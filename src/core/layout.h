...
// #define LAYOUT_PORT_COL_MASKS_ADDR   (LAYOUT_ADDR + 0)
// #define LAYOUT_PORT_ROW_PINS_ADDR    (LAYOUT_PORT_COL_MASKS_ADDR + IO_PORT_COUNT)
// #define LAYOUT_PORT_KEY_NUM_MAP_ADDR (LAYOUT_PORT_ROW_PINS_ADDR + MAX_NUM_ROWS)
