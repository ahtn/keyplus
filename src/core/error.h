...
typedef enum error_code_type {
    ...
    ERROR_PIN_MAPPING_CONFLICT_NRF24_SPI = 71,
    ERROR_PIN_MAPPING_CONFLICT_I2C = 72,
    ERROR_PIN_MAPPING_CONFLICT_ROW = 73,
    ERROR_PIN_MAPPING_CONFLICT_COL = 74,
    ERROR_NRF24_BAD_SPI_CONNECTION = 75,
} error_code_type;
