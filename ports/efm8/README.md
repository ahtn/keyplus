...
### EFM8 Factory bootloader

* [efm8 bootloader user guide](https://www.silabs.com/documents/public/application-notes/AN945.pdf)
* [efm8 bootloader software](https://www.silabs.com/documents/public/example-code/AN945SW.zip)

### Hardware programers

* [8-bit USB Debug Adapter User Guide](https://www.silabs.com/documents/public/user-guides/8-bit-USB-Debug-Adapter.pdf)
* [Digi-Key](https://www.digikey.com/product-detail/en/silicon-labs/DEBUGADPTR1-USB/336-1182-ND/807653), [Mouser](https://mouser.com/ProductDetail/Silicon-Labs/DEBUGADPTR1-USB?qs=sGAEpiMZZMsG1k5vdNM%2fc%252b5UiwcI%2fFSl), [eBay](https://www.ebay.com/sch/i.html?_nkw=c8051+usb+debug+adapter)

### Hardware programming code for C2 interface (arduino based):
