...
#ifndef SI_C8051F550_REGISTER_ENUMS_H
#define SI_C8051F550_REGISTER_ENUMS_H
...
#define XBR1_PCA0ME__FMASK                         0x1C ///< PCA Module I/O Enable                            
#define XBR1_PCA0ME__SHIFT                         0x02 ///< PCA Module I/O Enable                            
...
#define XBR1_ECIE__BMASK                           0x20 ///< PCA0 External Counter Input Enable               
#define XBR1_ECIE__SHIFT                           0x05 ///< PCA0 External Counter Input Enable               
#define XBR1_ECIE__DISABLED                        0x00 ///< ECI unavailable at Port pin.                     
#define XBR1_ECIE__ENABLED                         0x20 ///< ECI routed to Port pin.                          
...
#define REF0CN_REFSL__VDD           0x08 ///< Use VDD as the voltage reference. If VDD is       
                                         ///< selected as the voltage reference and the ADC is  
                                         ///< enabled in the ADC0CN register, the VREF pin      
                                         ///< cannot operate as a general purpose I/O pin in    
                                         ///< open-drain mode. With the above settings, this pin
                                         ///< can operate in push-pull output mode or as an     
                                         ///< analog input.                                     
...
#endif // SI_C8051F550_REGISTER_ENUMS_H
//-eof--------------------------------------------------------------------------
