...
#ifndef SI_C8051F390_REGISTER_ENUMS_H
#define SI_C8051F390_REGISTER_ENUMS_H

//Standard device includes
#include "SI_C8051F390_Defs.h"
//------------------------------------------------------------------------------
...
#define ADC0CN_ADCM__TIMER4        0x06 ///< ADC0 conversion initiated on overflow of Timer 4. 
#define ADC0CN_ADCM__TIMER5        0x07 ///< ADC0 conversion initiated on overflow of Timer 5. 
...
#define AMX0N_AMX0N__VREF    0x10 ///< Internal Voltage Reference.   
#define AMX0N_AMX0N__GND     0x11 ///< Ground (single-ended mode).   
...
#define AMX0N_AMX0N__NONE    0x1F ///< No input selected.            
...
#define AMX0P_AMX0P__TEMP    0x10 ///< Temperature sensor.           
#define AMX0P_AMX0P__VDD     0x11 ///< VDD Supply Voltage.           
...
#define AMX0P_AMX0P__NONE    0x1F ///< No input selected.            
...
//------------------------------------------------------------------------------
// PFE0CN Enums (Prefetch Engine Control @ 0xB5)
//------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------
// SFRSTACK Enums (SFR Page Stack @ 0xD3)
//------------------------------------------------------------------------------
...
#define CLKSEL_CLKSL__EXTOSC        0x01 ///< Clock (SYSCLK) derived from the External          
                                         ///< Oscillator circuit.                               
#define CLKSEL_CLKSL__LFOSC         0x02 ///< Clock (SYSCLK) derived from the Internal Low-     
                                         ///< Frequency Oscillator and scaled per the OSCLD bits
                                         ///< in register OSCLCN.                               
#define CLKSEL_CLKSL__HFOSC         0x03 ///< Clock (SYSCLK) derived directly from the Internal 
                                         ///< High-Frequency Oscillator.                        
#define CLKSEL_CLKSL__LPOSC         0x05 ///< Clock (SYSCLK) derived from the Internal Low-Power
                                         ///< Oscillator.                                       
...
//------------------------------------------------------------------------------
// CRC0AUTO Enums (CRC0 Automatic Control @ 0xDD)
//------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------
// CRC0CN Enums (CRC0 Control @ 0xDF)
//------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------
// CRC0CNT Enums (CRC0 Automatic Flash Sector Count @ 0xDE)
//------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------
// CRC0DAT Enums (CRC0 Data Output @ 0x9E)
//------------------------------------------------------------------------------
#define CRC0DAT_CRC0DAT__FMASK 0xFF ///< CRC Data Output
#define CRC0DAT_CRC0DAT__SHIFT 0x00 ///< CRC Data Output
                                                        
//------------------------------------------------------------------------------
// CRC0FLIP Enums (CRC0 Bit Flip @ 0x9A)
//------------------------------------------------------------------------------
#define CRC0FLIP_CRC0FLIP__FMASK 0xFF ///< CRC0 Bit Flip
#define CRC0FLIP_CRC0FLIP__SHIFT 0x00 ///< CRC0 Bit Flip
                                                        
//------------------------------------------------------------------------------
// CRC0IN Enums (CRC0 Data Input @ 0x9C)
//------------------------------------------------------------------------------
#define CRC0IN_CRC0IN__FMASK 0xFF ///< CRC Data Input
#define CRC0IN_CRC0IN__SHIFT 0x00 ///< CRC Data Input
                                                     
//------------------------------------------------------------------------------
// DERIVID Enums (Device Derivative ID @ 0xAB)
//------------------------------------------------------------------------------
#define DERIVID_DERIVID__FMASK      0xFF ///< Derivative ID
#define DERIVID_DERIVID__SHIFT      0x00 ///< Derivative ID
#define DERIVID_DERIVID__C8051F390  0xD0 ///< C8051F390    
#define DERIVID_DERIVID__C8051F391  0xD1 ///< C8051F391    
#define DERIVID_DERIVID__C8051F392  0xD2 ///< C8051F392    
#define DERIVID_DERIVID__C8051F393  0xD3 ///< C8051F393    
#define DERIVID_DERIVID__C8051F394  0xD4 ///< C8051F394    
#define DERIVID_DERIVID__C8051F395  0xD5 ///< C8051F395    
#define DERIVID_DERIVID__C8051F396  0xD6 ///< C8051F396    
#define DERIVID_DERIVID__C8051F397  0xD7 ///< C8051F397    
#define DERIVID_DERIVID__C8051F398  0xD8 ///< C8051F398    
#define DERIVID_DERIVID__C8051F399  0xD9 ///< C8051F399    
#define DERIVID_DERIVID__C8051F370  0xE0 ///< C8051F370    
#define DERIVID_DERIVID__C8051F371  0xE1 ///< C8051F371    
#define DERIVID_DERIVID__C8051F374  0xE4 ///< C8051F374    
#define DERIVID_DERIVID__C8051F375  0xE5 ///< C8051F375    
                                                           
//------------------------------------------------------------------------------
// REVISION Enums (Revision Identifcation @ 0xAC)
//------------------------------------------------------------------------------
#define REVISION_REVISION__FMASK 0xFF ///< Revision Identification
#define REVISION_REVISION__SHIFT 0x00 ///< Revision Identification
#define REVISION_REVISION__REV_A 0x00 ///< Revision A             
                                                                  
//------------------------------------------------------------------------------
// SN0 Enums (Serial Number Byte 0 @ 0xAB)
//------------------------------------------------------------------------------
#define SN0_SN0__FMASK 0xFF ///< Serial Number Byte 0
#define SN0_SN0__SHIFT 0x00 ///< Serial Number Byte 0
                                                     
//------------------------------------------------------------------------------
// SN1 Enums (Serial Number Byte 1 @ 0xAC)
//------------------------------------------------------------------------------
#define SN1_SN1__FMASK 0xFF ///< Serial Number Byte 1
#define SN1_SN1__SHIFT 0x00 ///< Serial Number Byte 1
                                                     
//------------------------------------------------------------------------------
// SN2 Enums (Serial Number Byte 2 @ 0xAD)
//------------------------------------------------------------------------------
#define SN2_SN2__FMASK 0xFF ///< Serial Number Byte 2
#define SN2_SN2__SHIFT 0x00 ///< Serial Number Byte 2
                                                     
//------------------------------------------------------------------------------
// SN3 Enums (Serial Number Byte 3 @ 0xAE)
//------------------------------------------------------------------------------
#define SN3_SN3__FMASK 0xFF ///< Serial Number Byte 3
#define SN3_SN3__SHIFT 0x00 ///< Serial Number Byte 3
...
#define OSCICN_IFCN__HFOSC_DIV_16 0x00 ///< SYSCLK derived from High Frequency Oscillator    
                                       ///< divided by 16.                                   
#define OSCICN_IFCN__HFOSC_DIV_8  0x01 ///< SYSCLK derived from High Frequency Oscillator    
                                       ///< divided by 8.                                    
#define OSCICN_IFCN__HFOSC_DIV_4  0x02 ///< SYSCLK derived from High Frequency Oscillator    
                                       ///< divided by 4.                                    
#define OSCICN_IFCN__HFOSC_DIV_2  0x03 ///< SYSCLK derived from High Frequency Oscillator    
                                       ///< divided by 2.                                    
...
#define IDA0CN_IDAOMD__0P5_MA             0x00 ///< 0.5 mA full-scale output current.                 
#define IDA0CN_IDAOMD__1_MA               0x01 ///< 1.0 mA full-scale output current.                 
#define IDA0CN_IDAOMD__2_MA               0x02 ///< 2.0 mA full-scale output current.                 
                                                                                                      
#define IDA0CN_IDARP__BMASK               0x04 ///< Reset Persistence Enable                          
#define IDA0CN_IDARP__SHIFT               0x02 ///< Reset Persistence Enable                          
#define IDA0CN_IDARP__DISABLED            0x00 ///< IDAC0 is disabled by any reset source.            
#define IDA0CN_IDARP__ENABLED             0x04 ///< IDAC0 will remain enabled through any reset source
...
//------------------------------------------------------------------------------
#define IDA0L_IDA0__FMASK 0xC0 ///< IDA0 Data Low
#define IDA0L_IDA0__SHIFT 0x06 ///< IDA0 Data Low
                                                 
//------------------------------------------------------------------------------
// IDA1CN Enums (IDAC1 Control @ 0xB9)
//------------------------------------------------------------------------------
#define IDA1CN_IDAOMD__FMASK              0x03 ///< Output Mode Select                                
#define IDA1CN_IDAOMD__SHIFT              0x00 ///< Output Mode Select                                
#define IDA1CN_IDAOMD__0P5_MA             0x00 ///< 0.5 mA full-scale output current.                 
#define IDA1CN_IDAOMD__1_MA               0x01 ///< 1.0 mA full-scale output current.                 
#define IDA1CN_IDAOMD__2_MA               0x02 ///< 2.0 mA full-scale output current.                 
                                                                                                      
#define IDA1CN_IDARP__BMASK               0x04 ///< Reset Persistence Enable                          
#define IDA1CN_IDARP__SHIFT               0x02 ///< Reset Persistence Enable                          
#define IDA1CN_IDARP__DISABLED            0x00 ///< IDAC1 is disabled by any reset source.            
#define IDA1CN_IDARP__ENABLED             0x04 ///< IDAC1 will remain enabled through any reset source
                                               ///< except a power-on-reset.                          
...
#define IDA1CN_IDACM__TIMER5              0x10 ///< DAC output updates on Timer 5 overflow.           
...
//------------------------------------------------------------------------------
// IDA1H Enums (IDAC1 Data High Byte @ 0x97)
//------------------------------------------------------------------------------
#define IDA1H_IDA1__FMASK 0xFF ///< IDAC1 Data High
#define IDA1H_IDA1__SHIFT 0x00 ///< IDAC1 Data High
                                                   
//------------------------------------------------------------------------------
// IDA1L Enums (IDAC1 Data Low Byte @ 0x96)
//------------------------------------------------------------------------------
#define IDA1L_IDA1__FMASK 0xC0 ///< IDA1 Data Low
#define IDA1L_IDA1__SHIFT 0x06 ///< IDA1 Data Low
...
//------------------------------------------------------------------------------
// EIE2 Enums (Extended Interrupt Enable 2 @ 0xAF)
//------------------------------------------------------------------------------
#define EIE2_ESMB1__BMASK    0x01 ///< SMBus (SMB1) Interrupt Enable                     
#define EIE2_ESMB1__SHIFT    0x00 ///< SMBus (SMB1) Interrupt Enable                     
#define EIE2_ESMB1__DISABLED 0x00 ///< Disable all SMB1 interrupts.                      
#define EIE2_ESMB1__ENABLED  0x01 ///< Enable interrupt requests generated by SMB1.      
                                                                                         
#define EIE2_ET4__BMASK      0x02 ///< Timer 4 Interrupt Enable                          
#define EIE2_ET4__SHIFT      0x01 ///< Timer 4 Interrupt Enable                          
#define EIE2_ET4__DISABLED   0x00 ///< Disable Timer 4 interrupts.                       
#define EIE2_ET4__ENABLED    0x02 ///< Enable interrupt requests generated by the TF4L or
                                  ///< TF4H flags.                                       
                                                                                         
#define EIE2_ET5__BMASK      0x04 ///< Timer 5 Interrupt Enable                          
#define EIE2_ET5__SHIFT      0x02 ///< Timer 5 Interrupt Enable                          
#define EIE2_ET5__DISABLED   0x00 ///< Disable Timer 5 interrupts.                       
#define EIE2_ET5__ENABLED    0x04 ///< Enable interrupt requests generated by the TF5L or
                                  ///< TF5H flags.                                       
                                                                                         
#define EIE2_EPTS__BMASK     0x08 ///< Precision Temperature Sensor Interrupt Enable     
#define EIE2_EPTS__SHIFT     0x03 ///< Precision Temperature Sensor Interrupt Enable     
#define EIE2_EPTS__DISABLED  0x00 ///< Disable Precision Temperature Sensor interrupts.  
#define EIE2_EPTS__ENABLED   0x08 ///< Enable interrupt requests generated by the        
...
//------------------------------------------------------------------------------
// EIP1H Enums (Extended Interrupt Priority 1 High @ 0x85)
//------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------
// EIP2 Enums (Extended Interrupt Priority 2 @ 0xBF)
//------------------------------------------------------------------------------
#define EIP2_PSMB1__BMASK 0x01 ///< SMBus (SMB1) Interrupt Priority Control LSB                
#define EIP2_PSMB1__SHIFT 0x00 ///< SMBus (SMB1) Interrupt Priority Control LSB                
#define EIP2_PSMB1__LOW   0x00 ///< SMB1 interrupt priority LSB set to low.                    
#define EIP2_PSMB1__HIGH  0x01 ///< SMB1 interrupt priority LSB set to high.                   
                                                                                               
#define EIP2_PT4__BMASK   0x02 ///< Timer 4 Interrupt Priority Control LSB                     
#define EIP2_PT4__SHIFT   0x01 ///< Timer 4 Interrupt Priority Control LSB                     
#define EIP2_PT4__LOW     0x00 ///< Timer 4 interrupt priority LSB set to low.                 
#define EIP2_PT4__HIGH    0x02 ///< Timer 4 interrupt priority LSB set to high.                
                                                                                               
#define EIP2_PT5__BMASK   0x04 ///< Timer 5 Interrupt Priority Control LSB                     
#define EIP2_PT5__SHIFT   0x02 ///< Timer 5 Interrupt Priority Control LSB                     
#define EIP2_PT5__LOW     0x00 ///< Timer 5 interrupt priority LSB set to low.                 
#define EIP2_PT5__HIGH    0x04 ///< Timer 5 interrupt priority LSB set to high.                
                                                                                               
#define EIP2_PPTS__BMASK  0x08 ///< Precision Temperature Sensor Interrupt Priority Control LSB
#define EIP2_PPTS__SHIFT  0x03 ///< Precision Temperature Sensor Interrupt Priority Control LSB
#define EIP2_PPTS__LOW    0x00 ///< Precision Temperature Sensor interrupt priority            
                               ///< LSB set to low.                                            
#define EIP2_PPTS__HIGH   0x08 ///< Precision Temperature Sensor interrupt priority            
                               ///< LSB set to high.                                           
                                                                                               
//------------------------------------------------------------------------------
// EIP2H Enums (Extended Interrupt Priority 2 High @ 0x86)
//------------------------------------------------------------------------------
#define EIP2H_PHSMB1__BMASK 0x01 ///< SMBus (SMB1) Interrupt Priority Control MSB                
#define EIP2H_PHSMB1__SHIFT 0x00 ///< SMBus (SMB1) Interrupt Priority Control MSB                
#define EIP2H_PHSMB1__LOW   0x00 ///< SMB1 interrupt priority MSB set to low.                    
#define EIP2H_PHSMB1__HIGH  0x01 ///< SMB1 interrupt priority MSB set to high.                   
                                                                                                 
#define EIP2H_PHT4__BMASK   0x02 ///< Timer 4 Interrupt Priority Control MSB                     
#define EIP2H_PHT4__SHIFT   0x01 ///< Timer 4 Interrupt Priority Control MSB                     
#define EIP2H_PHT4__LOW     0x00 ///< Timer 4 interrupt priority MSB set to low.                 
#define EIP2H_PHT4__HIGH    0x02 ///< Timer 4 interrupt priority MSB set to high.                
                                                                                                 
#define EIP2H_PHT5__BMASK   0x04 ///< Timer 5 Interrupt Priority Control MSB                     
#define EIP2H_PHT5__SHIFT   0x02 ///< Timer 5 Interrupt Priority Control MSB                     
#define EIP2H_PHT5__LOW     0x00 ///< Timer 5 interrupt priority MSB set to low.                 
#define EIP2H_PHT5__HIGH    0x04 ///< Timer 5 interrupt priority MSB set to high.                
                                                                                                 
#define EIP2H_PHPTS__BMASK  0x08 ///< Precision Temperature Sensor Interrupt Priority Control MSB
#define EIP2H_PHPTS__SHIFT  0x03 ///< Precision Temperature Sensor Interrupt Priority Control MSB
#define EIP2H_PHPTS__LOW    0x00 ///< Precision Temperature Sensor interrupt priority            
                                 ///< MSB set to low.                                            
#define EIP2H_PHPTS__HIGH   0x08 ///< Precision Temperature Sensor interrupt priority            
                                 ///< MSB set to high.                                           
...
//------------------------------------------------------------------------------
// IPH Enums (Interrupt Priority High @ 0x84)
//------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------
#define OSCLCN_OSCLD__FMASK       0x03 ///< Divider Select                                   
#define OSCLCN_OSCLD__SHIFT       0x00 ///< Divider Select                                   
#define OSCLCN_OSCLD__LFOSC_DIV_8 0x00 ///< Divide by 8 selected.                            
#define OSCLCN_OSCLD__LFOSC_DIV_4 0x01 ///< Divide by 4 selected.                            
#define OSCLCN_OSCLD__LFOSC_DIV_2 0x02 ///< Divide by 2 selected.                            
#define OSCLCN_OSCLD__LFOSC_DIV_1 0x03 ///< Divide by 1 selected.                            
                                                                                             
#define OSCLCN_OSCLF__FMASK       0x3C ///< Frequency Control Value                          
#define OSCLCN_OSCLF__SHIFT       0x02 ///< Frequency Control Value                          
                                                                                             
#define OSCLCN_OSCLRDY__BMASK     0x40 ///< Oscillator Ready Flag                            
#define OSCLCN_OSCLRDY__SHIFT     0x06 ///< Oscillator Ready Flag                            
#define OSCLCN_OSCLRDY__NOT_SET   0x00 ///< Low Frequency Oscillator frequency is not stable.
#define OSCLCN_OSCLRDY__SET       0x40 ///< Low Frequency Oscillator frequency is stable.    
...
#define XBR0_SMB1E__BMASK     0x40 ///< SMBus1 I/O Enable                             
#define XBR0_SMB1E__SHIFT     0x06 ///< SMBus1 I/O Enable                             
#define XBR0_SMB1E__DISABLED  0x00 ///< SMBus1 I/O unavailable at Port pins.          
#define XBR0_SMB1E__ENABLED   0x40 ///< SMBus1 I/O routed to Port pins.               
                                                                                      
#define XBR0_EEPUE__BMASK     0x80 ///< EEPROM Pullup Enable                          
#define XBR0_EEPUE__SHIFT     0x07 ///< EEPROM Pullup Enable                          
#define XBR0_EEPUE__DISABLED  0x00 ///< On-chip strong pullups not active.            
#define XBR0_EEPUE__ENABLED   0x80 ///< On-chip strong pullups active on pins P2.2 and
                                   ///< P2.3.                                         
...
//------------------------------------------------------------------------------
// PCA0CLR Enums (PCA Comparator Clear Control @ 0xCE)
//------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------
// TS0CN Enums (Temperature Sensor Control @ 0xD2)
//------------------------------------------------------------------------------
#define TS0CN_TSCNVL__FMASK  0x07 ///< Temperature Sensor Conversion Length             
#define TS0CN_TSCNVL__SHIFT  0x00 ///< Temperature Sensor Conversion Length             
                                                                                        
#define TS0CN_TSDN__BMASK    0x40 ///< Temperature Sensor Finished Flag                 
#define TS0CN_TSDN__SHIFT    0x06 ///< Temperature Sensor Finished Flag                 
#define TS0CN_TSDN__NOT_SET  0x00 ///< A temperature sensor measurement is not complete.
#define TS0CN_TSDN__SET      0x40 ///< A temperature sensor measurement completed.      
                                                                                        
#define TS0CN_TSSTRT__BMASK  0x80 ///< Temperature Sensor Start                         
#define TS0CN_TSSTRT__SHIFT  0x07 ///< Temperature Sensor Start                         
#define TS0CN_TSSTRT__START2 0x00 ///< Firmware must set this bit to 1, then clear this 
                                  ///< bit to 0 to start a temperature sensor           
                                  ///< measurement.                                     
#define TS0CN_TSSTRT__START1 0x80 ///< Firmware must set this bit to 1, then clear this 
                                  ///< bit to 0 to start a temperature sensor           
                                  ///< measurement.                                     
                                                                                        
//------------------------------------------------------------------------------
// TS0DATH Enums (Temperature Sensor Output High Byte @ 0xD3)
//------------------------------------------------------------------------------
#define TS0DATH_TS0DATH__FMASK 0xFF ///< Temperature Sensor Output High Byte
#define TS0DATH_TS0DATH__SHIFT 0x00 ///< Temperature Sensor Output High Byte
                                                                            
//------------------------------------------------------------------------------
// TS0DATL Enums (Temperature Sensor Output Low Byte @ 0xD2)
//------------------------------------------------------------------------------
#define TS0DATL_TS0DATL__FMASK 0xFF ///< Temperature Sensor Output Low Byte
#define TS0DATL_TS0DATL__SHIFT 0x00 ///< Temperature Sensor Output Low Byte
...
//------------------------------------------------------------------------------
// SMB0ADM Enums (SMBus 0 Slave Address Mask @ 0xE7)
//------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------
// SMB1ADM Enums (SMBus 1 Slave Address Mask @ 0xE7)
//------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------
// SMB1ADR Enums (SMBus 1 Slave Address @ 0xD7)
//------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------
// SMB1CN Enums (SMBus 1 Control @ 0xC0)
//------------------------------------------------------------------------------
#define SMB1CN_SI__BMASK           0x01 ///< SMBus Interrupt Flag                           
#define SMB1CN_SI__SHIFT           0x00 ///< SMBus Interrupt Flag                           
#define SMB1CN_SI__NOT_SET         0x00 ///<                                                
#define SMB1CN_SI__SET             0x01 ///<                                                
                                                                                            
#define SMB1CN_ACK__BMASK          0x02 ///< SMBus Acknowledge                              
#define SMB1CN_ACK__SHIFT          0x01 ///< SMBus Acknowledge                              
#define SMB1CN_ACK__NOT_SET        0x00 ///< Generate a NACK, or the response was a NACK.   
#define SMB1CN_ACK__SET            0x02 ///< Generate an ACK, or the response was an ACK.   
                                                                                            
#define SMB1CN_ARBLOST__BMASK      0x04 ///< SMBus Arbitration Lost Indicator               
#define SMB1CN_ARBLOST__SHIFT      0x02 ///< SMBus Arbitration Lost Indicator               
#define SMB1CN_ARBLOST__NOT_SET    0x00 ///< No arbitration error.                          
#define SMB1CN_ARBLOST__ERROR      0x04 ///< Arbitration error occurred.                    
                                                                                            
#define SMB1CN_ACKRQ__BMASK        0x08 ///< SMBus Acknowledge Request                      
#define SMB1CN_ACKRQ__SHIFT        0x03 ///< SMBus Acknowledge Request                      
#define SMB1CN_ACKRQ__NOT_SET      0x00 ///< No ACK requested.                              
#define SMB1CN_ACKRQ__REQUESTED    0x08 ///< ACK requested.                                 
                                                                                            
#define SMB1CN_STO__BMASK          0x10 ///< SMBus Stop Flag                                
#define SMB1CN_STO__SHIFT          0x04 ///< SMBus Stop Flag                                
#define SMB1CN_STO__NOT_SET        0x00 ///< A STOP is not pending.                         
#define SMB1CN_STO__SET            0x10 ///< Generate a STOP or a STOP is currently pending.
                                                                                            
#define SMB1CN_STA__BMASK          0x20 ///< SMBus Start Flag                               
#define SMB1CN_STA__SHIFT          0x05 ///< SMBus Start Flag                               
#define SMB1CN_STA__NOT_SET        0x00 ///< A START was not detected.                      
#define SMB1CN_STA__SET            0x20 ///< Generate a START, repeated START, or a START is
                                        ///< currently pending.                             
                                                                                            
#define SMB1CN_TXMODE__BMASK       0x40 ///< SMBus Transmit Mode Indicator                  
#define SMB1CN_TXMODE__SHIFT       0x06 ///< SMBus Transmit Mode Indicator                  
#define SMB1CN_TXMODE__RECEIVER    0x00 ///< SMBus in Receiver Mode.                        
#define SMB1CN_TXMODE__TRANSMITTER 0x40 ///< SMBus in Transmitter Mode.                     
                                                                                            
#define SMB1CN_MASTER__BMASK       0x80 ///< SMBus Master/Slave Indicator                   
#define SMB1CN_MASTER__SHIFT       0x07 ///< SMBus Master/Slave Indicator                   
#define SMB1CN_MASTER__SLAVE       0x00 ///< SMBus operating in slave mode.                 
#define SMB1CN_MASTER__MASTER      0x80 ///< SMBus operating in master mode.                
...
//------------------------------------------------------------------------------
// SMBTC Enums (SMBus Timing and Pin Control @ 0xC7)
//------------------------------------------------------------------------------
...
#define SMBTC_SMB0SWAP__BMASK        0x40 ///< SMBus 0 Swap Pins                                
#define SMBTC_SMB0SWAP__SHIFT        0x06 ///< SMBus 0 Swap Pins                                
#define SMBTC_SMB0SWAP__SDA_LOW_PIN  0x00 ///< SDA is mapped to the lower-numbered port pin, and
                                          ///< SCL is mapped to the higher-numbered port pin.   
#define SMBTC_SMB0SWAP__SDA_HIGH_PIN 0x40 ///< SCL is mapped to the lower-numbered port pin, and
                                          ///< SDA is mapped to the higher-numbered port pin.   
                                                                                                
#define SMBTC_SMB1SWAP__BMASK        0x80 ///< SMBus 1 Swap Pins                                
#define SMBTC_SMB1SWAP__SHIFT        0x07 ///< SMBus 1 Swap Pins                                
#define SMBTC_SMB1SWAP__SDA_LOW_PIN  0x00 ///< SDA is mapped to the lower-numbered port pin, and
                                          ///< SCL is mapped to the higher-numbered port pin.   
#define SMBTC_SMB1SWAP__SDA_HIGH_PIN 0x80 ///< SCL is mapped to the lower-numbered port pin, and
                                          ///< SDA is mapped to the higher-numbered port pin.   
...
#define TMR3CN_T3XCLK__EXTOSC_DIV_8   0x01 ///< Timer 3 clock is the external oscillator divided 
                                           ///< by 8 (synchronized with SYSCLK).                 
#define TMR3CN_T3XCLK__LFOSC_DIV_8    0x03 ///< Internal LFOSC / 8 (synchronized with SYSCLK when
                                           ///< not in suspend).                                 
...
//------------------------------------------------------------------------------
// TMR4CN Enums (Timer 4 Control @ 0x91)
//------------------------------------------------------------------------------
#define TMR4CN_T4XCLK__BMASK          0x01 ///< Timer 4 External Clock Select                    
#define TMR4CN_T4XCLK__SHIFT          0x00 ///< Timer 4 External Clock Select                    
#define TMR4CN_T4XCLK__SYSCLK_DIV_12  0x00 ///< Timer 4 clock is the system clock divided by 12. 
#define TMR4CN_T4XCLK__EXTOSC_DIV_8   0x01 ///< Timer 4 clock is the external oscillator divided 
                                           ///< by 8 (synchronized with SYSCLK).                 
...
#define TMR4CN_T4SPLIT__BMASK         0x08 ///< Timer 4 Split Mode Enable                        
#define TMR4CN_T4SPLIT__SHIFT         0x03 ///< Timer 4 Split Mode Enable                        
#define TMR4CN_T4SPLIT__16_BIT_RELOAD 0x00 ///< Timer 4 operates in 16-bit auto-reload mode.     
#define TMR4CN_T4SPLIT__8_BIT_RELOAD  0x08 ///< Timer 4 operates as two 8-bit auto-reload timers.
                                                                                                 
#define TMR4CN_TF4LEN__BMASK          0x20 ///< Timer 4 Low Byte Interrupt Enable                
#define TMR4CN_TF4LEN__SHIFT          0x05 ///< Timer 4 Low Byte Interrupt Enable                
#define TMR4CN_TF4LEN__DISABLED       0x00 ///< Disable low byte interrupts.                     
#define TMR4CN_TF4LEN__ENABLED        0x20 ///< Enable low byte interrupts.                      
                                                                                                 
#define TMR4CN_TF4L__BMASK            0x40 ///< Timer 4 Low Byte Overflow Flag                   
#define TMR4CN_TF4L__SHIFT            0x06 ///< Timer 4 Low Byte Overflow Flag                   
#define TMR4CN_TF4L__NOT_SET          0x00 ///< Timer 4 low byte did not overflow.               
#define TMR4CN_TF4L__SET              0x40 ///< Timer 4 low byte overflowed.                     
                                                                                                 
#define TMR4CN_TF4H__BMASK            0x80 ///< Timer 4 High Byte Overflow Flag                  
#define TMR4CN_TF4H__SHIFT            0x07 ///< Timer 4 High Byte Overflow Flag                  
#define TMR4CN_TF4H__NOT_SET          0x00 ///< Timer 4 8-bit high byte or 16-bit value did not  
                                           ///< overflow.                                        
#define TMR4CN_TF4H__SET              0x80 ///< Timer 4 8-bit high byte or 16-bit value          
                                           ///< overflowed.                                      
...
//------------------------------------------------------------------------------
// TMR5CN Enums (Timer 5 Control @ 0xC8)
//------------------------------------------------------------------------------
#define TMR5CN_T5XCLK__BMASK          0x01 ///< Timer 5 External Clock Select                    
#define TMR5CN_T5XCLK__SHIFT          0x00 ///< Timer 5 External Clock Select                    
#define TMR5CN_T5XCLK__SYSCLK_DIV_12  0x00 ///< Timer 5 clock is the system clock divided by 12. 
#define TMR5CN_T5XCLK__EXTOSC_DIV_8   0x01 ///< Timer 5 clock is the external oscillator divided 
                                           ///< by 8 (synchronized with SYSCLK).                 
...
#define TMR5CN_T5SPLIT__BMASK         0x08 ///< Timer 5 Split Mode Enable                        
#define TMR5CN_T5SPLIT__SHIFT         0x03 ///< Timer 5 Split Mode Enable                        
#define TMR5CN_T5SPLIT__16_BIT_RELOAD 0x00 ///< Timer 5 operates in 16-bit auto-reload mode.     
#define TMR5CN_T5SPLIT__8_BIT_RELOAD  0x08 ///< Timer 5 operates as two 8-bit auto-reload timers.
                                                                                                 
#define TMR5CN_TF5LEN__BMASK          0x20 ///< Timer 5 Low Byte Interrupt Enable                
#define TMR5CN_TF5LEN__SHIFT          0x05 ///< Timer 5 Low Byte Interrupt Enable                
#define TMR5CN_TF5LEN__DISABLED       0x00 ///< Disable low byte interrupts.                     
#define TMR5CN_TF5LEN__ENABLED        0x20 ///< Enable low byte interrupts.                      
                                                                                                 
#define TMR5CN_TF5L__BMASK            0x40 ///< Timer 5 Low Byte Overflow Flag                   
#define TMR5CN_TF5L__SHIFT            0x06 ///< Timer 5 Low Byte Overflow Flag                   
#define TMR5CN_TF5L__NOT_SET          0x00 ///< Timer 5 low byte did not overflow.               
#define TMR5CN_TF5L__SET              0x40 ///< Timer 5 low byte overflowed.                     
                                                                                                 
#define TMR5CN_TF5H__BMASK            0x80 ///< Timer 5 High Byte Overflow Flag                  
#define TMR5CN_TF5H__SHIFT            0x07 ///< Timer 5 High Byte Overflow Flag                  
#define TMR5CN_TF5H__NOT_SET          0x00 ///< Timer 5 8-bit high byte or 16-bit value did not  
                                           ///< overflow.                                        
#define TMR5CN_TF5H__SET              0x80 ///< Timer 5 8-bit high byte or 16-bit value          
                                           ///< overflowed.                                      
...
//------------------------------------------------------------------------------
// CKCON1 Enums (Clock Control 1 @ 0xF4)
//------------------------------------------------------------------------------
#define CKCON1_T4ML__BMASK          0x01 ///< Timer 4 Low Byte Clock Select                  
#define CKCON1_T4ML__SHIFT          0x00 ///< Timer 4 Low Byte Clock Select                  
#define CKCON1_T4ML__EXTERNAL_CLOCK 0x00 ///< Timer 4 low byte uses the clock defined by the 
                                         ///< T4XCLK bit in TMR4CN.                          
...
#define CKCON1_T4MH__EXTERNAL_CLOCK 0x00 ///< Timer 4 high byte uses the clock defined by the
                                         ///< T4XCLK bit in TMR4CN.                          
...
#define CKCON1_T5ML__EXTERNAL_CLOCK 0x00 ///< Timer 5 low byte uses the clock defined by the 
                                         ///< T5XCLK bit in TMR5CN.                          
...
#define CKCON1_T5MH__EXTERNAL_CLOCK 0x00 ///< Timer 5 high byte uses the clock defined by the
                                         ///< T5XCLK bit in TMR5CN.                          
...
#define REG0CN_STOPCF__SHUTDOWN 0x08 ///< Regulator is shut down in stop mode. Only the /RST
                                     ///< pin or a power cycle can reset the device.        
...
#endif // SI_C8051F390_REGISTER_ENUMS_H
//-eof--------------------------------------------------------------------------
