 ...
 * options.
 *
 * @note consumption will vary based on how the application uses the library.
 * Typically the consumption will be significantly less than listed but in rare
 * cases may be more.
 *
 * | condition          | CODE | XRAM | IRAM | RAM |
 * |--------------------|------|------|------|-----|
 * |USE                 |  377 |    6 |    0 |   0 |
 * |USE-AUTO_PAGE       |  295 |    6 |    0 |   0 |
 * |STDIO               |   43 |    0 |    0 |   0 |
 *
 * # Theory of Operation #
 *
...
/**************************************************************************//**
 * @def EFM8PDL_UART0_AUTO_PAGE
 * @brief Controls if the library handles SI_SFR paging.
 *
 * When '1' the UART0 driver automatically handles setting and restoring
...
#ifndef EFM8PDL_UART0_AUTO_PAGE
#define EFM8PDL_UART0_AUTO_PAGE 1
#endif
