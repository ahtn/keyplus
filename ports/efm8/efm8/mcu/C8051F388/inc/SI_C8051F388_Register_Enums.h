...
#ifndef SI_C8051F388_REGISTER_ENUMS_H
#define SI_C8051F388_REGISTER_ENUMS_H

//Standard device includes
#include "SI_C8051F388_Defs.h"
//------------------------------------------------------------------------------
...
//------------------------------------------------------------------------------
#define CPT1MX_CMXP__FMASK  0x07 ///< Comparator Positive Input MUX Selection
...
#define CPT1MX_CMXN__FMASK  0x70 ///< Comparator Negative Input MUX Selection
...
#define OSCICN_IFCN__SYSCLK_DIV_8 0x00 ///< SYSCLK can be derived from Internal H-F Oscillator
                                       ///< divided by 8 (1.5 MHz).                           
#define OSCICN_IFCN__SYSCLK_DIV_4 0x01 ///< SYSCLK can be derived from Internal H-F Oscillator
                                       ///< divided by 4 (3 MHz).                             
#define OSCICN_IFCN__SYSCLK_DIV_2 0x02 ///< SYSCLK can be derived from Internal H-F Oscillator
                                       ///< divided by 2 (6 MHz).                             
#define OSCICN_IFCN__SYSCLK_DIV_1 0x03 ///< SYSCLK can be derived from Internal H-F Oscillator
                                       ///< divided by 1 (12 MHz).                            
...
//------------------------------------------------------------------------------
#define EIE2_EINT2__BMASK    0x01 ///< INT2 Level Interrupt Enable                       
#define EIE2_EINT2__SHIFT    0x00 ///< INT2 Level Interrupt Enable                       
#define EIE2_EINT2__DISABLED 0x00 ///< Disable all INT2 interrupts.                      
#define EIE2_EINT2__ENABLED  0x01 ///< Enable interrupt requests generated by INT2 level 
                                  ///< sense.                                            
...
//------------------------------------------------------------------------------
#define EIP2_PINT2__BMASK 0x01 ///< INT2 Level Interrupt Priority Control        
#define EIP2_PINT2__SHIFT 0x00 ///< INT2 Level Interrupt Priority Control        
#define EIP2_PINT2__LOW   0x00 ///< INT2 interrupt set to low priority level.    
#define EIP2_PINT2__HIGH  0x01 ///< INT2 interrupt set to high priority level.   
...
//------------------------------------------------------------------------------
// OSCLCN Enums (Internal Low Frequency Oscillator Control @ 0x86)
//------------------------------------------------------------------------------
...
#define TMR2CN_T2CSS__BMASK           0x02 ///< Timer 2 Capture Source Select                    
#define TMR2CN_T2CSS__SHIFT           0x01 ///< Timer 2 Capture Source Select                    
#define TMR2CN_T2CSS__LFOSC_CAPTURE   0x02 ///< Capture source is falling edge of Low-Frequency  
                                           ///< Oscillator.                                      
...
#define TMR3CN_T3CSS__BMASK           0x02 ///< Timer 3 Capture Source Select                    
#define TMR3CN_T3CSS__SHIFT           0x01 ///< Timer 3 Capture Source Select                    
#define TMR3CN_T3CSS__LFOSC_CAPTURE   0x02 ///< Capture source is falling edge of Low-Frequency  
                                           ///< Oscillator.                                      
...
//------------------------------------------------------------------------------
#define SBCON1_SBPS__FMASK     0x03 ///< Baud Rate Prescaler Select                     
#define SBCON1_SBPS__SHIFT     0x00 ///< Baud Rate Prescaler Select                     
#define SBCON1_SBPS__DIV_BY_12 0x00 ///< Prescaler = 12.                                
#define SBCON1_SBPS__DIV_BY_4  0x01 ///< Prescaler = 4.                                 
#define SBCON1_SBPS__DIV_BY_48 0x02 ///< Prescaler = 48.                                
#define SBCON1_SBPS__DIV_BY_1  0x03 ///< Prescaler = 1.                                 
                                                                                        
#define SBCON1_SBRUN__BMASK    0x40 ///< Baud Rate Generator Enable                     
#define SBCON1_SBRUN__SHIFT    0x06 ///< Baud Rate Generator Enable                     
#define SBCON1_SBRUN__DISABLED 0x00 ///< Disable the baud rate generator. UART1 will not
                                    ///< function.                                      
#define SBCON1_SBRUN__ENABLED  0x40 ///< Enable the baud rate generator.                
                                                                                        
//------------------------------------------------------------------------------
// SBRLH1 Enums (UART1 Baud Rate Generator High Byte @ 0xB5)
//------------------------------------------------------------------------------
#define SBRLH1_SBRL__FMASK 0xFF ///< UART1 Baud Rate Reload High
#define SBRLH1_SBRL__SHIFT 0x00 ///< UART1 Baud Rate Reload High
                                                                
//------------------------------------------------------------------------------
// SBRLL1 Enums (UART1 Baud Rate Generator Low Byte @ 0xB4)
//------------------------------------------------------------------------------
#define SBRLL1_SBRL__FMASK 0xFF ///< UART1 Baud Rate Reload Low
#define SBRLL1_SBRL__SHIFT 0x00 ///< UART1 Baud Rate Reload Low
...
#define SCON1_RI__SET               0x01 ///< UART1 received a byte of data or data remains in  
                                         ///< the receive FIFO.                                 
...
#define SCON1_THRE__BMASK           0x20 ///< Transmit Holding Register Empty Flag              
#define SCON1_THRE__SHIFT           0x05 ///< Transmit Holding Register Empty Flag              
#define SCON1_THRE__NOT_SET         0x00 ///< The transmit holding register is not empty. Do not
                                         ///< write to SBUF1.                                   
#define SCON1_THRE__SET             0x20 ///< The transmit holding register is empty. It is safe
                                         ///< to write to SBUF1.                                
...
#define REG01CN_STOPCF__SHUTDOWN  0x08 ///< VREG1 Regulator is shut down in stop mode. Only  
                                       ///< the /RST pin or power cycle can reset the device.
...
#define REG01CN_INT2STAT__BMASK   0x40 ///< INT2 Signal Status                               
#define REG01CN_INT2STAT__SHIFT   0x06 ///< INT2 Signal Status                               
#define REG01CN_INT2STAT__LOW     0x00 ///< INT2 pin is currently low.                       
#define REG01CN_INT2STAT__HIGH    0x40 ///< INT2 pin is currently high.                      
...
#endif // SI_C8051F388_REGISTER_ENUMS_H
//-eof--------------------------------------------------------------------------
