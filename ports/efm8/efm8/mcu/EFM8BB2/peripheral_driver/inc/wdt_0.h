...
#ifdef IS_DOXYGEN
  WDT0_SYSCLK_DIV12 = -1,          //!< @warning NOT SUPPORTED ON THIS DEVICE
  WDT0_SYSCLK_DIV4  = -1,          //!< @warning NOT SUPPORTED ON THIS DEVICE
  WDT0_TIMER0       = -1,          //!< @warning NOT SUPPORTED ON THIS DEVICE
  WDT0_ECI          = -1,          //!< @warning NOT SUPPORTED ON THIS DEVICE
  WDT0_SYSCLK       = -1,          //!< @warning NOT SUPPORTED ON THIS DEVICE
  WDT0_EXTOSC_DIV8  = -1,          //!< @warning NOT SUPPORTED ON THIS DEVICE
  WDT0_LFOSC_DIV8   = -1,          //!< @warning NOT SUPPORTED ON THIS DEVICE
#endif
} WDT0_Timebase_t;
...
#ifdef IS_DOXYGEN
  WDT0_IDLE_RUN     = -1, //!< @warning Run when idle not suppoted on this device
#endif
} WDT0_IdleState_t;
