...
/**************************************************************************//**
 * @def EFM8PDL_SMB0_USE_INIT
 * @brief Controls inclusion of SMB0 Initialization API.
 *
 * When '1' the SMB0 Initialization API is available.
 *
 * Default setting is '1' if either USE or USE_BUFFER are
 * enabled and may be overridden by defining in 'efm8_config.h'.
 *
 *****************************************************************************/
