...
#ifndef SI_C8051F850_SI_DEFS_H
#define SI_C8051F850_SI_DEFS_H
...
SI_SFR (CPT1CN,   0xBF); ///< Comparator 1 Control                  
SI_SFR (CPT1MD,   0xAB); ///< Comparator 1 Mode                     
SI_SFR (CPT1MX,   0xAA); ///< Comparator 1 Multiplexer Selection    
...
SI_SFR (OSCICL,   0xC7); ///< High Frequency Oscillator Calibration 
SI_SFR (OSCLCN,   0xB1); ///< Low Frequency Oscillator Control      
