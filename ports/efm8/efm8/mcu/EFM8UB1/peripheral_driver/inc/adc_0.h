 ...
 * |Auto Page     |EFM8PDL_ADC0_AUTO_PAGE    | +105 |     0 |     0 |   +3 |
...
typedef enum {
    ...
    ADC0_CONVERSION_START_CEX2      = ADC0CN0_ADCM__CEX2,   //!< Rising edge of PCA CEX2 starts a conversion.
    ADC0_CONVERSION_START_GATED_TIMER_2 = ADC0CN0_ADCM__GATED_TIMER2, //!< Gated Timer2 Overflow starts a conversion when CEX2 is logic high..
    ADC0_CONVERSION_START_TIMER4    = ADC0CN0_ADCM__TIMER4, //!< Timer5 Overflow starts a conversion.
