...
#if IS_DOXYGEN
  PCA0_CHAN3 = -1,          //!< @warning NOT SUPPORTED ON THIS DEVICE
  PCA0_CHAN4 = -1,          //!< @warning NOT SUPPORTED ON THIS DEVICE
  PCA0_CHAN5 = -1,          //!< @warning NOT SUPPORTED ON THIS DEVICE
#endif
} PCA0_Channel_t;
 ...
 *
 * @warning All channels in 8-11 bit PWM mode must be in the same
