 ...
 * |--------------|--------------------------|------|-------|-------|------|
 * |Base          |                          |  148 |     0 |     0 |    2 |
 * |Init          |EFM8PDL_ADC0_USE_INIT     | +92  |     0 |     0 |   +7 |
 * |Auto Page     |EFM8PDL_ADC0_AUTO_PAGE    | +315 |     0 |     0 |   +3 |
 * |Default (All) |                          |  327 |     0 |     0 |   12 |
 *
 *****************************************************************************/
...
typedef enum {
    ADC0_CONVERSION_START_MANUAL    = ADC0CN1_ADCM__ADBUSY, //!< Conversions are only started manually, with ADC0_startConversion()
    ADC0_CONVERSION_START_TIMER0    = ADC0CN1_ADCM__TIMER0, //!< Timer0 Overflow starts a conversion.
    ADC0_CONVERSION_START_TIMER2    = ADC0CN1_ADCM__TIMER2, //!< Timer2 Overflow starts a conversion.
    ADC0_CONVERSION_START_TIMER3    = ADC0CN1_ADCM__TIMER3, //!< Timer3 Overflow starts a conversion.
    ADC0_CONVERSION_START_CNVSTR    = ADC0CN1_ADCM__CNVSTR, //!< Rising edge of CNVSTR pin starts a conversion.
    ADC0_CONVERSION_START_CEX2      = ADC0CN1_ADCM__CEX2,   //!< Rising edge of PCA CEX2 starts a conversion.
    ADC0_CONVERSION_START_GATED_TIMER_2 = ADC0CN1_ADCM__GATED_TIMER2, //!< Gated Timer2 Overflow starts a conversion when CEX2 is logic high..
    ADC0_CONVERSION_START_TIMER4    = ADC0CN1_ADCM__TIMER4, //!< Timer5 Overflow starts a conversion.
}ADC0_ConversionStart_t ;

/// @brief ADC Resolution Enum.
typedef enum {
    ADC0_RESOLUTION_8_BIT  = ADC0CF_AD8BE__8_BIT,            //!< Select 8-bit resolution
    ADC0_RESOLUTION_31_BIT = ADC0AC_AD12BE__12_BIT_DISABLED, //!< Select 31-bit resolution.
...
typedef enum {
    ...
    ADC0_POSITIVE_INPUT_P31, //!< ADC0P31 is ADC Positive Input
    ...
    ADC0_POSITIVE_INPUT_USB_DP = 28, //!< USB D+ Pin is ADC Positive Input
	ADC0_POSITIVE_INPUT_USB_DM = 29, //!< USB D- Pin is ADC Positive Input
    ADC0_POSITIVE_INPUT_VREGIN_DIV_4 = 30, //!< VREGIN/4 is ADC Positive Input
