...
#else
#define USB_IsVbusOn() ((bool)(REG01CN & REG01CN_VBSTAT__SET))
#endif
...
#define USB_SuspendRegulator() \
  do \
  { \
    REG01CN |= (REG01CN_REG1MD__LOW_POWER | REG01CN_REG0MD__LOW_POWER); \
  } while (0)
#endif
...
#else
#define USB_IsRegulatorEnabled() (!(REG01CN & REG01CN_REG0DIS__DISABLED))
#endif
