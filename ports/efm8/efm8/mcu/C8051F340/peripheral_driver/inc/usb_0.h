 ...
 * @note        This function is not implemented on this device.
 *              Use USB_SetSuspendClock().
 *
 ******************************************************************************/
#ifdef IS_DOXYGEN
 ...
 * @details      This function does not shutdown the multiplier or HFOSC.
 * @note        This function is implemented as a macro.
 ******************************************************************************/
#ifdef IS_DOXYGEN
...
#else
#define USB_DisablePrefetch() do {PFE0CN &= ~PFE0CN_PFEN__ENABLED;} while (0)
#endif
...
#else
#define USB_EnablePrefetch() do {PFE0CN |= PFE0CN_PFEN__ENABLED;} while (0)
#endif
...
#else
#define USB_IsPrefetchEnabled() ((bool)(PFE0CN & PFE0CN_PFEN__ENABLED))
#endif
