...
/**************************************************************************//**
 * @addtogroup dac_2 DAC2 Driver
 * @{
 *
 * @brief Peripheral driver for DAC2
 *
 * # Introduction #
 *
 * This module provides an API for using the DAC2 peripheral. This includes
 ...
 * |--------------|--------------------------|------|-------|-------|------|
 * |Base          |                          |  29  |     0 |     0 |   0.1|
 * |Init          |EFM8PDL_DAC2_USE_INIT     | +18  |     0 |     0 |   0  |
 * |Auto Page     |EFM8PDL_DAC2_AUTO_PAGE    | +45  |     0 |     0 |  +1  |
 * |Default (All) |                          |  92  |     0 |     0 |   1.1|
 *
 * ## Setting Output Voltage ##
 * The DAC2 module is used to output a user determined voltage to a pin. The
 ...
 * using the simple initialization function DAC2_init(), or when generating 
 ...
 * is driven on the output pin. This can be accomplished through the DAC2_enable()
 * and DAC2_disable() functions.
 *
 ...
 ******************************************************************************/
/**************************************************************************//**
 * @def EFM8PDL_DAC2_AUTO_PAGE
 * @brief Controls if the library handles SI_SFR paging.
 *
 * When '1' the DAC2 driver automatically handles setting and restoring
 ...
 *****************************************************************************/
 /**************************************************************************//**
 * @def EFM8PDL_DAC2_USE_INIT
 * @brief Controls inclusion of DAC2 Initialization function.
 *
 * When '1' the DAC2_init() function is available for use. This provides a
...
#ifndef EFM8PDL_DAC2_AUTO_PAGE
 #define EFM8PDL_DAC2_AUTO_PAGE 1
#endif

#ifndef EFM8PDL_DAC2_USE_INIT
 #define EFM8PDL_DAC2_USE_INIT 1
#endif

// Initialization API
/**************************************************************************//**
 * @addtogroup dac2_init DAC2 Initialization API
 * @{
 *****************************************************************************/
 
/// @brief Output Update Trigger Source Enum.
typedef enum {
    DAC2_UPDATE_TRIGGER_SYSCLK  = DAC2CF0_UPDATE__SYSCLK, //!< DAC2 output updates occur on every SYSCLK clock cycle
    DAC2_UPDATE_TRIGGER_TIMER3  = DAC2CF0_UPDATE__TIMER3, //!< DAC2 output updates occur on Timer 3 high byte overflow
    DAC2_UPDATE_TRIGGER_TIMER4  = DAC2CF0_UPDATE__TIMER4, //!< DAC2 output updates occur on Timer 4 high byte overflow
    DAC2_UPDATE_TRIGGER_TIMER5  = DAC2CF0_UPDATE__TIMER5, //!< DAC2 output updates occur on Timer 5 high byte overflow
    DAC2_UPDATE_TRIGGER_CLU0    = DAC2CF0_UPDATE__CLU0, //!< DAC2 output updates occur on Configurable Logic output 0 rising edge
    DAC2_UPDATE_TRIGGER_CLU1    = DAC2CF0_UPDATE__CLU1,   //!< DAC2 output updates occur on Configurable Logic output 1 rising edge
    DAC2_UPDATE_TRIGGER_CLU2    = DAC2CF0_UPDATE__CLU2, //!< DAC2 output updates occur on Configurable Logic output 2 rising edge
    DAC2_UPDATE_TRIGGER_CLU3    = DAC2CF0_UPDATE__CLU3, //!< DAC2 output updates occur on Configurable Logic output 3 rising edge
  }DAC2_UpdateTrigger_t ;
...
/** @} (end dac2_init DAC2 Initialization API) */

// Runtime API
/**************************************************************************//**
 * @addtogroup dac2_runtime DAC2 Runtime API
 * @{
 *****************************************************************************/
 /***************************************************************************//**
 * @brief
 ...
 * registers, or if the DAC's output voltage is being held by DAC2_holdOutput().
 *
 ******************************************************************************/
uint16_t DAC2_getOutput(void);

/** @} (end adc0_runtime ADC0 Runtime API) */
/** @} (end addtogroup dac_2 DAC2 Driver) */
