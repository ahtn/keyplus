...
#ifndef SI_C8051F700_DEFS_H
#define SI_C8051F700_DEFS_H
...
SFR (CRC0CN,   0x91); ///< CRC0 Control                                     
SFR (CRC0CNT,  0x97); ///< CRC0 Automatic Flash Sector Count                
SFR (CRC0DAT,  0xD9); ///< CRC0 Data Output                                 
SFR (CRC0FLIP, 0x95); ///< CRC0 Bit Flip                                    
SFR (CRC0IN,   0x94); ///< CRC0 Data Input                                  
SFR (CS0CF,    0x9E); ///< Capacitive Sense 0 Configuration                 
SFR (CS0CN,    0x9A); ///< Capacitive Sense 0 Control                       
SFR (CS0DH,    0xAA); ///< Capacitive Sense 0 Data High Byte                
SFR (CS0DL,    0xA9); ///< Capacitive Sense 0 Data Low Byte                 
SFR (CS0MD1,   0xAD); ///< Capacitive Sense 0 Mode 1                        
SFR (CS0MD2,   0xBE); ///< Capacitive Sense 0 Mode 2                        
SFR (CS0MX,    0x9C); ///< Capacitive Sense 0 Mux Channel Select            
SFR (CS0PM,    0x9F); ///< Capacitive Sense 0 Pin Monitor                   
SFR (CS0SE,    0x93); ///< Capacitive Sense 0 Auto Scan End Channel         
SFR (CS0SS,    0x92); ///< Capacitive Sense 0 Auto Scan Start Channel       
SFR (CS0THH,   0x97); ///< Capacitive Sense 0 Comparator Threshold High Byte
SFR (CS0THL,   0x96); ///< Capacitive Sense 0 Comparator Threshold Low Byte 
SFR (DERIVID,  0xEC); ///< Derivative Identification                        
SFR (DEVICEID, 0xC4); ///< Device Identification                            
SFR (DPH,      0x83); ///< Data Pointer High                                
SFR (DPL,      0x82); ///< Data Pointer Low                                 
SFR (EEADR,    0xB6); ///< EEPROM Byte Address                              
SFR (EECN,     0xC5); ///< EEPROM Control                                   
SFR (EEDAT,    0xD1); ///< EEPROM Byte Data                                 
SFR (EEKEY,    0xC6); ///< EEPROM Key                                       
SFR (EIE1,     0xE6); ///< Extended Interrupt Enable 1                      
SFR (EIE2,     0xE7); ///< Extended Interrupt Enable 2                      
SFR (EIP1,     0xCE); ///< Extended Interrupt Priority 1                    
SFR (EIP2,     0xCF); ///< Extended Interrupt Priority 2                    
SFR (EMI0CF,   0xC7); ///< External Memory Configuration                    
SFR (EMI0CN,   0xAA); ///< External Memory Interface Control                
SFR (EMI0TC,   0xEE); ///< External Memory Timing Control                   
SFR (FLKEY,    0xB7); ///< Flash Lock and Key                               
SFR (IE,       0xA8); ///< Interrupt Enable                                 
SFR (IP,       0xB8); ///< Interrupt Priority                               
SFR (IT01CF,   0xE4); ///< INT0/INT1 Configuration                          
SFR (OSCICL,   0xBF); ///< High Frequency Oscillator Calibration            
SFR (OSCICN,   0xA9); ///< High Frequency Oscillator Control                
...
SFR (REVID,    0xAD); ///< Revision Identifcation                           
...
SFR (SMB0ADM,  0xBB); ///< SMBus 0 Slave Address Mask                       
SFR (SMB0ADR,  0xBA); ///< SMBus 0 Slave Address                            
...
SFR16 (CS0D,    0xA9); ///< Capacitive Sense 0 Data                 
SFR16 (CS0TH,   0x96); ///< Capacitive Sense 0 Comparator Threshold 
