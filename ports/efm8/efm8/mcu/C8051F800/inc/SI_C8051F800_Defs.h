...
#ifndef SI_C8051F800_DEFS_H
#define SI_C8051F800_DEFS_H
...
SFR (CS0DH,    0xAC); ///< Capacitive Sense 0 Data High Byte                
SFR (CS0DL,    0xAB); ///< Capacitive Sense 0 Data Low Byte                 
SFR (CS0MX,    0x9C); ///< Capacitive Sense 0 Mux Channel Select            
SFR (CS0SE,    0xBA); ///< Capacitive Sense 0 Auto Scan End Channel         
SFR (CS0SS,    0xB9); ///< Capacitive Sense 0 Auto Scan Start Channel       
...
SFR16 (CS0D,    0xAB); ///< Capacitive Sense 0 Data                 
