...
#ifndef SI_EFM8UB4_REGISTER_ENUMS_H
#define SI_EFM8UB4_REGISTER_ENUMS_H

//Standard device includes
#include "SI_EFM8UB4_Defs.h"
//------------------------------------------------------------------------------
...
#define DERIVID_DERIVID__EFM8UB40F40G_QFN20  0x40 ///< EFM8UB40F40G-{R}-QFN20 
#define DERIVID_DERIVID__EFM8UB41F40G_QFN20  0x41 ///< EFM8UB41F40G-{R}-QFN20 
#define DERIVID_DERIVID__EFM8UB42F40G_QFN24  0x42 ///< EFM8UB42F40G-{R}-QFN24 
#define DERIVID_DERIVID__EFM8UB42F40G_QSOP24 0x43 ///< EFM8UB42F40G-{R}-QSOP24
#define DERIVID_DERIVID__EFM8UB42F40G_QFN32  0x44 ///< EFM8UB42F40G-{R}-QFN32 
...
#define EIE2_EPD0__BMASK     0x10 ///< USB Type-C Power Delivery 0 Interrupt Enable      
#define EIE2_EPD0__SHIFT     0x04 ///< USB Type-C Power Delivery 0 Interrupt Enable      
#define EIE2_EPD0__DISABLED  0x00 ///< Disable Power Delivery 0 interrupts.              
#define EIE2_EPD0__ENABLED   0x10 ///< Enable interrupt requests generated by the Power  
                                  ///< Delivery 0 flags.                                 
                                                                                         
#define EIE2_EPD1__BMASK     0x20 ///< USB Type-C Power Delivery 1 Interrupt Enable      
#define EIE2_EPD1__SHIFT     0x05 ///< USB Type-C Power Delivery 1 Interrupt Enable      
#define EIE2_EPD1__DISABLED  0x00 ///< Disable Power Delivery 1 interrupts.              
#define EIE2_EPD1__ENABLED   0x20 ///< Enable interrupt requests generated by the Power  
                                  ///< Delivery 1 flags.                                 
...
#define EIP2_PPD0__BMASK  0x10 ///< USB Type-C Power Delivery 0 Priority Control LSB          
#define EIP2_PPD0__SHIFT  0x04 ///< USB Type-C Power Delivery 0 Priority Control LSB          
#define EIP2_PPD0__LOW    0x00 ///< Power Delivery 0 interrupt priority LSB set to            
                               ///< low.                                                      
#define EIP2_PPD0__HIGH   0x10 ///< Power Delivery 0 interrupt priority LSB set to            
                               ///< high.                                                     
                                                                                              
#define EIP2_PPD1__BMASK  0x20 ///< USB Type-C Power Delivery 1 Priority Control LSB          
#define EIP2_PPD1__SHIFT  0x05 ///< USB Type-C Power Delivery 1 Priority Control LSB          
#define EIP2_PPD1__LOW    0x00 ///< Power Delivery 1 interrupt priority LSB set to            
                               ///< low.                                                      
#define EIP2_PPD1__HIGH   0x20 ///< Power Delivery 1 interrupt priority LSB set to            
                               ///< high.                                                     
...
#define EIP2H_PHPD0__BMASK  0x10 ///< USB Type-C Power Delivery 0 Interrupt Priority Control MSB
#define EIP2H_PHPD0__SHIFT  0x04 ///< USB Type-C Power Delivery 0 Interrupt Priority Control MSB
#define EIP2H_PHPD0__LOW    0x00 ///< Power Delivery 0 interrupt priority MSB set to            
                                 ///< low.                                                      
#define EIP2H_PHPD0__HIGH   0x10 ///< Power Delivery 0 interrupt priority MSB set to            
                                 ///< high.                                                     
                                                                                                
#define EIP2H_PHPD1__BMASK  0x20 ///< USB Type-C Power Delivery 1 Interrupt Priority Control MSB
#define EIP2H_PHPD1__SHIFT  0x05 ///< USB Type-C Power Delivery 1 Interrupt Priority Control MSB
#define EIP2H_PHPD1__LOW    0x00 ///< Power Delivery 1 interrupt priority MSB set to            
                                 ///< low.                                                      
#define EIP2H_PHPD1__HIGH   0x20 ///< Power Delivery 1 interrupt priority MSB set to            
                                 ///< high.                                                     
...
#define PSTAT0_PD0WK__BMASK     0x40 ///< PD0 Wake-up Event                                 
#define PSTAT0_PD0WK__SHIFT     0x06 ///< PD0 Wake-up Event                                 
#define PSTAT0_PD0WK__NOT_SET   0x00 ///< A PD0 interrupt-enabled event did not occur.      
#define PSTAT0_PD0WK__SET       0x40 ///< A PD0 interrupt-enabled event occurred.           
                                                                                            
#define PSTAT0_PD1WK__BMASK     0x80 ///< PD1 Wake-up Event                                 
#define PSTAT0_PD1WK__SHIFT     0x07 ///< PD1 Wake-up Event                                 
#define PSTAT0_PD1WK__NOT_SET   0x00 ///< A PD1 interrupt-enabled event did not occur.      
#define PSTAT0_PD1WK__SET       0x80 ///< A PD1 interrupt-enabled event occurred.           
...
#define TMR4CN1_RLFSEL__PD0_BUSY    0x00 ///< If PD0TOE is 0, then this is always 0. If PD0TOE 
                                         ///< is 1, then the timer will only reload on overflow
                                         ///< events and when the PD0 Busy signal is high.     
...
#define TMR5CN1_RLFSEL__PD1         0x00 ///< If PD1TOE is 0, then this is always 0. If PD1TOE 
                                         ///< is 1, then the timer will only reload on overflow
                                         ///< events and when the PD1 Busy signal is high.     
...
//------------------------------------------------------------------------------
// UPD0CC Enums (PD0 CC Configuration @ 0xAA)
//------------------------------------------------------------------------------
#define UPD0CC_ENCC1RD__BMASK    0x01 ///< CC1 RD Pull-Down Enable                           
#define UPD0CC_ENCC1RD__SHIFT    0x00 ///< CC1 RD Pull-Down Enable                           
#define UPD0CC_ENCC1RD__DISABLED 0x00 ///< Disable the RD pull-down resistor.                
#define UPD0CC_ENCC1RD__ENABLED  0x01 ///< Enable the RD pull-down resistor.                 
                                                                                             
#define UPD0CC_ENCC1IP__BMASK    0x02 ///< CC1 Ip Pull-Up Enable                             
#define UPD0CC_ENCC1IP__SHIFT    0x01 ///< CC1 Ip Pull-Up Enable                             
#define UPD0CC_ENCC1IP__DISABLED 0x00 ///< Disable the Ip pull-up current source at the CC1  
                                      ///< pin.                                              
#define UPD0CC_ENCC1IP__ENABLED  0x02 ///< Enable the Ip pull-up current source at the CC1   
                                      ///< pin. The Ip value is configured by the IPPW field.
                                                                                             
#define UPD0CC_CC1OVP__BMASK     0x04 ///< CC1 Overvoltage Flag                              
#define UPD0CC_CC1OVP__SHIFT     0x02 ///< CC1 Overvoltage Flag                              
#define UPD0CC_CC1OVP__NOT_SET   0x00 ///< The CC1 pin voltage is less than or equal to VDD. 
#define UPD0CC_CC1OVP__SET       0x04 ///< The CC1 pin voltage is greater than VDD.          
                                                                                             
#define UPD0CC_ENCC2RD__BMASK    0x08 ///< CC2 RD Pull-Down Enable                           
#define UPD0CC_ENCC2RD__SHIFT    0x03 ///< CC2 RD Pull-Down Enable                           
#define UPD0CC_ENCC2RD__DISABLED 0x00 ///< Disable the RD pull-down resistor.                
#define UPD0CC_ENCC2RD__ENABLED  0x08 ///< Enable the RD pull-down resistor.                 
                                                                                             
#define UPD0CC_ENCC2IP__BMASK    0x10 ///< CC2 Ip Pull-Up Enable                             
#define UPD0CC_ENCC2IP__SHIFT    0x04 ///< CC2 Ip Pull-Up Enable                             
#define UPD0CC_ENCC2IP__DISABLED 0x00 ///< Disable the Ip pull-up current source at the CC2  
                                      ///< pin.                                              
#define UPD0CC_ENCC2IP__ENABLED  0x10 ///< Enable the Ip pull-up current source at the CC2   
                                      ///< pin. The Ip value is configured by the IPPW field.
                                                                                             
#define UPD0CC_CC2OVP__BMASK     0x20 ///< CC2 Overvoltage Flag                              
#define UPD0CC_CC2OVP__SHIFT     0x05 ///< CC2 Overvoltage Flag                              
#define UPD0CC_CC2OVP__NOT_SET   0x00 ///< The CC2 pin voltage is less than or equal to VDD. 
#define UPD0CC_CC2OVP__SET       0x20 ///< The CC2 pin voltage is greater than VDD.          
                                                                                             
#define UPD0CC_AUTOOVP__BMASK    0x40 ///< Automatic Overvoltage Protection Enable           
#define UPD0CC_AUTOOVP__SHIFT    0x06 ///< Automatic Overvoltage Protection Enable           
#define UPD0CC_AUTOOVP__DISABLED 0x00 ///< Disable automatic change in Ip.                   
#define UPD0CC_AUTOOVP__ENABLED  0x40 ///< Enable overvoltage protection of the CC pins by   
                                      ///< switching off Ip current when either CC1OVP or    
                                      ///< CC2OVP are set. This setting functions only when  
                                      ///< ENOVP is set to 1.                                
                                                                                             
#define UPD0CC_ENOVP__BMASK      0x80 ///< Overvoltage Monitor Enable                        
#define UPD0CC_ENOVP__SHIFT      0x07 ///< Overvoltage Monitor Enable                        
#define UPD0CC_ENOVP__DISABLED   0x00 ///< Disable over voltage monitoring for CC1 and CC2.  
#define UPD0CC_ENOVP__ENABLED    0x80 ///< Enable over voltage monitoring for CC1 and CC2.   
                                                                                             
//------------------------------------------------------------------------------
// UPD0CN0 Enums (PD0 Control @ 0x88)
//------------------------------------------------------------------------------
#define UPD0CN0_FORCERX__BMASK    0x01 ///< Force RX Enable                         
#define UPD0CN0_FORCERX__SHIFT    0x00 ///< Force RX Enable                         
#define UPD0CN0_FORCERX__DISABLED 0x00 ///< PD0 Receiver is not enabled during TX.  
#define UPD0CN0_FORCERX__ENABLED  0x01 ///< PD0 Receiver is enabled during TX.      
                                                                                    
#define UPD0CN0_IPPW__FMASK       0x06 ///< Pull-Up Current Source Select           
#define UPD0CN0_IPPW__SHIFT       0x01 ///< Pull-Up Current Source Select           
#define UPD0CN0_IPPW__80_UA       0x02 ///< Configures the current source to 80 uA. 
#define UPD0CN0_IPPW__180_UA      0x04 ///< Configures the current source to 180 uA.
#define UPD0CN0_IPPW__330_UA      0x06 ///< Configures the current source to 330 uA.
                                                                                    
#define UPD0CN0_ENREF__BMASK      0x08 ///< Reference Buffer Enable                 
#define UPD0CN0_ENREF__SHIFT      0x03 ///< Reference Buffer Enable                 
#define UPD0CN0_ENREF__DISABLED   0x00 ///< Disable the PD0 reference buffer.       
#define UPD0CN0_ENREF__ENABLED    0x08 ///< Enable the PD0 reference buffer.        
                                                                                    
#define UPD0CN0_CCSEL__BMASK      0x80 ///< CC Pad Select                           
#define UPD0CN0_CCSEL__SHIFT      0x07 ///< CC Pad Select                           
#define UPD0CN0_CCSEL__CC1        0x00 ///< Selects CC1 pin for CC connection.      
#define UPD0CN0_CCSEL__CC2        0x80 ///< Selects CC2 pin for CC connection.      
                                                                                    
//------------------------------------------------------------------------------
// UPD0CRC0 Enums (PD0 CRC 0 @ 0xA3)
//------------------------------------------------------------------------------
#define UPD0CRC0_CRC0__FMASK 0xFF ///< CRC32 Byte 0
#define UPD0CRC0_CRC0__SHIFT 0x00 ///< CRC32 Byte 0
                                                   
//------------------------------------------------------------------------------
// UPD0CRC1 Enums (PD0 CRC 1 @ 0xA4)
//------------------------------------------------------------------------------
#define UPD0CRC1_CRC1__FMASK 0xFF ///< CRC32 Byte 1
#define UPD0CRC1_CRC1__SHIFT 0x00 ///< CRC32 Byte 1
                                                   
//------------------------------------------------------------------------------
// UPD0CRC2 Enums (PD0 CRC 2 @ 0xA5)
//------------------------------------------------------------------------------
#define UPD0CRC2_CRC2__FMASK 0xFF ///< CRC32 Byte 2
#define UPD0CRC2_CRC2__SHIFT 0x00 ///< CRC32 Byte 2
                                                   
//------------------------------------------------------------------------------
// UPD0CRC3 Enums (PD0 CRC 3 @ 0xA6)
//------------------------------------------------------------------------------
#define UPD0CRC3_CRC3__FMASK 0xFF ///< CRC32 Byte 3
#define UPD0CRC3_CRC3__SHIFT 0x00 ///< CRC32 Byte 3
                                                   
//------------------------------------------------------------------------------
// UPD0DAT Enums (PD0 Transmit and Receive Buffer @ 0x9A)
//------------------------------------------------------------------------------
#define UPD0DAT_PDDAT__FMASK 0xFF ///< PD0 Transmit and Receive Buffer
#define UPD0DAT_PDDAT__SHIFT 0x00 ///< PD0 Transmit and Receive Buffer
                                                                      
//------------------------------------------------------------------------------
// UPD0FCN0 Enums (PD0 FIFO Control 0 @ 0x9B)
//------------------------------------------------------------------------------
#define UPD0FCN0_RXTH__FMASK     0x03 ///< RX FIFO Threshold                                 
#define UPD0FCN0_RXTH__SHIFT     0x00 ///< RX FIFO Threshold                                 
#define UPD0FCN0_RXTH__NOT_EMPTY 0x00 ///< RFRQ will be set anytime new data arrives in the  
                                      ///< RX FIFO (when the RX FIFO is not empty).          
#define UPD0FCN0_RXTH__1_BYTE    0x01 ///< RFRQ will be set if the RX FIFO contains more than
                                      ///< one byte.                                         
                                                                                             
#define UPD0FCN0_RFLSH__BMASK    0x04 ///< RX FIFO Flush                                     
#define UPD0FCN0_RFLSH__SHIFT    0x02 ///< RX FIFO Flush                                     
#define UPD0FCN0_RFLSH__SET      0x04 ///< Flush the RX FIFO.                                
                                                                                             
#define UPD0FCN0_RFRQE__BMASK    0x08 ///< Read Request Interrupt Enable                     
#define UPD0FCN0_RFRQE__SHIFT    0x03 ///< Read Request Interrupt Enable                     
#define UPD0FCN0_RFRQE__DISABLED 0x00 ///< PD0 interrupts will not be generated when RFRQ is 
                                      ///< set.                                              
#define UPD0FCN0_RFRQE__ENABLED  0x08 ///< PD0 interrupts will be generated when RFRQ is set.
                                                                                             
#define UPD0FCN0_TXTH__FMASK     0x30 ///< TX FIFO Threshold                                 
#define UPD0FCN0_TXTH__SHIFT     0x04 ///< TX FIFO Threshold                                 
#define UPD0FCN0_TXTH__EMPTY     0x00 ///< TFRQ will be set when the TX FIFO is empty.       
#define UPD0FCN0_TXTH__1_BYTE    0x10 ///< TFRQ will be set when the TX FIFO contains one or 
                                      ///< fewer bytes.                                      
                                                                                             
#define UPD0FCN0_TFLSH__BMASK    0x40 ///< TX FIFO Flush                                     
#define UPD0FCN0_TFLSH__SHIFT    0x06 ///< TX FIFO Flush                                     
#define UPD0FCN0_TFLSH__SET      0x40 ///< Flush the TX FIFO.                                
                                                                                             
#define UPD0FCN0_TFRQE__BMASK    0x80 ///< Write Request Interrupt Enable                    
#define UPD0FCN0_TFRQE__SHIFT    0x07 ///< Write Request Interrupt Enable                    
#define UPD0FCN0_TFRQE__DISABLED 0x00 ///< PD0 interrupts will not be generated when TFRQ is 
                                      ///< set.                                              
#define UPD0FCN0_TFRQE__ENABLED  0x80 ///< PD0 interrupts will be generated when TFRQ is set.
                                                                                             
//------------------------------------------------------------------------------
// UPD0FCN1 Enums (PD0 FIFO Control 1 @ 0x9C)
//------------------------------------------------------------------------------
#define UPD0FCN1_RXOVRUN__BMASK   0x01 ///< RX FIFO Overrun                                   
#define UPD0FCN1_RXOVRUN__SHIFT   0x00 ///< RX FIFO Overrun                                   
#define UPD0FCN1_RXOVRUN__NOT_SET 0x00 ///< The RX FIFO has not overrun. The last byte was    
                                       ///< received when the RX FIFO was not full.           
#define UPD0FCN1_RXOVRUN__SET     0x01 ///< The RX FIFO has overrun. This occurs when a new   
                                       ///< byte arrives when the RX FIFO is already full.    
                                                                                              
#define UPD0FCN1_RXE__BMASK       0x04 ///< RX FIFO Empty                                     
#define UPD0FCN1_RXE__SHIFT       0x02 ///< RX FIFO Empty                                     
#define UPD0FCN1_RXE__NOT_SET     0x00 ///< The RX FIFO contains data.                        
#define UPD0FCN1_RXE__SET         0x04 ///< The RX FIFO is empty.                             
                                                                                              
#define UPD0FCN1_RFRQ__BMASK      0x08 ///< Receive FIFO Request                              
#define UPD0FCN1_RFRQ__SHIFT      0x03 ///< Receive FIFO Request                              
#define UPD0FCN1_RFRQ__NOT_SET    0x00 ///< The number of bytes in the RX FIFO is less than or
                                       ///< equal to RXTH.                                    
#define UPD0FCN1_RFRQ__SET        0x08 ///< The number of bytes in the RX FIFO is greater than
                                       ///< RXTH.                                             
                                                                                              
#define UPD0FCN1_TXNF__BMASK      0x40 ///< TX FIFO Not Full                                  
#define UPD0FCN1_TXNF__SHIFT      0x06 ///< TX FIFO Not Full                                  
#define UPD0FCN1_TXNF__NOT_SET    0x00 ///< The TX FIFO is full.                              
#define UPD0FCN1_TXNF__SET        0x40 ///< The TX FIFO has room for more data.               
                                                                                              
#define UPD0FCN1_TFRQ__BMASK      0x80 ///< Transmit FIFO Request                             
#define UPD0FCN1_TFRQ__SHIFT      0x07 ///< Transmit FIFO Request                             
#define UPD0FCN1_TFRQ__NOT_SET    0x00 ///< The number of bytes in the TX FIFO is greater than
                                       ///< TXTH.                                             
#define UPD0FCN1_TFRQ__SET        0x80 ///< The number of bytes in the TX FIFO is less than or
                                       ///< equal to TXTH.                                    
                                                                                              
//------------------------------------------------------------------------------
// UPD0FCT Enums (PD0 FIFO Count @ 0x9D)
//------------------------------------------------------------------------------
#define UPD0FCT_RXCNT__FMASK 0x03 ///< RX FIFO Count
#define UPD0FCT_RXCNT__SHIFT 0x00 ///< RX FIFO Count
                                                    
#define UPD0FCT_TXCNT__FMASK 0x30 ///< TX FIFO Count
#define UPD0FCT_TXCNT__SHIFT 0x04 ///< TX FIFO Count
                                                    
//------------------------------------------------------------------------------
// UPD0INTEN Enums (PD0 Interrupt Enable @ 0x9F)
//------------------------------------------------------------------------------
#define UPD0INTEN_PRERIE__BMASK      0x01 ///< Preamble Received Interrupt Enable                
#define UPD0INTEN_PRERIE__SHIFT      0x00 ///< Preamble Received Interrupt Enable                
#define UPD0INTEN_PRERIE__DISABLED   0x00 ///< PD0 interrupt will not be generated when the PRERF
                                          ///< flag is set.                                      
#define UPD0INTEN_PRERIE__ENABLED    0x01 ///< PD0 interrupt will be generated when the PRERF    
                                          ///< flag is set.                                      
                                                                                                 
#define UPD0INTEN_OSRIE__BMASK       0x02 ///< Ordered Set Received Interrupt Enable             
#define UPD0INTEN_OSRIE__SHIFT       0x01 ///< Ordered Set Received Interrupt Enable             
#define UPD0INTEN_OSRIE__DISABLED    0x00 ///< PD0 interrupt will not be generated when the OSRF 
                                          ///< flag is set.                                      
#define UPD0INTEN_OSRIE__ENABLED     0x02 ///< PD0 interrupt will be generated when the OSRF flag
                                          ///< is set.                                           
                                                                                                 
#define UPD0INTEN_EOPRIE__BMASK      0x04 ///< EOP Received Interrupt Enable                     
#define UPD0INTEN_EOPRIE__SHIFT      0x02 ///< EOP Received Interrupt Enable                     
#define UPD0INTEN_EOPRIE__DISABLED   0x00 ///< PD0 interrupt will not be generated when the EOPRF
                                          ///< flag is set.                                      
#define UPD0INTEN_EOPRIE__ENABLED    0x04 ///< PD0 interrupt will be generated when the EOPRF    
                                          ///< flag is set.                                      
                                                                                                 
#define UPD0INTEN_IDLEIE__BMASK      0x08 ///< CC Line Idle Interrupt Enable                     
#define UPD0INTEN_IDLEIE__SHIFT      0x03 ///< CC Line Idle Interrupt Enable                     
#define UPD0INTEN_IDLEIE__DISABLED   0x00 ///< PD0 interrupt will not be generated when the IDLEF
                                          ///< flag is set.                                      
#define UPD0INTEN_IDLEIE__ENABLED    0x08 ///< PD0 interrupt will be generated when the IDLEF    
                                          ///< flag is set.                                      
                                                                                                 
#define UPD0INTEN_BMCERRIE__BMASK    0x10 ///< Received BMC Error Interrupt Enable               
#define UPD0INTEN_BMCERRIE__SHIFT    0x04 ///< Received BMC Error Interrupt Enable               
#define UPD0INTEN_BMCERRIE__DISABLED 0x00 ///< PD0 interrupt will not be generated when the      
                                          ///< BMCERRF flag is set.                              
#define UPD0INTEN_BMCERRIE__ENABLED  0x10 ///< PD0 interrupt will be generated when the BMCERRF  
                                          ///< flag is set.                                      
                                                                                                 
#define UPD0INTEN_TXDONEIE__BMASK    0x20 ///< TX Transmit Done Interrupt Enable                 
#define UPD0INTEN_TXDONEIE__SHIFT    0x05 ///< TX Transmit Done Interrupt Enable                 
#define UPD0INTEN_TXDONEIE__DISABLED 0x00 ///< PD0 interrupt will not be generated when the      
                                          ///< TXDONE flag is set.                               
#define UPD0INTEN_TXDONEIE__ENABLED  0x20 ///< PD0 interrupt will be generated when the TXDONE   
                                          ///< flag is set.                                      
                                                                                                 
//------------------------------------------------------------------------------
// UPD0INTSTAT Enums (PD0 Interrupt Status @ 0x9E)
//------------------------------------------------------------------------------
#define UPD0INTSTAT_PRERF__BMASK     0x01 ///< Preamble Received Flag                            
#define UPD0INTSTAT_PRERF__SHIFT     0x00 ///< Preamble Received Flag                            
#define UPD0INTSTAT_PRERF__NOT_SET   0x00 ///< No preamble received.                             
#define UPD0INTSTAT_PRERF__SET       0x01 ///< Preamble received.                                
                                                                                                 
#define UPD0INTSTAT_OSRF__BMASK      0x02 ///< Ordered Set Received Flag                         
#define UPD0INTSTAT_OSRF__SHIFT      0x01 ///< Ordered Set Received Flag                         
#define UPD0INTSTAT_OSRF__NOT_SET    0x00 ///< Ordered set bits not yet received into UPD0RXKC1-4
                                          ///< SFRs.                                             
#define UPD0INTSTAT_OSRF__SET        0x02 ///< Complete ordered set bits received into           
                                          ///< UPD0RXKC1-4 SFRs.                                 
                                                                                                 
#define UPD0INTSTAT_EOPRF__BMASK     0x04 ///< EOP Received Flag                                 
#define UPD0INTSTAT_EOPRF__SHIFT     0x02 ///< EOP Received Flag                                 
#define UPD0INTSTAT_EOPRF__NOT_SET   0x00 ///< EOP has not been received by the PD.              
#define UPD0INTSTAT_EOPRF__SET       0x04 ///< EOP has been received by the PD.                  
                                                                                                 
#define UPD0INTSTAT_IDLEF__BMASK     0x08 ///< CC Line Idle Flag                                 
#define UPD0INTSTAT_IDLEF__SHIFT     0x03 ///< CC Line Idle Flag                                 
#define UPD0INTSTAT_IDLEF__NOT_SET   0x00 ///< RX core has not detected a transition of RXBUSY   
                                          ///< from busy to idle.                                
#define UPD0INTSTAT_IDLEF__SET       0x08 ///< RX core detected a transition of RXBUSY from busy 
                                          ///< to idle.                                          
                                                                                                 
#define UPD0INTSTAT_BMCERRF__BMASK   0x10 ///< Received BMC Error Flag                           
#define UPD0INTSTAT_BMCERRF__SHIFT   0x04 ///< Received BMC Error Flag                           
#define UPD0INTSTAT_BMCERRF__NOT_SET 0x00 ///< BMC error has not occurred.                       
#define UPD0INTSTAT_BMCERRF__SET     0x10 ///< BMC error occurred.                               
                                                                                                 
#define UPD0INTSTAT_TXDONE__BMASK    0x20 ///< TX Transmit Done Flag                             
#define UPD0INTSTAT_TXDONE__SHIFT    0x05 ///< TX Transmit Done Flag                             
#define UPD0INTSTAT_TXDONE__NOT_SET  0x00 ///< The transmit BUSY flag has not transitioned from  
                                          ///< busy to idle.                                     
#define UPD0INTSTAT_TXDONE__SET      0x20 ///< The transmit BUSY flag has transitioned from busy 
                                          ///< to idle.                                          
                                                                                                 
//------------------------------------------------------------------------------
// UPD0RXCN0 Enums (PD0 Receive Control @ 0x91)
//------------------------------------------------------------------------------
#define UPD0RXCN0_EN__BMASK          0x01 ///< PD Receive Enable                                 
#define UPD0RXCN0_EN__SHIFT          0x00 ///< PD Receive Enable                                 
#define UPD0RXCN0_EN__DISABLED       0x00 ///< Disable the PD Receiver.                          
#define UPD0RXCN0_EN__ENABLED        0x01 ///< Enable the PD Receiver when Transmit is not active
                                          ///< unless the FORCERX bit is set.                    
                                                                                                 
#define UPD0RXCN0_RXTO__FMASK        0x06 ///< Receive Timeout                                   
#define UPD0RXCN0_RXTO__SHIFT        0x01 ///< Receive Timeout                                   
#define UPD0RXCN0_RXTO__13_US        0x00 ///< Set RXBUSY when there are more than 2 transitions 
                                          ///< on the CC line in a 13 us window.                 
#define UPD0RXCN0_RXTO__15_US        0x02 ///< Set RXBUSY when there are more than 2 transitions 
                                          ///< on the CC line in a 15 us window.                 
#define UPD0RXCN0_RXTO__17_US        0x04 ///< Set RXBUSY when there are more than 2 transitions 
                                          ///< on the CC line in a 17 us window.                 
#define UPD0RXCN0_RXTO__19_US        0x06 ///< Set RXBUSY when there are more than 2 transitions 
                                          ///< on the CC line in a 19 us window.                 
                                                                                                 
#define UPD0RXCN0_ENLPF__BMASK       0x08 ///< Low Pass Filter Enable                            
#define UPD0RXCN0_ENLPF__SHIFT       0x03 ///< Low Pass Filter Enable                            
#define UPD0RXCN0_ENLPF__DISABLED    0x00 ///< Disable low pass filter.                          
#define UPD0RXCN0_ENLPF__ENABLED     0x08 ///< Enable low pass filter on receiver path.          
                                                                                                 
#define UPD0RXCN0_LOCKP__BMASK       0x10 ///< Preamble Lock Pattern                             
#define UPD0RXCN0_LOCKP__SHIFT       0x04 ///< Preamble Lock Pattern                             
#define UPD0RXCN0_LOCKP__1_PREAMBLE  0x00 ///< 1 preamble pattern (1101 x 1) must be detected to 
                                          ///< recover the clock on the CC line.                 
#define UPD0RXCN0_LOCKP__2_PREAMBLES 0x10 ///< 2 preamble patterns (1101 x 2) must be detected to
                                          ///< recover the clock on the CC line.                 
                                                                                                 
#define UPD0RXCN0_LOCKC__BMASK       0x20 ///< Clock Lock Pattern                                
#define UPD0RXCN0_LOCKC__SHIFT       0x05 ///< Clock Lock Pattern                                
#define UPD0RXCN0_LOCKC__2_PREAMBLES 0x00 ///< 2 preamble patterns (1101 x 2) must be detected to
                                          ///< recover the clock on the CC line.                 
#define UPD0RXCN0_LOCKC__3_PREAMBLES 0x20 ///< 3 preamble patterns (1101 x 3) must be detected to
                                          ///< recover the clock on the CC line.                 
                                                                                                 
#define UPD0RXCN0_ENEOPPRE__BMASK    0x40 ///< Preamble EOP Enable                               
#define UPD0RXCN0_ENEOPPRE__SHIFT    0x06 ///< Preamble EOP Enable                               
#define UPD0RXCN0_ENEOPPRE__DISABLED 0x00 ///< Disable EOP detection when a preamble is being    
                                          ///< received.                                         
#define UPD0RXCN0_ENEOPPRE__ENABLED  0x40 ///< Enable EOP detection when a preamble is being     
                                          ///< received.                                         
                                                                                                 
#define UPD0RXCN0_ENSKIDLE__BMASK    0x80 ///< Skip IDLE Enable                                  
#define UPD0RXCN0_ENSKIDLE__SHIFT    0x07 ///< Skip IDLE Enable                                  
#define UPD0RXCN0_ENSKIDLE__DISABLED 0x00 ///< The Idle state must occur after receiving EOP in  
                                          ///< order for the preamble to be detected.            
#define UPD0RXCN0_ENSKIDLE__ENABLED  0x80 ///< The Idle state is not required after receiving EOP
                                          ///< in order for the preamble to be detected.         
                                                                                                 
//------------------------------------------------------------------------------
// UPD0RXKC1 Enums (PD0 Receive KCODE 1 @ 0x93)
//------------------------------------------------------------------------------
#define UPD0RXKC1_KCODE1__FMASK 0x1F ///< First K-Code
#define UPD0RXKC1_KCODE1__SHIFT 0x00 ///< First K-Code
                                                      
//------------------------------------------------------------------------------
// UPD0RXKC2 Enums (PD0 Receive KCODE 2 @ 0x94)
//------------------------------------------------------------------------------
#define UPD0RXKC2_KCODE2__FMASK 0x1F ///< Second K-Code
#define UPD0RXKC2_KCODE2__SHIFT 0x00 ///< Second K-Code
                                                       
//------------------------------------------------------------------------------
// UPD0RXKC3 Enums (PD0 Receive KCODE 3 @ 0x95)
//------------------------------------------------------------------------------
#define UPD0RXKC3_KCODE3__FMASK 0x1F ///< Third K-Code
#define UPD0RXKC3_KCODE3__SHIFT 0x00 ///< Third K-Code
                                                      
//------------------------------------------------------------------------------
// UPD0RXKC4 Enums (PD0 Receive KCODE 4 @ 0x96)
//------------------------------------------------------------------------------
#define UPD0RXKC4_KCODE4__FMASK 0x1F ///< Fourth K-Code
#define UPD0RXKC4_KCODE4__SHIFT 0x00 ///< Fourth K-Code
                                                       
//------------------------------------------------------------------------------
// UPD0RXSHFT Enums (PD0 Receive Shift @ 0xA2)
//------------------------------------------------------------------------------
#define UPD0RXSHFT_RXSHREG__FMASK   0x1F ///< Received BMC Decoded Data                         
#define UPD0RXSHFT_RXSHREG__SHIFT   0x00 ///< Received BMC Decoded Data                         
                                                                                                
#define UPD0RXSHFT_NIBSTAT__BMASK   0x40 ///< Low or High Nibble Indicator                      
#define UPD0RXSHFT_NIBSTAT__SHIFT   0x06 ///< Low or High Nibble Indicator                      
#define UPD0RXSHFT_NIBSTAT__NOT_SET 0x00 ///< The data in RXSHREG decodes into the lower nibble.
#define UPD0RXSHFT_NIBSTAT__SET     0x40 ///< The data in RXSHREG decodes into the upper nibble.
                                                                                                
#define UPD0RXSHFT_BIT5BND__BMASK   0x80 ///< Bit-5 Boundary                                    
#define UPD0RXSHFT_BIT5BND__SHIFT   0x07 ///< Bit-5 Boundary                                    
#define UPD0RXSHFT_BIT5BND__NOT_SET 0x00 ///< RXSHREG does not contain 5 bits of received data. 
#define UPD0RXSHFT_BIT5BND__SET     0x80 ///< RXSHREG contains 5 bits of received data.         
                                                                                                
//------------------------------------------------------------------------------
// UPD0RXSTAT Enums (PD0 Receive Status @ 0x92)
//------------------------------------------------------------------------------
#define UPD0RXSTAT_STATE__FMASK         0x03 ///< PD0 Receive State                                 
#define UPD0RXSTAT_STATE__SHIFT         0x00 ///< PD0 Receive State                                 
#define UPD0RXSTAT_STATE__WAITING       0x00 ///< Waiting for preamble pattern.                     
#define UPD0RXSTAT_STATE__PREAMBLE_REC  0x01 ///< Received preamble pattern, waiting for non-       
                                             ///< preamble 20-bit ordered set K-codes.              
#define UPD0RXSTAT_STATE__WAITING_EOP   0x02 ///< Received 20-bit ordered set K-codes, waiting for  
                                             ///< EOP.                                              
#define UPD0RXSTAT_STATE__REC_EOP       0x03 ///< Received EOP, waiting for idle (RXBUSY = 0).      
                                                                                                    
#define UPD0RXSTAT_CRCERR__BMASK        0x04 ///< CRC Error                                         
#define UPD0RXSTAT_CRCERR__SHIFT        0x02 ///< CRC Error                                         
#define UPD0RXSTAT_CRCERR__NOT_SET      0x00 ///< No CRC error in the current received packet.      
#define UPD0RXSTAT_CRCERR__SET          0x04 ///< CRC error in the current received packet.         
                                                                                                    
#define UPD0RXSTAT_ISNIB__BMASK         0x08 ///< Last FIFO Byte Nibble Status                      
#define UPD0RXSTAT_ISNIB__SHIFT         0x03 ///< Last FIFO Byte Nibble Status                      
#define UPD0RXSTAT_ISNIB__NOT_SET       0x00 ///< The last RX FIFO data contains a full byte of     
                                             ///< data.                                             
#define UPD0RXSTAT_ISNIB__SET           0x08 ///< The last RX FIFO data contains only the low nibble
                                             ///< data.                                             
                                                                                                    
#define UPD0RXSTAT_OSTYPE__FMASK        0x70 ///< Ordered Set Type                                  
#define UPD0RXSTAT_OSTYPE__SHIFT        0x04 ///< Ordered Set Type                                  
#define UPD0RXSTAT_OSTYPE__SOP          0x00 ///< SOP.                                              
#define UPD0RXSTAT_OSTYPE__SOP_P        0x10 ///< SOP'.                                             
#define UPD0RXSTAT_OSTYPE__SOP_DP       0x20 ///< SOP''.                                            
#define UPD0RXSTAT_OSTYPE__SOP_P_DEBUG  0x30 ///< SOP' Debug.                                       
#define UPD0RXSTAT_OSTYPE__SOP_DP_DEBUG 0x40 ///< SOP'' Debug.                                      
#define UPD0RXSTAT_OSTYPE__HARD_RESET   0x50 ///< Hard reset.                                       
#define UPD0RXSTAT_OSTYPE__CABLE_RESET  0x60 ///< Cable reset.                                      
#define UPD0RXSTAT_OSTYPE__UNIDENTIFIED 0x70 ///< Unidentified ordered set.                         
                                                                                                    
#define UPD0RXSTAT_RXBUSY__BMASK        0x80 ///< CC Line State                                     
#define UPD0RXSTAT_RXBUSY__SHIFT        0x07 ///< CC Line State                                     
#define UPD0RXSTAT_RXBUSY__NOT_SET      0x00 ///< The CC line is idle.                              
#define UPD0RXSTAT_RXBUSY__SET          0x80 ///< The CC line is busy.                              
                                                                                                    
//------------------------------------------------------------------------------
// UPD0RXTH Enums (PD0 Receive Threshold Configuration @ 0xA1)
//------------------------------------------------------------------------------
#define UPD0RXTH_THF__FMASK     0x07 ///< Falling Edge Receive Threshold                   
#define UPD0RXTH_THF__SHIFT     0x00 ///< Falling Edge Receive Threshold                   
                                                                                           
#define UPD0RXTH_THR__FMASK     0x38 ///< Rising Edge Receive Threshold                    
#define UPD0RXTH_THR__SHIFT     0x03 ///< Rising Edge Receive Threshold                    
                                                                                           
#define UPD0RXTH_THSEL__FMASK   0xC0 ///< Receive Threshold Level Select                   
#define UPD0RXTH_THSEL__SHIFT   0x06 ///< Receive Threshold Level Select                   
#define UPD0RXTH_THSEL__SINK    0x00 ///< THF and THR Threshold levels based on the SINK   
                                     ///< selection.                                       
#define UPD0RXTH_THSEL__SRC     0x40 ///< THF and THR Threshold levels based on the SRC    
                                     ///< selection.                                       
#define UPD0RXTH_THSEL__NEUTRAL 0x80 ///< THF and THR Threshold levels based on the NEUTRAL
                                     ///< selection.                                       
                                                                                           
//------------------------------------------------------------------------------
// UPD0TXCN0 Enums (PD0 Transmit Control 0 @ 0x89)
//------------------------------------------------------------------------------
#define UPD0TXCN0_STARTTX__BMASK    0x01 ///< Start TX Transmission                             
#define UPD0TXCN0_STARTTX__SHIFT    0x00 ///< Start TX Transmission                             
#define UPD0TXCN0_STARTTX__SET      0x01 ///< Start the TX transmission.                        
                                                                                                
#define UPD0TXCN0_ENCORE__BMASK     0x02 ///< TX Driver Enable                                  
#define UPD0TXCN0_ENCORE__SHIFT     0x01 ///< TX Driver Enable                                  
#define UPD0TXCN0_ENCORE__DISABLED  0x00 ///< Disable the TX driver.                            
#define UPD0TXCN0_ENCORE__ENABLED   0x02 ///< Enable the TX driver.                             
                                                                                                
#define UPD0TXCN0_RESET__BMASK      0x04 ///< TX Engine Reset                                   
#define UPD0TXCN0_RESET__SHIFT      0x02 ///< TX Engine Reset                                   
#define UPD0TXCN0_RESET__SET        0x04 ///< Reset the TX engine.                              
                                                                                                
#define UPD0TXCN0_EOPOVR__BMASK     0x08 ///< End-of-Packet Override                            
#define UPD0TXCN0_EOPOVR__SHIFT     0x03 ///< End-of-Packet Override                            
#define UPD0TXCN0_EOPOVR__DISABLED  0x00 ///< Disable override.                                 
#define UPD0TXCN0_EOPOVR__ENABLED   0x08 ///< Transmit an EOP at the next 5-bit boundary in the 
                                         ///< packet to terminate the ongoing transmission      
                                         ///< early.                                            
                                                                                                
#define UPD0TXCN0_CRCEN__BMASK      0x10 ///< CRC Enable                                        
#define UPD0TXCN0_CRCEN__SHIFT      0x04 ///< CRC Enable                                        
#define UPD0TXCN0_CRCEN__DISABLED   0x00 ///< Disable CRC transmission at the end-of-packet. CRC
                                         ///< calculation will still be performed.              
#define UPD0TXCN0_CRCEN__ENABLED    0x10 ///< Enable a CRC calculation of outgoing data and     
                                         ///< transmit the CRC just before the EOP.             
                                                                                                
#define UPD0TXCN0_EOPEN__BMASK      0x20 ///< EOP Enable                                        
#define UPD0TXCN0_EOPEN__SHIFT      0x05 ///< EOP Enable                                        
#define UPD0TXCN0_EOPEN__DISABLED   0x00 ///< No EOP will be sent at the end of the packet.     
#define UPD0TXCN0_EOPEN__ENABLED    0x20 ///< EOP will be sent when there is no more data to    
                                         ///< transmit in the PD0 TX FIFO. This will be sent    
                                         ///< after CRC if CRCEN is 1.                          
                                                                                                
#define UPD0TXCN0_DELAY__BMASK      0x40 ///< TX Start Delay                                    
#define UPD0TXCN0_DELAY__SHIFT      0x06 ///< TX Start Delay                                    
#define UPD0TXCN0_DELAY__1_PERIOD   0x00 ///< Outputs 1 bit period low at the start of          
                                         ///< transmission.                                     
#define UPD0TXCN0_DELAY__2_PERIODS  0x40 ///< Outputs 2 bit periods low at the start of         
                                         ///< transmission.                                     
                                                                                                
#define UPD0TXCN0_BISTCR2__BMASK    0x80 ///< BIST Carrier Mode 2 Enable                        
#define UPD0TXCN0_BISTCR2__SHIFT    0x07 ///< BIST Carrier Mode 2 Enable                        
#define UPD0TXCN0_BISTCR2__DISABLED 0x00 ///< Disable BIST Carrier Mode 2 test operation.       
#define UPD0TXCN0_BISTCR2__ENABLED  0x80 ///< Enable BIST Carrier Mode 2 test operation.        
                                                                                                
//------------------------------------------------------------------------------
// UPD0TXKC1 Enums (PD0 Transmit KCODE 1 @ 0x8B)
//------------------------------------------------------------------------------
#define UPD0TXKC1_KCODE1__FMASK 0x1F ///< First K-Code
#define UPD0TXKC1_KCODE1__SHIFT 0x00 ///< First K-Code
                                                      
//------------------------------------------------------------------------------
// UPD0TXKC2 Enums (PD0 Transmit KCODE 2 @ 0x8C)
//------------------------------------------------------------------------------
#define UPD0TXKC2_KCODE2__FMASK 0x1F ///< Second K-Code
#define UPD0TXKC2_KCODE2__SHIFT 0x00 ///< Second K-Code
                                                       
//------------------------------------------------------------------------------
// UPD0TXKC3 Enums (PD0 Transmit KCODE 3 @ 0x8D)
//------------------------------------------------------------------------------
#define UPD0TXKC3_KCODE3__FMASK 0x1F ///< Third K-Code
#define UPD0TXKC3_KCODE3__SHIFT 0x00 ///< Third K-Code
                                                      
//------------------------------------------------------------------------------
// UPD0TXKC4 Enums (PD0 Transmit KCODE 4 @ 0x8E)
//------------------------------------------------------------------------------
#define UPD0TXKC4_KCODE4__FMASK 0x1F ///< Fourth K-Code
#define UPD0TXKC4_KCODE4__SHIFT 0x00 ///< Fourth K-Code
                                                       
//------------------------------------------------------------------------------
// UPD0TXSTAT Enums (PD0 TX Status @ 0x8A)
//------------------------------------------------------------------------------
#define UPD0TXSTAT_STATE__FMASK             0x0F ///< CC Transmission State                          
#define UPD0TXSTAT_STATE__SHIFT             0x00 ///< CC Transmission State                          
#define UPD0TXSTAT_STATE__IDLE              0x00 ///< Idle.                                          
#define UPD0TXSTAT_STATE__AUTOMATIC_STARTUP 0x01 ///< Automatic startup sequencing state.            
#define UPD0TXSTAT_STATE__DELAYED_STARTUP   0x02 ///< Delayed startup state (for longer low time just
                                                 ///< before start of preamble).                     
#define UPD0TXSTAT_STATE__PREAMBLE          0x03 ///< Preamble transmission state.                   
#define UPD0TXSTAT_STATE__KCODE1            0x04 ///< K-code 1 transmission.                         
#define UPD0TXSTAT_STATE__KCODE2            0x05 ///< K-code 2 transmission.                         
#define UPD0TXSTAT_STATE__KCODE3            0x06 ///< K-code 3 transmission.                         
#define UPD0TXSTAT_STATE__KCODE4            0x07 ///< K-code 4 transmission.                         
#define UPD0TXSTAT_STATE__LOWBMC            0x08 ///< Low-nibble BMC-encoded transmission.           
#define UPD0TXSTAT_STATE__HIGHBMC           0x09 ///< High-nibble BMC-encoded transmission.          
#define UPD0TXSTAT_STATE__LOWCRC            0x0A ///< Low-nibble of BMC-encoded CRC transmission.    
#define UPD0TXSTAT_STATE__HIGHCRC           0x0B ///< High-nibble of BMC-encoded CRC transmission.   
#define UPD0TXSTAT_STATE__EOP               0x0C ///< EOP transmission.                              
#define UPD0TXSTAT_STATE__TERM_EDGE         0x0D ///< Termination of transmission with possible      
                                                 ///< adjustment for trailing edge.                  
#define UPD0TXSTAT_STATE__TERM_LOW          0x0E ///< Termination of transmission with low driving   
                                                 ///< output.                                        
#define UPD0TXSTAT_STATE__BIST              0x0F ///< BIST Carrier Mode 2 transmission.              
                                                                                                     
#define UPD0TXSTAT_BUSY__BMASK              0x80 ///< PD0 TX Busy Flag                               
#define UPD0TXSTAT_BUSY__SHIFT              0x07 ///< PD0 TX Busy Flag                               
#define UPD0TXSTAT_BUSY__NOT_SET            0x00 ///< A transmission is not in progress.             
#define UPD0TXSTAT_BUSY__SET                0x80 ///< A transmission is in progress.                 
                                                                                                     
//------------------------------------------------------------------------------
// UPD1CC Enums (PD1 CC Configuration @ 0xF1)
//------------------------------------------------------------------------------
#define UPD1CC_ENCC1RD__BMASK    0x01 ///< CC1 RD Pull-Down Enable                           
#define UPD1CC_ENCC1RD__SHIFT    0x00 ///< CC1 RD Pull-Down Enable                           
#define UPD1CC_ENCC1RD__DISABLED 0x00 ///< Disable the RD pull-down resistor.                
#define UPD1CC_ENCC1RD__ENABLED  0x01 ///< Enable the RD pull-down resistor.                 
                                                                                             
#define UPD1CC_ENCC1IP__BMASK    0x02 ///< CC1 Ip Pull-Up Enable                             
#define UPD1CC_ENCC1IP__SHIFT    0x01 ///< CC1 Ip Pull-Up Enable                             
#define UPD1CC_ENCC1IP__DISABLED 0x00 ///< Disable the Ip pull-up current source at the CC1  
                                      ///< pin.                                              
#define UPD1CC_ENCC1IP__ENABLED  0x02 ///< Enable the Ip pull-up current source at the CC1   
                                      ///< pin. The Ip value is configured by the IPPW field.
                                                                                             
#define UPD1CC_CC1OVP__BMASK     0x04 ///< CC1 Overvoltage Flag                              
#define UPD1CC_CC1OVP__SHIFT     0x02 ///< CC1 Overvoltage Flag                              
#define UPD1CC_CC1OVP__NOT_SET   0x00 ///< The CC1 pin voltage is less than or equal to VDD. 
#define UPD1CC_CC1OVP__SET       0x04 ///< The CC1 pin voltage is greater than VDD.          
                                                                                             
#define UPD1CC_AUTOOVP__BMASK    0x40 ///< Automatic Overvoltage Protection Enable           
#define UPD1CC_AUTOOVP__SHIFT    0x06 ///< Automatic Overvoltage Protection Enable           
#define UPD1CC_AUTOOVP__DISABLED 0x00 ///< Disable automatic change in Ip.                   
#define UPD1CC_AUTOOVP__ENABLED  0x40 ///< Enable overvoltage protection of the CC pins by   
                                      ///< switching off Ip current when either CC1OVP or    
                                      ///< CC2OVP are set. This setting functions only when  
                                      ///< ENOVP is set to 1.                                
                                                                                             
#define UPD1CC_ENOVP__BMASK      0x80 ///< Overvoltage Monitor Enable                        
#define UPD1CC_ENOVP__SHIFT      0x07 ///< Overvoltage Monitor Enable                        
#define UPD1CC_ENOVP__DISABLED   0x00 ///< Disable over voltage monitoring for CC1 and CC2.  
#define UPD1CC_ENOVP__ENABLED    0x80 ///< Enable over voltage monitoring for CC1 and CC2.   
                                                                                             
//------------------------------------------------------------------------------
// UPD1CN0 Enums (PD1 Control @ 0xC8)
//------------------------------------------------------------------------------
#define UPD1CN0_FORCERX__BMASK    0x01 ///< Force RX Enable                         
#define UPD1CN0_FORCERX__SHIFT    0x00 ///< Force RX Enable                         
#define UPD1CN0_FORCERX__DISABLED 0x00 ///< PD1 Receiver is not enabled during TX.  
#define UPD1CN0_FORCERX__ENABLED  0x01 ///< PD1 Receiver is enabled during TX.      
                                                                                    
#define UPD1CN0_IPPW__FMASK       0x06 ///< Pull-Up Current Source Select           
#define UPD1CN0_IPPW__SHIFT       0x01 ///< Pull-Up Current Source Select           
#define UPD1CN0_IPPW__80_UA       0x02 ///< Configures the current source to 80 uA. 
#define UPD1CN0_IPPW__180_UA      0x04 ///< Configures the current source to 180 uA.
#define UPD1CN0_IPPW__330_UA      0x06 ///< Configures the current source to 330 uA.
                                                                                    
#define UPD1CN0_ENREF__BMASK      0x08 ///< Reference Buffer Enable                 
#define UPD1CN0_ENREF__SHIFT      0x03 ///< Reference Buffer Enable                 
#define UPD1CN0_ENREF__DISABLED   0x00 ///< Disable the PD1 reference buffer.       
#define UPD1CN0_ENREF__ENABLED    0x08 ///< Enable the PD1 reference buffer.        
                                                                                    
//------------------------------------------------------------------------------
// UPD1CRC0 Enums (PD1 CRC 0 @ 0xEB)
//------------------------------------------------------------------------------
#define UPD1CRC0_CRC0__FMASK 0xFF ///< CRC32 Byte 0
#define UPD1CRC0_CRC0__SHIFT 0x00 ///< CRC32 Byte 0
                                                   
//------------------------------------------------------------------------------
// UPD1CRC1 Enums (PD1 CRC 1 @ 0xEC)
//------------------------------------------------------------------------------
#define UPD1CRC1_CRC1__FMASK 0xFF ///< CRC32 Byte 1
#define UPD1CRC1_CRC1__SHIFT 0x00 ///< CRC32 Byte 1
                                                   
//------------------------------------------------------------------------------
// UPD1CRC2 Enums (PD1 CRC 2 @ 0xED)
//------------------------------------------------------------------------------
#define UPD1CRC2_CRC2__FMASK 0xFF ///< CRC32 Byte 2
#define UPD1CRC2_CRC2__SHIFT 0x00 ///< CRC32 Byte 2
                                                   
//------------------------------------------------------------------------------
// UPD1CRC3 Enums (PD1 CRC 3 @ 0xEE)
//------------------------------------------------------------------------------
#define UPD1CRC3_CRC3__FMASK 0xFF ///< CRC32 Byte 3
#define UPD1CRC3_CRC3__SHIFT 0x00 ///< CRC32 Byte 3
                                                   
//------------------------------------------------------------------------------
// UPD1DAT Enums (PD1 Transmit and Receive Buffer @ 0xDA)
//------------------------------------------------------------------------------
#define UPD1DAT_PDDAT__FMASK 0xFF ///< PD1 Transmit and Receive Buffer
#define UPD1DAT_PDDAT__SHIFT 0x00 ///< PD1 Transmit and Receive Buffer
                                                                      
//------------------------------------------------------------------------------
// UPD1FCN0 Enums (PD1 FIFO Control 0 @ 0xDB)
//------------------------------------------------------------------------------
#define UPD1FCN0_RXTH__FMASK     0x03 ///< RX FIFO Threshold                                 
#define UPD1FCN0_RXTH__SHIFT     0x00 ///< RX FIFO Threshold                                 
#define UPD1FCN0_RXTH__NOT_EMPTY 0x00 ///< RFRQ will be set anytime new data arrives in the  
                                      ///< RX FIFO (when the RX FIFO is not empty).          
#define UPD1FCN0_RXTH__1_BYTE    0x01 ///< RFRQ will be set if the RX FIFO contains more than
                                      ///< one byte.                                         
                                                                                             
#define UPD1FCN0_RFLSH__BMASK    0x04 ///< RX FIFO Flush                                     
#define UPD1FCN0_RFLSH__SHIFT    0x02 ///< RX FIFO Flush                                     
#define UPD1FCN0_RFLSH__SET      0x04 ///< Flush the RX FIFO.                                
                                                                                             
#define UPD1FCN0_RFRQE__BMASK    0x08 ///< Read Request Interrupt Enable                     
#define UPD1FCN0_RFRQE__SHIFT    0x03 ///< Read Request Interrupt Enable                     
#define UPD1FCN0_RFRQE__DISABLED 0x00 ///< PD1 interrupts will not be generated when RFRQ is 
                                      ///< set.                                              
#define UPD1FCN0_RFRQE__ENABLED  0x08 ///< PD1 interrupts will be generated when RFRQ is set.
                                                                                             
#define UPD1FCN0_TXTH__FMASK     0x30 ///< TX FIFO Threshold                                 
#define UPD1FCN0_TXTH__SHIFT     0x04 ///< TX FIFO Threshold                                 
#define UPD1FCN0_TXTH__EMPTY     0x00 ///< TFRQ will be set when the TX FIFO is empty.       
#define UPD1FCN0_TXTH__1_BYTE    0x10 ///< TFRQ will be set when the TX FIFO contains one or 
                                      ///< fewer bytes.                                      
                                                                                             
#define UPD1FCN0_TFLSH__BMASK    0x40 ///< TX FIFO Flush                                     
#define UPD1FCN0_TFLSH__SHIFT    0x06 ///< TX FIFO Flush                                     
#define UPD1FCN0_TFLSH__SET      0x40 ///< Flush the TX FIFO.                                
                                                                                             
#define UPD1FCN0_TFRQE__BMASK    0x80 ///< Write Request Interrupt Enable                    
#define UPD1FCN0_TFRQE__SHIFT    0x07 ///< Write Request Interrupt Enable                    
#define UPD1FCN0_TFRQE__DISABLED 0x00 ///< PD1 interrupts will not be generated when TFRQ is 
                                      ///< set.                                              
#define UPD1FCN0_TFRQE__ENABLED  0x80 ///< PD1 interrupts will be generated when TFRQ is set.
                                                                                             
//------------------------------------------------------------------------------
// UPD1FCN1 Enums (PD1 FIFO Control 1 @ 0xDC)
//------------------------------------------------------------------------------
#define UPD1FCN1_RXOVRUN__BMASK   0x01 ///< RX FIFO Overrun                                   
#define UPD1FCN1_RXOVRUN__SHIFT   0x00 ///< RX FIFO Overrun                                   
#define UPD1FCN1_RXOVRUN__NOT_SET 0x00 ///< The RX FIFO has not overrun. The last byte was    
                                       ///< received when the RX FIFO was not full.           
#define UPD1FCN1_RXOVRUN__SET     0x01 ///< The RX FIFO has overrun. This occurs when a new   
                                       ///< byte arrives when the RX FIFO is already full.    
                                                                                              
#define UPD1FCN1_RXE__BMASK       0x04 ///< RX FIFO Empty                                     
#define UPD1FCN1_RXE__SHIFT       0x02 ///< RX FIFO Empty                                     
#define UPD1FCN1_RXE__NOT_SET     0x00 ///< The RX FIFO contains data.                        
#define UPD1FCN1_RXE__SET         0x04 ///< The RX FIFO is empty.                             
                                                                                              
#define UPD1FCN1_RFRQ__BMASK      0x08 ///< Receive FIFO Request                              
#define UPD1FCN1_RFRQ__SHIFT      0x03 ///< Receive FIFO Request                              
#define UPD1FCN1_RFRQ__NOT_SET    0x00 ///< The number of bytes in the RX FIFO is less than or
                                       ///< equal to RXTH.                                    
#define UPD1FCN1_RFRQ__SET        0x08 ///< The number of bytes in the RX FIFO is greater than
                                       ///< RXTH.                                             
                                                                                              
#define UPD1FCN1_TXNF__BMASK      0x40 ///< TX FIFO Not Full                                  
#define UPD1FCN1_TXNF__SHIFT      0x06 ///< TX FIFO Not Full                                  
#define UPD1FCN1_TXNF__NOT_SET    0x00 ///< The TX FIFO is full.                              
#define UPD1FCN1_TXNF__SET        0x40 ///< The TX FIFO has room for more data.               
                                                                                              
#define UPD1FCN1_TFRQ__BMASK      0x80 ///< Transmit FIFO Request                             
#define UPD1FCN1_TFRQ__SHIFT      0x07 ///< Transmit FIFO Request                             
#define UPD1FCN1_TFRQ__NOT_SET    0x00 ///< The number of bytes in the TX FIFO is greater than
                                       ///< TXTH.                                             
#define UPD1FCN1_TFRQ__SET        0x80 ///< The number of bytes in the TX FIFO is less than or
                                       ///< equal to TXTH.                                    
                                                                                              
//------------------------------------------------------------------------------
// UPD1FCT Enums (PD1 FIFO Count @ 0xDD)
//------------------------------------------------------------------------------
#define UPD1FCT_RXCNT__FMASK 0x03 ///< RX FIFO Count
#define UPD1FCT_RXCNT__SHIFT 0x00 ///< RX FIFO Count
                                                    
#define UPD1FCT_TXCNT__FMASK 0x30 ///< TX FIFO Count
#define UPD1FCT_TXCNT__SHIFT 0x04 ///< TX FIFO Count
                                                    
//------------------------------------------------------------------------------
// UPD1INTEN Enums (PD1 Interrupt Enable @ 0xDF)
//------------------------------------------------------------------------------
#define UPD1INTEN_PRERIE__BMASK      0x01 ///< Preamble Received Interrupt Enable                
#define UPD1INTEN_PRERIE__SHIFT      0x00 ///< Preamble Received Interrupt Enable                
#define UPD1INTEN_PRERIE__DISABLED   0x00 ///< PD1 interrupt will not be generated when the PRERF
                                          ///< flag is set.                                      
#define UPD1INTEN_PRERIE__ENABLED    0x01 ///< PD1 interrupt will be generated when the PRERF    
                                          ///< flag is set.                                      
                                                                                                 
#define UPD1INTEN_OSRIE__BMASK       0x02 ///< Ordered Set Received Interrupt Enable             
#define UPD1INTEN_OSRIE__SHIFT       0x01 ///< Ordered Set Received Interrupt Enable             
#define UPD1INTEN_OSRIE__DISABLED    0x00 ///< PD1 interrupt will not be generated when the OSRF 
                                          ///< flag is set.                                      
#define UPD1INTEN_OSRIE__ENABLED     0x02 ///< PD1 interrupt will be generated when the OSRF flag
                                          ///< is set.                                           
                                                                                                 
#define UPD1INTEN_EOPRIE__BMASK      0x04 ///< EOP Received Interrupt Enable                     
#define UPD1INTEN_EOPRIE__SHIFT      0x02 ///< EOP Received Interrupt Enable                     
#define UPD1INTEN_EOPRIE__DISABLED   0x00 ///< PD1 interrupt will not be generated when the EOPRF
                                          ///< flag is set.                                      
#define UPD1INTEN_EOPRIE__ENABLED    0x04 ///< PD1 interrupt will be generated when the EOPRF    
                                          ///< flag is set.                                      
                                                                                                 
#define UPD1INTEN_IDLEIE__BMASK      0x08 ///< CC Line Idle Interrupt Enable                     
#define UPD1INTEN_IDLEIE__SHIFT      0x03 ///< CC Line Idle Interrupt Enable                     
#define UPD1INTEN_IDLEIE__DISABLED   0x00 ///< PD1 interrupt will not be generated when the IDLEF
                                          ///< flag is set.                                      
#define UPD1INTEN_IDLEIE__ENABLED    0x08 ///< PD1 interrupt will be generated when the IDLEF    
                                          ///< flag is set.                                      
                                                                                                 
#define UPD1INTEN_BMCERRIE__BMASK    0x10 ///< Received BMC Error Interrupt Enable               
#define UPD1INTEN_BMCERRIE__SHIFT    0x04 ///< Received BMC Error Interrupt Enable               
#define UPD1INTEN_BMCERRIE__DISABLED 0x00 ///< PD1 interrupt will not be generated when the      
                                          ///< BMCERRF flag is set.                              
#define UPD1INTEN_BMCERRIE__ENABLED  0x10 ///< PD1 interrupt will be generated when the BMCERRF  
                                          ///< flag is set.                                      
                                                                                                 
#define UPD1INTEN_TXDONEIE__BMASK    0x20 ///< TX Transmit Done Interrupt Enable                 
#define UPD1INTEN_TXDONEIE__SHIFT    0x05 ///< TX Transmit Done Interrupt Enable                 
#define UPD1INTEN_TXDONEIE__DISABLED 0x00 ///< PD1 interrupt will not be generated when the      
                                          ///< TXDONE flag is set.                               
#define UPD1INTEN_TXDONEIE__ENABLED  0x20 ///< PD1 interrupt will be generated when the TXDONE   
                                          ///< flag is set.                                      
                                                                                                 
//------------------------------------------------------------------------------
// UPD1INTSTAT Enums (PD1 Interrupt Status @ 0xDE)
//------------------------------------------------------------------------------
#define UPD1INTSTAT_PRERF__BMASK     0x01 ///< Preamble Received Flag                            
#define UPD1INTSTAT_PRERF__SHIFT     0x00 ///< Preamble Received Flag                            
#define UPD1INTSTAT_PRERF__NOT_SET   0x00 ///< No preamble received.                             
#define UPD1INTSTAT_PRERF__SET       0x01 ///< Preamble received.                                
                                                                                                 
#define UPD1INTSTAT_OSRF__BMASK      0x02 ///< Ordered Set Received Flag                         
#define UPD1INTSTAT_OSRF__SHIFT      0x01 ///< Ordered Set Received Flag                         
#define UPD1INTSTAT_OSRF__NOT_SET    0x00 ///< Ordered set bits not yet received into UPD0RXKC1-4
                                          ///< SFRs.                                             
#define UPD1INTSTAT_OSRF__SET        0x02 ///< Complete ordered set bits received into           
                                          ///< UPD0RXKC1-4 SFRs.                                 
                                                                                                 
#define UPD1INTSTAT_EOPRF__BMASK     0x04 ///< EOP Received Flag                                 
#define UPD1INTSTAT_EOPRF__SHIFT     0x02 ///< EOP Received Flag                                 
#define UPD1INTSTAT_EOPRF__NOT_SET   0x00 ///< EOP has not been received by the PD.              
#define UPD1INTSTAT_EOPRF__SET       0x04 ///< EOP has been received by the PD.                  
                                                                                                 
#define UPD1INTSTAT_IDLEF__BMASK     0x08 ///< CC Line Idle Flag                                 
#define UPD1INTSTAT_IDLEF__SHIFT     0x03 ///< CC Line Idle Flag                                 
#define UPD1INTSTAT_IDLEF__NOT_SET   0x00 ///< RX core has not detected a transition of RXBUSY   
                                          ///< from busy to idle.                                
#define UPD1INTSTAT_IDLEF__SET       0x08 ///< RX core detected a transition of RXBUSY from busy 
                                          ///< to idle.                                          
                                                                                                 
#define UPD1INTSTAT_BMCERRF__BMASK   0x10 ///< Received BMC Error Flag                           
#define UPD1INTSTAT_BMCERRF__SHIFT   0x04 ///< Received BMC Error Flag                           
#define UPD1INTSTAT_BMCERRF__NOT_SET 0x00 ///< BMC error has not occurred.                       
#define UPD1INTSTAT_BMCERRF__SET     0x10 ///< BMC error occurred.                               
                                                                                                 
#define UPD1INTSTAT_TXDONE__BMASK    0x20 ///< TX Transmit Done Flag                             
#define UPD1INTSTAT_TXDONE__SHIFT    0x05 ///< TX Transmit Done Flag                             
#define UPD1INTSTAT_TXDONE__NOT_SET  0x00 ///< The transmit BUSY flag has not transitioned from  
                                          ///< busy to idle.                                     
#define UPD1INTSTAT_TXDONE__SET      0x20 ///< The transmit BUSY flag has transitioned from busy 
                                          ///< to idle.                                          
                                                                                                 
//------------------------------------------------------------------------------
// UPD1RXCN0 Enums (PD1 Receive Control @ 0xD1)
//------------------------------------------------------------------------------
#define UPD1RXCN0_EN__BMASK          0x01 ///< PD Receive Enable                                 
#define UPD1RXCN0_EN__SHIFT          0x00 ///< PD Receive Enable                                 
#define UPD1RXCN0_EN__DISABLED       0x00 ///< Disable the PD Receiver.                          
#define UPD1RXCN0_EN__ENABLED        0x01 ///< Enable the PD Receiver when Transmit is not active
                                          ///< unless the FORCERX bit is set.                    
                                                                                                 
#define UPD1RXCN0_RXTO__FMASK        0x06 ///< Receive Timeout                                   
#define UPD1RXCN0_RXTO__SHIFT        0x01 ///< Receive Timeout                                   
#define UPD1RXCN0_RXTO__13_US        0x00 ///< Set RXBUSY when there are more than 2 transitions 
                                          ///< on the CC line in a 13 us window.                 
#define UPD1RXCN0_RXTO__15_US        0x02 ///< Set RXBUSY when there are more than 2 transitions 
                                          ///< on the CC line in a 15 us window.                 
#define UPD1RXCN0_RXTO__17_US        0x04 ///< Set RXBUSY when there are more than 2 transitions 
                                          ///< on the CC line in a 17 us window.                 
#define UPD1RXCN0_RXTO__19_US        0x06 ///< Set RXBUSY when there are more than 2 transitions 
                                          ///< on the CC line in a 19 us window.                 
                                                                                                 
#define UPD1RXCN0_ENLPF__BMASK       0x08 ///< Low Pass Filter Enable                            
#define UPD1RXCN0_ENLPF__SHIFT       0x03 ///< Low Pass Filter Enable                            
#define UPD1RXCN0_ENLPF__DISABLED    0x00 ///< Disable low pass filter.                          
#define UPD1RXCN0_ENLPF__ENABLED     0x08 ///< Enable low pass filter on receiver path.          
                                                                                                 
#define UPD1RXCN0_LOCKP__BMASK       0x10 ///< Preamble Lock Pattern                             
#define UPD1RXCN0_LOCKP__SHIFT       0x04 ///< Preamble Lock Pattern                             
#define UPD1RXCN0_LOCKP__1_PREAMBLE  0x00 ///< 1 preamble pattern (1101 x 1) must be detected to 
                                          ///< recover the clock on the CC line.                 
#define UPD1RXCN0_LOCKP__2_PREAMBLES 0x10 ///< 2 preamble patterns (1101 x 2) must be detected to
                                          ///< recover the clock on the CC line.                 
                                                                                                 
#define UPD1RXCN0_LOCKC__BMASK       0x20 ///< Clock Lock Pattern                                
#define UPD1RXCN0_LOCKC__SHIFT       0x05 ///< Clock Lock Pattern                                
#define UPD1RXCN0_LOCKC__2_PREAMBLES 0x00 ///< 2 preamble patterns (1101 x 2) must be detected to
                                          ///< recover the clock on the CC line.                 
#define UPD1RXCN0_LOCKC__3_PREAMBLES 0x20 ///< 3 preamble patterns (1101 x 3) must be detected to
                                          ///< recover the clock on the CC line.                 
                                                                                                 
#define UPD1RXCN0_ENEOPPRE__BMASK    0x40 ///< Preamble EOP Enable                               
#define UPD1RXCN0_ENEOPPRE__SHIFT    0x06 ///< Preamble EOP Enable                               
#define UPD1RXCN0_ENEOPPRE__DISABLED 0x00 ///< Disable EOP detection when a preamble is being    
                                          ///< received.                                         
#define UPD1RXCN0_ENEOPPRE__ENABLED  0x40 ///< Enable EOP detection when a preamble is being     
                                          ///< received.                                         
                                                                                                 
#define UPD1RXCN0_ENSKIDLE__BMASK    0x80 ///< Skip IDLE Enable                                  
#define UPD1RXCN0_ENSKIDLE__SHIFT    0x07 ///< Skip IDLE Enable                                  
#define UPD1RXCN0_ENSKIDLE__DISABLED 0x00 ///< The Idle state must occur after receiving EOP in  
                                          ///< order for the preamble to be detected.            
#define UPD1RXCN0_ENSKIDLE__ENABLED  0x80 ///< The Idle state is not required after receiving EOP
                                          ///< in order for the preamble to be detected.         
                                                                                                 
//------------------------------------------------------------------------------
// UPD1RXKC1 Enums (PD1 Receive KCODE 1 @ 0xD3)
//------------------------------------------------------------------------------
#define UPD1RXKC1_KCODE1__FMASK 0x1F ///< First K-Code
#define UPD1RXKC1_KCODE1__SHIFT 0x00 ///< First K-Code
                                                      
//------------------------------------------------------------------------------
// UPD1RXKC2 Enums (PD1 Receive KCODE 2 @ 0xD4)
//------------------------------------------------------------------------------
#define UPD1RXKC2_KCODE2__FMASK 0x1F ///< Second K-Code
#define UPD1RXKC2_KCODE2__SHIFT 0x00 ///< Second K-Code
                                                       
//------------------------------------------------------------------------------
// UPD1RXKC3 Enums (PD1 Receive KCODE 3 @ 0xD5)
//------------------------------------------------------------------------------
#define UPD1RXKC3_KCODE3__FMASK 0x1F ///< Third K-Code
#define UPD1RXKC3_KCODE3__SHIFT 0x00 ///< Third K-Code
                                                      
//------------------------------------------------------------------------------
// UPD1RXKC4 Enums (PD1 Receive KCODE 4 @ 0xD6)
//------------------------------------------------------------------------------
#define UPD1RXKC4_KCODE4__FMASK 0x1F ///< Fourth K-Code
#define UPD1RXKC4_KCODE4__SHIFT 0x00 ///< Fourth K-Code
                                                       
//------------------------------------------------------------------------------
// UPD1RXSHFT Enums (PD1 Receive Shift @ 0xEA)
//------------------------------------------------------------------------------
#define UPD1RXSHFT_RXSHREG__FMASK   0x1F ///< Received BMC Decoded Data                         
#define UPD1RXSHFT_RXSHREG__SHIFT   0x00 ///< Received BMC Decoded Data                         
                                                                                                
#define UPD1RXSHFT_NIBSTAT__BMASK   0x40 ///< Low or High Nibble Indicator                      
#define UPD1RXSHFT_NIBSTAT__SHIFT   0x06 ///< Low or High Nibble Indicator                      
#define UPD1RXSHFT_NIBSTAT__NOT_SET 0x00 ///< The data in RXSHREG decodes into the lower nibble.
#define UPD1RXSHFT_NIBSTAT__SET     0x40 ///< The data in RXSHREG decodes into the upper nibble.
                                                                                                
#define UPD1RXSHFT_BIT5BND__BMASK   0x80 ///< Bit-5 Boundary                                    
#define UPD1RXSHFT_BIT5BND__SHIFT   0x07 ///< Bit-5 Boundary                                    
#define UPD1RXSHFT_BIT5BND__NOT_SET 0x00 ///< RXSHREG does not contain 5 bits of received data. 
#define UPD1RXSHFT_BIT5BND__SET     0x80 ///< RXSHREG contains 5 bits of received data.         
                                                                                                
//------------------------------------------------------------------------------
// UPD1RXSTAT Enums (PD1 Receive Status @ 0xD2)
//------------------------------------------------------------------------------
#define UPD1RXSTAT_STATE__FMASK         0x03 ///< PD1 Receive State                                 
#define UPD1RXSTAT_STATE__SHIFT         0x00 ///< PD1 Receive State                                 
#define UPD1RXSTAT_STATE__WAITING       0x00 ///< Waiting for preamble pattern.                     
#define UPD1RXSTAT_STATE__PREAMBLE_REC  0x01 ///< Received preamble pattern, waiting for non-       
                                             ///< preamble 20-bit ordered set K-codes.              
#define UPD1RXSTAT_STATE__WAITING_EOP   0x02 ///< Received 20-bit ordered set K-codes, waiting for  
                                             ///< EOP.                                              
#define UPD1RXSTAT_STATE__REC_EOP       0x03 ///< Received EOP, waiting for idle (RXBUSY = 0).      
                                                                                                    
#define UPD1RXSTAT_CRCERR__BMASK        0x04 ///< CRC Error                                         
#define UPD1RXSTAT_CRCERR__SHIFT        0x02 ///< CRC Error                                         
#define UPD1RXSTAT_CRCERR__NOT_SET      0x00 ///< No CRC error in the current received packet.      
#define UPD1RXSTAT_CRCERR__SET          0x04 ///< CRC error in the current received packet.         
                                                                                                    
#define UPD1RXSTAT_ISNIB__BMASK         0x08 ///< Last FIFO Byte Nibble Status                      
#define UPD1RXSTAT_ISNIB__SHIFT         0x03 ///< Last FIFO Byte Nibble Status                      
#define UPD1RXSTAT_ISNIB__NOT_SET       0x00 ///< The last RX FIFO data contains a full byte of     
                                             ///< data.                                             
#define UPD1RXSTAT_ISNIB__SET           0x08 ///< The last RX FIFO data contains only the low nibble
                                             ///< data.                                             
                                                                                                    
#define UPD1RXSTAT_OSTYPE__FMASK        0x70 ///< Ordered Set Type                                  
#define UPD1RXSTAT_OSTYPE__SHIFT        0x04 ///< Ordered Set Type                                  
#define UPD1RXSTAT_OSTYPE__SOP          0x00 ///< SOP.                                              
#define UPD1RXSTAT_OSTYPE__SOP_P        0x10 ///< SOP'.                                             
#define UPD1RXSTAT_OSTYPE__SOP_DP       0x20 ///< SOP''.                                            
#define UPD1RXSTAT_OSTYPE__SOP_P_DEBUG  0x30 ///< SOP' Debug.                                       
#define UPD1RXSTAT_OSTYPE__SOP_DP_DEBUG 0x40 ///< SOP'' Debug.                                      
#define UPD1RXSTAT_OSTYPE__HARD_RESET   0x50 ///< Hard reset.                                       
#define UPD1RXSTAT_OSTYPE__CABLE_RESET  0x60 ///< Cable reset.                                      
#define UPD1RXSTAT_OSTYPE__UNIDENTIFIED 0x70 ///< Unidentified ordered set.                         
                                                                                                    
#define UPD1RXSTAT_RXBUSY__BMASK        0x80 ///< CC Line State                                     
#define UPD1RXSTAT_RXBUSY__SHIFT        0x07 ///< CC Line State                                     
#define UPD1RXSTAT_RXBUSY__NOT_SET      0x00 ///< The CC line is idle.                              
#define UPD1RXSTAT_RXBUSY__SET          0x80 ///< The CC line is busy.                              
                                                                                                    
//------------------------------------------------------------------------------
// UPD1RXTH Enums (PD1 Receive Threshold Configuration @ 0xE9)
//------------------------------------------------------------------------------
#define UPD1RXTH_THF__FMASK     0x07 ///< Falling Edge Receive Threshold                   
#define UPD1RXTH_THF__SHIFT     0x00 ///< Falling Edge Receive Threshold                   
                                                                                           
#define UPD1RXTH_THR__FMASK     0x38 ///< Rising Edge Receive Threshold                    
#define UPD1RXTH_THR__SHIFT     0x03 ///< Rising Edge Receive Threshold                    
                                                                                           
#define UPD1RXTH_THSEL__FMASK   0xC0 ///< Receive Threshold Level Select                   
#define UPD1RXTH_THSEL__SHIFT   0x06 ///< Receive Threshold Level Select                   
#define UPD1RXTH_THSEL__SINK    0x00 ///< THF and THR Threshold levels based on the SINK   
                                     ///< selection.                                       
#define UPD1RXTH_THSEL__SRC     0x40 ///< THF and THR Threshold levels based on the SRC    
                                     ///< selection.                                       
#define UPD1RXTH_THSEL__NEUTRAL 0x80 ///< THF and THR Threshold levels based on the NEUTRAL
                                     ///< selection.                                       
                                                                                           
//------------------------------------------------------------------------------
// UPD1TXCN0 Enums (PD1 Transmit Control 0 @ 0xC9)
//------------------------------------------------------------------------------
#define UPD1TXCN0_STARTTX__BMASK    0x01 ///< Start TX Transmission                             
#define UPD1TXCN0_STARTTX__SHIFT    0x00 ///< Start TX Transmission                             
#define UPD1TXCN0_STARTTX__SET      0x01 ///< Start the TX transmission.                        
                                                                                                
#define UPD1TXCN0_ENCORE__BMASK     0x02 ///< TX Driver Enable                                  
#define UPD1TXCN0_ENCORE__SHIFT     0x01 ///< TX Driver Enable                                  
#define UPD1TXCN0_ENCORE__DISABLED  0x00 ///< Disable the TX driver.                            
#define UPD1TXCN0_ENCORE__ENABLED   0x02 ///< Enable the TX driver.                             
                                                                                                
#define UPD1TXCN0_RESET__BMASK      0x04 ///< TX Engine Reset                                   
#define UPD1TXCN0_RESET__SHIFT      0x02 ///< TX Engine Reset                                   
#define UPD1TXCN0_RESET__SET        0x04 ///< Reset the TX engine.                              
                                                                                                
#define UPD1TXCN0_EOPOVR__BMASK     0x08 ///< End-of-Packet Override                            
#define UPD1TXCN0_EOPOVR__SHIFT     0x03 ///< End-of-Packet Override                            
#define UPD1TXCN0_EOPOVR__DISABLED  0x00 ///< Disable override.                                 
#define UPD1TXCN0_EOPOVR__ENABLED   0x08 ///< Transmit an EOP at the next 5-bit boundary in the 
                                         ///< packet to terminate the ongoing transmission      
                                         ///< early.                                            
                                                                                                
#define UPD1TXCN0_CRCEN__BMASK      0x10 ///< CRC Enable                                        
#define UPD1TXCN0_CRCEN__SHIFT      0x04 ///< CRC Enable                                        
#define UPD1TXCN0_CRCEN__DISABLED   0x00 ///< Disable CRC transmission at the end-of-packet. CRC
                                         ///< calculation will still be performed.              
#define UPD1TXCN0_CRCEN__ENABLED    0x10 ///< Enable a CRC calculation of outgoing data and     
                                         ///< transmit the CRC just before the EOP.             
                                                                                                
#define UPD1TXCN0_EOPEN__BMASK      0x20 ///< EOP Enable                                        
#define UPD1TXCN0_EOPEN__SHIFT      0x05 ///< EOP Enable                                        
#define UPD1TXCN0_EOPEN__DISABLED   0x00 ///< No EOP will be sent at the end of the packet.     
#define UPD1TXCN0_EOPEN__ENABLED    0x20 ///< EOP will be sent when there is no more data to    
                                         ///< transmit in the PD1 TX FIFO. This will be sent    
                                         ///< after CRC if CRCEN is 1.                          
                                                                                                
#define UPD1TXCN0_DELAY__BMASK      0x40 ///< TX Start Delay                                    
#define UPD1TXCN0_DELAY__SHIFT      0x06 ///< TX Start Delay                                    
#define UPD1TXCN0_DELAY__1_PERIOD   0x00 ///< Outputs 1 bit period low at the start of          
                                         ///< transmission.                                     
#define UPD1TXCN0_DELAY__2_PERIODS  0x40 ///< Outputs 2 bit periods low at the start of         
                                         ///< transmission.                                     
                                                                                                
#define UPD1TXCN0_BISTCR2__BMASK    0x80 ///< BIST Carrier Mode 2 Enable                        
#define UPD1TXCN0_BISTCR2__SHIFT    0x07 ///< BIST Carrier Mode 2 Enable                        
#define UPD1TXCN0_BISTCR2__DISABLED 0x00 ///< Disable BIST Carrier Mode 2 test operation.       
#define UPD1TXCN0_BISTCR2__ENABLED  0x80 ///< Enable BIST Carrier Mode 2 test operation.        
                                                                                                
//------------------------------------------------------------------------------
// UPD1TXKC1 Enums (PD1 Transmit KCODE 1 @ 0xCB)
//------------------------------------------------------------------------------
#define UPD1TXKC1_KCODE1__FMASK 0x1F ///< First K-Code
#define UPD1TXKC1_KCODE1__SHIFT 0x00 ///< First K-Code
                                                      
//------------------------------------------------------------------------------
// UPD1TXKC2 Enums (PD1 Transmit KCODE 2 @ 0xCC)
//------------------------------------------------------------------------------
#define UPD1TXKC2_KCODE2__FMASK 0x1F ///< Second K-Code
#define UPD1TXKC2_KCODE2__SHIFT 0x00 ///< Second K-Code
                                                       
//------------------------------------------------------------------------------
// UPD1TXKC3 Enums (PD1 Transmit KCODE 3 @ 0xCD)
//------------------------------------------------------------------------------
#define UPD1TXKC3_KCODE3__FMASK 0x1F ///< Third K-Code
#define UPD1TXKC3_KCODE3__SHIFT 0x00 ///< Third K-Code
                                                      
//------------------------------------------------------------------------------
// UPD1TXKC4 Enums (PD1 Transmit KCODE 4 @ 0xCE)
//------------------------------------------------------------------------------
#define UPD1TXKC4_KCODE4__FMASK 0x1F ///< Fourth K-Code
#define UPD1TXKC4_KCODE4__SHIFT 0x00 ///< Fourth K-Code
                                                       
//------------------------------------------------------------------------------
// UPD1TXSTAT Enums (PD1 TX Status @ 0xCA)
//------------------------------------------------------------------------------
#define UPD1TXSTAT_STATE__FMASK             0x0F ///< CC Transmission State                          
#define UPD1TXSTAT_STATE__SHIFT             0x00 ///< CC Transmission State                          
#define UPD1TXSTAT_STATE__IDLE              0x00 ///< Idle.                                          
#define UPD1TXSTAT_STATE__AUTOMATIC_STARTUP 0x01 ///< Automatic startup sequencing state.            
#define UPD1TXSTAT_STATE__DELAYED_STARTUP   0x02 ///< Delayed startup state (for longer low time just
                                                 ///< before start of preamble).                     
#define UPD1TXSTAT_STATE__PREAMBLE          0x03 ///< Preamble transmission state.                   
#define UPD1TXSTAT_STATE__KCODE1            0x04 ///< K-code 1 transmission.                         
#define UPD1TXSTAT_STATE__KCODE2            0x05 ///< K-code 2 transmission.                         
#define UPD1TXSTAT_STATE__KCODE3            0x06 ///< K-code 3 transmission.                         
#define UPD1TXSTAT_STATE__KCODE4            0x07 ///< K-code 4 transmission.                         
#define UPD1TXSTAT_STATE__LOWBMC            0x08 ///< Low-nibble BMC-encoded transmission.           
#define UPD1TXSTAT_STATE__HIGHBMC           0x09 ///< High-nibble BMC-encoded transmission.          
#define UPD1TXSTAT_STATE__LOWCRC            0x0A ///< Low-nibble of BMC-encoded CRC transmission.    
#define UPD1TXSTAT_STATE__HIGHCRC           0x0B ///< High-nibble of BMC-encoded CRC transmission.   
#define UPD1TXSTAT_STATE__EOP               0x0C ///< EOP transmission.                              
#define UPD1TXSTAT_STATE__TERM_EDGE         0x0D ///< Termination of transmission with possible      
                                                 ///< adjustment for trailing edge.                  
#define UPD1TXSTAT_STATE__TERM_LOW          0x0E ///< Termination of transmission with low driving   
                                                 ///< output.                                        
#define UPD1TXSTAT_STATE__BIST              0x0F ///< BIST Carrier Mode 2 transmission.              
                                                                                                     
#define UPD1TXSTAT_BUSY__BMASK              0x80 ///< PD1 TX Busy Flag                               
#define UPD1TXSTAT_BUSY__SHIFT              0x07 ///< PD1 TX Busy Flag                               
#define UPD1TXSTAT_BUSY__NOT_SET            0x00 ///< A transmission is not in progress.             
#define UPD1TXSTAT_BUSY__SET                0x80 ///< A transmission is in progress.                 
...
#define REF0CN_ENPD12__BMASK        0x40 ///< PD0 1.2V Reference                                
#define REF0CN_ENPD12__SHIFT        0x06 ///< PD0 1.2V Reference                                
#define REF0CN_ENPD12__DISABLED     0x00 ///< Disable the PD0 reference buffer.                 
#define REF0CN_ENPD12__ENABLED      0x40 ///< Enable the PD0 reference buffer.                  
...
#endif // SI_EFM8UB4_REGISTER_ENUMS_H
//-eof--------------------------------------------------------------------------
