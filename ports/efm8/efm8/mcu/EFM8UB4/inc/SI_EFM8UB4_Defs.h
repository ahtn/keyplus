...
#ifndef SI_EFM8UB4_DEFS_H
#define SI_EFM8UB4_DEFS_H
...
SI_SFR (UPD0CC,      0xAA); ///< PD0 CC Configuration                     
SI_SFR (UPD0CN0,     0x88); ///< PD0 Control                              
SI_SFR (UPD0CRC0,    0xA3); ///< PD0 CRC 0                                
SI_SFR (UPD0CRC1,    0xA4); ///< PD0 CRC 1                                
SI_SFR (UPD0CRC2,    0xA5); ///< PD0 CRC 2                                
SI_SFR (UPD0CRC3,    0xA6); ///< PD0 CRC 3                                
SI_SFR (UPD0DAT,     0x9A); ///< PD0 Transmit and Receive Buffer          
SI_SFR (UPD0FCN0,    0x9B); ///< PD0 FIFO Control 0                       
SI_SFR (UPD0FCN1,    0x9C); ///< PD0 FIFO Control 1                       
SI_SFR (UPD0FCT,     0x9D); ///< PD0 FIFO Count                           
SI_SFR (UPD0INTEN,   0x9F); ///< PD0 Interrupt Enable                     
SI_SFR (UPD0INTSTAT, 0x9E); ///< PD0 Interrupt Status                     
SI_SFR (UPD0RXCN0,   0x91); ///< PD0 Receive Control                      
SI_SFR (UPD0RXKC1,   0x93); ///< PD0 Receive KCODE 1                      
SI_SFR (UPD0RXKC2,   0x94); ///< PD0 Receive KCODE 2                      
SI_SFR (UPD0RXKC3,   0x95); ///< PD0 Receive KCODE 3                      
SI_SFR (UPD0RXKC4,   0x96); ///< PD0 Receive KCODE 4                      
SI_SFR (UPD0RXSHFT,  0xA2); ///< PD0 Receive Shift                        
SI_SFR (UPD0RXSTAT,  0x92); ///< PD0 Receive Status                       
SI_SFR (UPD0RXTH,    0xA1); ///< PD0 Receive Threshold Configuration      
SI_SFR (UPD0TXCN0,   0x89); ///< PD0 Transmit Control 0                   
SI_SFR (UPD0TXKC1,   0x8B); ///< PD0 Transmit KCODE 1                     
SI_SFR (UPD0TXKC2,   0x8C); ///< PD0 Transmit KCODE 2                     
SI_SFR (UPD0TXKC3,   0x8D); ///< PD0 Transmit KCODE 3                     
SI_SFR (UPD0TXKC4,   0x8E); ///< PD0 Transmit KCODE 4                     
SI_SFR (UPD0TXSTAT,  0x8A); ///< PD0 TX Status                            
SI_SFR (UPD1CC,      0xF1); ///< PD1 CC Configuration                     
SI_SFR (UPD1CN0,     0xC8); ///< PD1 Control                              
SI_SFR (UPD1CRC0,    0xEB); ///< PD1 CRC 0                                
SI_SFR (UPD1CRC1,    0xEC); ///< PD1 CRC 1                                
SI_SFR (UPD1CRC2,    0xED); ///< PD1 CRC 2                                
SI_SFR (UPD1CRC3,    0xEE); ///< PD1 CRC 3                                
SI_SFR (UPD1DAT,     0xDA); ///< PD1 Transmit and Receive Buffer          
SI_SFR (UPD1FCN0,    0xDB); ///< PD1 FIFO Control 0                       
SI_SFR (UPD1FCN1,    0xDC); ///< PD1 FIFO Control 1                       
SI_SFR (UPD1FCT,     0xDD); ///< PD1 FIFO Count                           
SI_SFR (UPD1INTEN,   0xDF); ///< PD1 Interrupt Enable                     
SI_SFR (UPD1INTSTAT, 0xDE); ///< PD1 Interrupt Status                     
SI_SFR (UPD1RXCN0,   0xD1); ///< PD1 Receive Control                      
SI_SFR (UPD1RXKC1,   0xD3); ///< PD1 Receive KCODE 1                      
SI_SFR (UPD1RXKC2,   0xD4); ///< PD1 Receive KCODE 2                      
SI_SFR (UPD1RXKC3,   0xD5); ///< PD1 Receive KCODE 3                      
SI_SFR (UPD1RXKC4,   0xD6); ///< PD1 Receive KCODE 4                      
SI_SFR (UPD1RXSHFT,  0xEA); ///< PD1 Receive Shift                        
SI_SFR (UPD1RXSTAT,  0xD2); ///< PD1 Receive Status                       
SI_SFR (UPD1RXTH,    0xE9); ///< PD1 Receive Threshold Configuration      
SI_SFR (UPD1TXCN0,   0xC9); ///< PD1 Transmit Control 0                   
SI_SFR (UPD1TXKC1,   0xCB); ///< PD1 Transmit KCODE 1                     
SI_SFR (UPD1TXKC2,   0xCC); ///< PD1 Transmit KCODE 2                     
SI_SFR (UPD1TXKC3,   0xCD); ///< PD1 Transmit KCODE 3                     
SI_SFR (UPD1TXKC4,   0xCE); ///< PD1 Transmit KCODE 4                     
SI_SFR (UPD1TXSTAT,  0xCA); ///< PD1 TX Status                            
...
// UPD0CN0 (PD0 Control)
#define SFR_UPD0CN0 0x88
SI_SBIT (UPD0CN0_FORCERX, SFR_UPD0CN0, 0); ///< Force RX Enable                    
SI_SBIT (UPD0CN0_IPPW0,   SFR_UPD0CN0, 1); ///< Pull-Up Current Source Select Bit 0
SI_SBIT (UPD0CN0_IPPW1,   SFR_UPD0CN0, 2); ///< Pull-Up Current Source Select Bit 1
SI_SBIT (UPD0CN0_ENREF,   SFR_UPD0CN0, 3); ///< Reference Buffer Enable            
SI_SBIT (UPD0CN0_CCSEL,   SFR_UPD0CN0, 7); ///< CC Pad Select                      

// UPD1CN0 (PD1 Control)
#define SFR_UPD1CN0 0xC8
SI_SBIT (UPD1CN0_FORCERX, SFR_UPD1CN0, 0); ///< Force RX Enable                    
SI_SBIT (UPD1CN0_IPPW0,   SFR_UPD1CN0, 1); ///< Pull-Up Current Source Select Bit 0
SI_SBIT (UPD1CN0_IPPW1,   SFR_UPD1CN0, 2); ///< Pull-Up Current Source Select Bit 1
SI_SBIT (UPD1CN0_ENREF,   SFR_UPD1CN0, 3); ///< Reference Buffer Enable            
...
#define PD0_IRQn     19 ///< USB Type-C Power Delivery 0
#define PD1_IRQn     20 ///< USB Type-C Power Delivery 1
...
#define USB0PD_PAGE    0x30 ///< USB0 PD Page    
