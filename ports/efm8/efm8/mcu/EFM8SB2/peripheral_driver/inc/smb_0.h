 ...
 *
 * @warning
 * The EFM8SB2 device has an errata describing problems using the SMB hardware
 * ack feature. Due to this library using hardware ack it should not be used
 * in the following applications.
 *
 * - MCU is a slave in a multi-slave system.
 * - MCU is a master in a multi-master system.
 *
 * See the errata for a description of the problem and it's effects.
 *
 *****************************************************************************/
