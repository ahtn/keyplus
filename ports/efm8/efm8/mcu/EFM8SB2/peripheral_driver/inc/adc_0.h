 ...
 * |--------------|--------------------------|------|-------|-------|------|
 * |Base          |                          |  148 |     0 |     0 |    2 |
 * |Init          |EFM8PDL_ADC0_USE_INIT     | +96  |     0 |     0 |   +7 |
 * |Auto Page     |EFM8PDL_ADC0_AUTO_PAGE    | +105 |     0 |     0 |   +3 |
 * |Default (All) |                          |  329 |     0 |     0 |   12 |
 *
 *****************************************************************************/
...
typedef enum {
    ...
    ADC0_RESOLUTION_10_BIT = ADC0CF_AD8BE__NORMAL, //!< Select 10-bit resolution.
} ADC0_Resolution_t;
...
typedef enum {
	...
	ADC0_POSITIVE_INPUT_VDD2 = 30, //!< VDD2 Supply Pin is ADC Positive Input
