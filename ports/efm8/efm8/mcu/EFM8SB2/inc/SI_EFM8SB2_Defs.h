...
#ifndef SI_EFM8SB2_DEFS_H
#define SI_EFM8SB2_DEFS_H
...
SI_SFR (ADC0TK,   0xBD); ///< ADC0 Burst Mode Track Time            
...
SI_SFR (CRC0CN0,  0x92); ///< CRC0 Control 0                        
...
SI_SFR (IREF0CN0, 0xB9); ///< Current Reference Control 0           
...
SI_SFR (SPI1CKR,  0x85); ///< SPI1 Clock Rate                       
SI_SFR (SPI1CN0,  0xB0); ///< SPI1 Control                          
...
SI_SFR (TOFFH,    0x86); ///< Temperature Sensor Offset High        
SI_SFR (TOFFL,    0x85); ///< Temperature Sensor Offset Low         
...
#define RTC0CN0  0x04 ///< RTC Control 0               
#define RTC0PIN  0x07 ///< RTC Pin Configuration       
#define RTC0XCF  0x06 ///< RTC Oscillator Configuration
#define RTC0XCN0 0x05 ///< RTC Oscillator Control 0    
...
#define SFR_SPI1CN0 0xB0
SI_SBIT (SPI1CN0_SPIEN,  SFR_SPI1CN0, 0); ///< SPI1 Enable            
SI_SBIT (SPI1CN0_TXBMT,  SFR_SPI1CN0, 1); ///< Transmit Buffer Empty  
SI_SBIT (SPI1CN0_NSSMD0, SFR_SPI1CN0, 2); ///< Slave Select Mode Bit 0
SI_SBIT (SPI1CN0_NSSMD1, SFR_SPI1CN0, 3); ///< Slave Select Mode Bit 1
SI_SBIT (SPI1CN0_RXOVRN, SFR_SPI1CN0, 4); ///< Receive Overrun Flag   
SI_SBIT (SPI1CN0_MODF,   SFR_SPI1CN0, 5); ///< Mode Fault Flag        
SI_SBIT (SPI1CN0_WCOL,   SFR_SPI1CN0, 6); ///< Write Collision Flag   
SI_SBIT (SPI1CN0_SPIF,   SFR_SPI1CN0, 7); ///< SPI1 Interrupt Flag    
...
#define CRC0_PAGE   0x0F ///< CRC0 Page                                 
