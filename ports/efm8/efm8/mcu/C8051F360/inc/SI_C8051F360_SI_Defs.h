...
#ifndef SI_C8051F360_SI_DEFS_H
#define SI_C8051F360_SI_DEFS_H
...
SI_SFR (CCH0CN,   0x84); ///< Cache Control                            
SI_SFR (CCH0LC,   0xD2); ///< Cache Lock Control                       
SI_SFR (CCH0MA,   0xD3); ///< Cache Miss Accumulator                   
SI_SFR (CCH0TN,   0xC9); ///< Cache Tuning                             
...
SI_SFR (EMI0TC,   0xF7); ///< External Memory Timing Control           
SI_SFR (FLKEY,    0xB7); ///< Flash Lock and Key                       
SI_SFR (FLSCL,    0xB6); ///< Flash Scale                              
SI_SFR (FLSTAT,   0xAC); ///< Flash Status                             
...
SI_SFR (MAC0AH,   0xA5); ///< Operand A High Byte                      
SI_SFR (MAC0AL,   0xA4); ///< Operand A Low Byte                       
SI_SFR (MAC0BH,   0xF2); ///< Operand B High Byte                      
SI_SFR (MAC0BL,   0xF1); ///< Operand B Low Byte                       
SI_SFR (MAC0CF,   0xD7); ///< MAC0 Configuration                       
SI_SFR (MAC0OVR,  0xD6); ///< Accumulator Overflow Byte                
SI_SFR (MAC0RNDH, 0xAF); ///< Rounded Result High Byte                 
SI_SFR (MAC0RNDL, 0xAE); ///< Rounded Result Low Byte                  
SI_SFR (MAC0STA,  0xCF); ///< MAC0 Status                              
SI_SFR (OSCICL,   0xBF); ///< High Frequency Oscillator Calibration    
SI_SFR (OSCICN,   0xB7); ///< High Frequency Oscillator Control        
SI_SFR (OSCLCN,   0xAD); ///< Internal Low Frequency Oscillator Control
SI_SFR (OSCXCN,   0xB6); ///< External Oscillator Control              
...
SI_SFR (PCA0CPH5, 0xF6); ///< PCA Channel 5 Capture Module High Byte   
...
SI_SFR (PCA0CPL5, 0xF5); ///< PCA Channel 5 Capture Module Low Byte    
...
SI_SFR (PLL0CN,   0xB3); ///< PLL Control                              
SI_SFR (PLL0DIV,  0xA9); ///< PLL Divider                              
SI_SFR (PLL0FLT,  0xB2); ///< PLL Filter                               
SI_SFR (PLL0MUL,  0xB1); ///< PLL Multiplier                           
...
SI_SFR (SFR0CN,   0xE5); ///< SFR Page Control                         
...
SI_SFR16 (MAC0A,   0xA4); ///< Operand A                    
SI_SFR16 (MAC0B,   0xF1); ///< Operand B                    
SI_SFR16 (MAC0RND, 0xAE); ///< Rounded Result               
...
SI_SFR16 (PCA0CP5, 0xF5); ///< PCA Channel 5 Capture Module 
...
#define CMP0_PAGE    0x00 ///< Comparator 0 Page                 
#define CMP1_PAGE    0x00 ///< Comparator 1 Page                 
#define DAC0_PAGE    0x00 ///<                                   
#define LEGACY_PAGE  0x00 ///< Legacy SFR Page                   
#define MAC0_PAGE    0x00 ///< Multiply and Accumulate (MAC) Page
#define PCA0_PAGE    0x00 ///<                                   
#define PMATCH_PAGE  0x00 ///< Port Match Page                   
#define SMBUS0_PAGE  0x00 ///<                                   
#define SPI0_PAGE    0x00 ///<                                   
#define TIMER01_PAGE 0x00 ///< Timer 0/1 Page                    
#define TIMER2_PAGE  0x00 ///<                                   
#define TIMER3_PAGE  0x00 ///<                                   
#define UART0_PAGE   0x00 ///< UART0 Page                        
#define CONFIG_PAGE  0x0F ///< System and Port Configuration Page
#define EMIF0_PAGE   0x0F ///< External Memory Interface Page    
