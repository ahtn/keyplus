...
#ifndef SI_C8051F990_DEFS_H
#define SI_C8051F990_DEFS_H
...
SFR (ADC0MX,   0x96); ///< ADC0 Multiplexer Selection                       
...
SFR (CRC0FLIP, 0x9C); ///< CRC0 Bit Flip                                    
...
SFR (CS0MD1,   0xAF); ///< Capacitive Sense 0 Mode 1                        
SFR (CS0MD2,   0xF3); ///< Capacitive Sense 0 Mode 2                        
SFR (CS0MD3,   0xF3); ///< Capacitive Sense 0 Mode 3                        
SFR (CS0MX,    0xAB); ///< Capacitive Sense 0 Mux Channel Select            
SFR (CS0PM,    0xDE); ///< Capacitive Sense 0 Pin Monitor                   
SFR (CS0SCAN0, 0xD2); ///< Capacitive Sense 0 Channel Scan Mask 0           
SFR (CS0SCAN1, 0xD3); ///< Capacitive Sense 0 Channel Scan Mask 1           
...
SFR (DERIVID,  0xE3); ///< Device Identification                            
...
SFR (IREF0CN,  0xD6); ///< Current Reference Control                        
...
SFR (PMU0MD,   0xB5); ///< Power Management Unit Mode                       
