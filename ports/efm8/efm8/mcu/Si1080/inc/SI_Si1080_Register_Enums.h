...
#ifndef SI_SI1080_REGISTER_ENUMS_H
#define SI_SI1080_REGISTER_ENUMS_H

//Standard device includes
#include "SI_Si1080_Defs.h"
//------------------------------------------------------------------------------
...
#define ADC0MX_ADC0MX__VDD     0x1E ///< VDD/DC+ Supply Voltage.       
...
#define CPT0MX_CMXP__VDD_DIV_2    0x0D ///< VDD/DC+ divided by 2.                  
#define CPT0MX_CMXP__VBAT         0x0E ///< VBAT Supply Voltage.                   
#define CPT0MX_CMXP__VDD          0x0F ///< VDD/DC+ Supply Voltage.                
...
#define CPT0MX_CMXN__VDD_DIV_2    0xD0 ///< VDD/DC+ divided by 2.                  
...
#define CPT1MX_CMXP__VDD_DIV_2    0x0D ///< VDD/DC+ divided by 2.                  
#define CPT1MX_CMXP__VBAT         0x0E ///< VBAT Supply Voltage.                   
#define CPT1MX_CMXP__VDD          0x0F ///< VDD/DC+ Supply Voltage.                
...
#define CPT1MX_CMXN__VDD_DIV_2    0xD0 ///< VDD/DC+ divided by 2.                  
...
//------------------------------------------------------------------------------
// DC0CF Enums (DC-DC Converter Configuration @ 0x96)
//------------------------------------------------------------------------------
#define DC0CF_CLKSEL__BMASK          0x01 ///< DC-DC Converter Clock Source Select               
#define DC0CF_CLKSEL__SHIFT          0x00 ///< DC-DC Converter Clock Source Select               
#define DC0CF_CLKSEL__LOCAL          0x00 ///< The dc-dc converter is clocked from its local     
                                          ///< oscillator.                                       
#define DC0CF_CLKSEL__SYSCLK         0x01 ///< The dc-dc converter is clocked from the system    
                                          ///< clock.                                            
                                                                                                 
#define DC0CF_VDDSLP__BMASK          0x02 ///< VDD/DC+ Sleep Mode Connection                     
#define DC0CF_VDDSLP__SHIFT          0x01 ///< VDD/DC+ Sleep Mode Connection                     
#define DC0CF_VDDSLP__VBAT           0x00 ///< VDD/DC+ connected to VBAT in Sleep Mode.          
#define DC0CF_VDDSLP__FLOATING       0x02 ///< VDD/DC+ is floating in Sleep Mode.                
                                                                                                 
#define DC0CF_ILIMIT__BMASK          0x04 ///< Peak Current Limit Threshold                      
#define DC0CF_ILIMIT__SHIFT          0x02 ///< Peak Current Limit Threshold                      
#define DC0CF_ILIMIT__MODE0          0x00 ///< If SWSEL is 1, the current limit is 100 mA in     
                                          ///< normal mode and 75 mA in low power mode. If SWSEL 
                                          ///< is 0, the current limit is 250 mA in normal mode  
                                          ///< and 125 mA in low power mode.                     
#define DC0CF_ILIMIT__MODE1          0x04 ///< If SWSEL is 1, the current limit is 125 mA in     
                                          ///< normal mode and 100 mA in low power mode. If SWSEL
                                          ///< is 0, the current limit is 500 mA in normal mode  
                                          ///< and 250 mA in low power mode.                     
                                                                                                 
#define DC0CF_CLKINV__BMASK          0x08 ///< DC-DC Converter Clock Invert                      
#define DC0CF_CLKINV__SHIFT          0x03 ///< DC-DC Converter Clock Invert                      
#define DC0CF_CLKINV__NOT_INVERTED   0x00 ///< The dc-dc converter clock is inverted.            
#define DC0CF_CLKINV__INVERTED       0x08 ///< The dc-dc converter clock is not inverted.        
                                                                                                 
#define DC0CF_AD0CKINV__BMASK        0x10 ///< ADC0 Clock Inversion (Clock Invert During Sync)   
#define DC0CF_AD0CKINV__SHIFT        0x04 ///< ADC0 Clock Inversion (Clock Invert During Sync)   
#define DC0CF_AD0CKINV__INVERTED     0x00 ///< ADC0 SAR clock is inverted.                       
#define DC0CF_AD0CKINV__NOT_INVERTED 0x10 ///< ADC0 SAR clock is not inverted.                   
                                                                                                 
#define DC0CF_CLKDIV__FMASK          0x60 ///< DC-DC Clock Divider                               
#define DC0CF_CLKDIV__SHIFT          0x05 ///< DC-DC Clock Divider                               
#define DC0CF_CLKDIV__SYSCLK_DIV_1   0x00 ///< The dc-dc converter clock is system clock divided 
                                          ///< by 1.                                             
#define DC0CF_CLKDIV__SYSCLK_DIV_2   0x20 ///< The dc-dc converter clock is system clock divided 
                                          ///< by 2.                                             
#define DC0CF_CLKDIV__SYSCLK_DIV_4   0x40 ///< The dc-dc converter clock is system clock divided 
                                          ///< by 4.                                             
#define DC0CF_CLKDIV__SYSCLK_DIV_8   0x60 ///< The dc-dc converter clock is system clock divided 
                                          ///< by 8.                                             
                                                                                                 
#define DC0CF_LPEN__BMASK            0x80 ///< Low Power Mode Enable                             
#define DC0CF_LPEN__SHIFT            0x07 ///< Low Power Mode Enable                             
#define DC0CF_LPEN__DISABLED         0x00 ///< Disable low power mode.                           
#define DC0CF_LPEN__ENABLED          0x80 ///< Enable low power mode.                            
                                                                                                 
//------------------------------------------------------------------------------
// DC0CN Enums (DC-DC Converter Control @ 0x97)
//------------------------------------------------------------------------------
#define DC0CN_VSEL__FMASK       0x07 ///< DC-DC Converter Output Voltage Select           
#define DC0CN_VSEL__SHIFT       0x00 ///< DC-DC Converter Output Voltage Select           
#define DC0CN_VSEL__OUTPUT_1P8  0x00 ///< Target output voltage is 1.8 V.                 
#define DC0CN_VSEL__OUTPUT_1P9  0x01 ///< Target output voltage is 1.9 V.                 
#define DC0CN_VSEL__OUTPUT_2P0  0x02 ///< Target output voltage is 2.0 V.                 
#define DC0CN_VSEL__OUTPUT_2P1  0x03 ///< Target output voltage is 2.1 V.                 
#define DC0CN_VSEL__OUTPUT_2P4  0x04 ///< Target output voltage is 2.4 V.                 
#define DC0CN_VSEL__OUTPUT_2P7  0x05 ///< Target output voltage is 2.7 V.                 
#define DC0CN_VSEL__OUTPUT_3P0  0x06 ///< Target output voltage is 3.0 V.                 
#define DC0CN_VSEL__OUTPUT_3P3  0x07 ///< Target output voltage is 3.3 V.                 
                                                                                          
#define DC0CN_SYNC__BMASK       0x08 ///< ADC0 Synchronization Enable                     
#define DC0CN_SYNC__SHIFT       0x03 ///< ADC0 Synchronization Enable                     
#define DC0CN_SYNC__DISABLED    0x00 ///< The ADC is not synchronized to the dc-dc        
                                     ///< converter.                                      
#define DC0CN_SYNC__ENABLED     0x08 ///< The ADC is synchronized to the dc-dc converter. 
                                                                                          
#define DC0CN_SWSEL__BMASK      0x20 ///< DC-DC Converter Switch Select                   
#define DC0CN_SWSEL__SHIFT      0x05 ///< DC-DC Converter Switch Select                   
#define DC0CN_SWSEL__LARGE      0x00 ///< The large switches are selected (best efficiency
                                     ///< for high output currents).                      
#define DC0CN_SWSEL__SMALL      0x20 ///< The small switches are selected (best efficiency
                                     ///< for low output currents).                       
                                                                                          
#define DC0CN_MINPW__FMASK      0xC0 ///< DC-DC Converter Minimum Pulse Width             
#define DC0CN_MINPW__SHIFT      0x06 ///< DC-DC Converter Minimum Pulse Width             
#define DC0CN_MINPW__NO_MINIMUM 0x00 ///< No minimum duty cycle.                          
#define DC0CN_MINPW__20_NS      0x40 ///< Minimum pulse width is 20 ns.                   
#define DC0CN_MINPW__40_NS      0x80 ///< Minimum pulse width is 40 ns.                   
#define DC0CN_MINPW__80_NS      0xC0 ///< Minimum pulse width is 80 ns.                   
                                                                                          
//------------------------------------------------------------------------------
// DC0MD Enums (DC-DC Mode @ 0x94)
//------------------------------------------------------------------------------
#define DC0MD_PASDEN__BMASK                     0x01 ///< Passive Diode Mode Enable                        
#define DC0MD_PASDEN__SHIFT                     0x00 ///< Passive Diode Mode Enable                        
#define DC0MD_PASDEN__DISABLED                  0x00 ///< Disable passive diode mode.                      
#define DC0MD_PASDEN__ENABLED                   0x01 ///< Enable passive diode mode.                       
                                                                                                           
#define DC0MD_BYPSEL__FMASK                     0x06 ///< Bypass Mode Select                               
#define DC0MD_BYPSEL__SHIFT                     0x01 ///< Bypass Mode Select                               
#define DC0MD_BYPSEL__BYPASS_DISABLED           0x00 ///< Bypass mode disabled. This creates the highest   
                                                     ///< supply current when the input voltage exceeds the
                                                     ///< programmed output voltage.                       
#define DC0MD_BYPSEL__BYPASS_WITH_DCDC_ENABLED  0x02 ///< Bypass enabled (auto switch), dc-dc oscillator   
                                                     ///< enabled (fast response time).                    
#define DC0MD_BYPSEL__BYPASS_WITH_DCDC_DISABLED 0x04 ///< Bypass enabled (auto switch), dc-dc oscillator   
                                                     ///< disabled (reduced supply current).               
#define DC0MD_BYPSEL__FORCED_BYPASS             0x06 ///< The dc-dc converter is forced into bypass mode,  
                                                     ///< which creates the lowest supply current when the 
                                                     ///< input voltage exceeds the programmed output      
                                                     ///< voltage.                                         
                                                                                                           
#define DC0MD_BYPFLG__BMASK                     0x08 ///< Bypass Flag                                      
#define DC0MD_BYPFLG__SHIFT                     0x03 ///< Bypass Flag                                      
#define DC0MD_BYPFLG__NOT_SET                   0x00 ///< DC0 is not operating in bypass mode.             
#define DC0MD_BYPFLG__SET                       0x08 ///< DC0 is operating in bypass mode.                 
...
#define XBR1_SPI1E__BMASK                          0x40 ///< Radio Serial Interface (SPI1) I/O Enable         
#define XBR1_SPI1E__SHIFT                          0x06 ///< Radio Serial Interface (SPI1) I/O Enable         
#define XBR1_SPI1E__DISABLED                       0x00 ///< Radio unavailable at Port pins.                  
#define XBR1_SPI1E__ENABLED                        0x40 ///< Radio Serial Interface (SPI1) I/O routed to Port 
                                                        ///< pins.                                            
...
#define PMU0MD_MONDIS__ENABLED  0x00 ///< Enable the VBAT supply monitor.    
#define PMU0MD_MONDIS__DISABLED 0x20 ///< Disable the VBAT supply monitor.   
...
//------------------------------------------------------------------------------
#define RTC0PIN_RTCPIN__BMASK          0x80 ///< RTC Pin Configuration                             
#define RTC0PIN_RTCPIN__SHIFT          0x07 ///< RTC Pin Configuration                             
#define RTC0PIN_RTCPIN__NORMAL         0x00 ///< XTAL3 and XTAL4 are in their normal configuration.
#define RTC0PIN_RTCPIN__SELF_OSCILLATE 0x80 ///< XTAL3 and XTAL4 are internally shorted for use    
...
//------------------------------------------------------------------------------
// SPI1CN Enums (SPI1 Control @ 0xB0)
//------------------------------------------------------------------------------
...
#define TMR3CN_T3XCLK__SYSCLK_DIV_12_CAP_CMP1   0x00 ///< External Clock is SYSCLK/12. Capture trigger is   
                                                     ///< Comparator 1.                                     
#define TMR3CN_T3XCLK__EXTOSC_DIV_8_CAP_CMP1    0x01 ///< External Clock is External Oscillator/8. Capture  
...
#define TMR3CN_T3XCLK__CMP1_CAP_EXTOSC          0x03 ///< External Clock is Comparator 1. Capture trigger is
                                                     ///< External Oscillator/8.                            
...
//------------------------------------------------------------------------------
// VDM0CN Enums (VDD/DC+ Supply Monitor Control @ 0xFF)
//------------------------------------------------------------------------------
#define VDM0CN_VBATOKIE__BMASK             0x04 ///< VBAT Early Warning Interrupt Enable          
#define VDM0CN_VBATOKIE__SHIFT             0x02 ///< VBAT Early Warning Interrupt Enable          
#define VDM0CN_VBATOKIE__DISABLED          0x00 ///< Disable the VBAT Early Warning interrupt.    
#define VDM0CN_VBATOKIE__ENABLED           0x04 ///< Enable the VBAT Early Warning interrupt.     
                                                                                                  
#define VDM0CN_VDDOKIE__BMASK              0x08 ///< VDD/DC+ Early Warning Interrupt Enable       
#define VDM0CN_VDDOKIE__SHIFT              0x03 ///< VDD/DC+ Early Warning Interrupt Enable       
#define VDM0CN_VDDOKIE__DISABLED           0x00 ///< Disable the VDD/DC+ Early Warning interrupt. 
#define VDM0CN_VDDOKIE__ENABLED            0x08 ///< Enable the VDD/DC+ Early Warning interrupt.  
                                                                                                  
#define VDM0CN_VBATOK__BMASK               0x10 ///< VBAT Supply Status (Early Warning)           
#define VDM0CN_VBATOK__SHIFT               0x04 ///< VBAT Supply Status (Early Warning)           
#define VDM0CN_VBATOK__VBAT_BELOW_VBATWARN 0x00 ///< VBAT is at or below the VBATWARN threshold.  
#define VDM0CN_VBATOK__VBAT_ABOVE_VBATWARN 0x10 ///< VBAT is above the VBATWARN threshold.        
                                                                                                  
#define VDM0CN_VDDOK__BMASK                0x20 ///< VDD/DC+ Supply Status (Early Warning)        
#define VDM0CN_VDDOK__SHIFT                0x05 ///< VDD/DC+ Supply Status (Early Warning)        
#define VDM0CN_VDDOK__VDD_BELOW_VDDWARN    0x00 ///< VDD/DC+ is at or below the VDDWARN threshold.
#define VDM0CN_VDDOK__VDD_ABOVE_VDDWARN    0x20 ///< VDD/DC+ is above the VDDWARN threshold.      
                                                                                                  
#define VDM0CN_VDDSTAT__BMASK              0x40 ///< VDD/DC+ Supply Status                        
#define VDM0CN_VDDSTAT__SHIFT              0x06 ///< VDD/DC+ Supply Status                        
#define VDM0CN_VDDSTAT__VDD_BELOW_VRST     0x00 ///< VDD/DC+ is at or below the VRST threshold.   
#define VDM0CN_VDDSTAT__VDD_ABOVE_VRST     0x40 ///< VDD/DC+ is above the VRST threshold.         
                                                                                                  
#define VDM0CN_VDMEN__BMASK                0x80 ///< VDD/DC+ Supply Monitor Enable                
#define VDM0CN_VDMEN__SHIFT                0x07 ///< VDD/DC+ Supply Monitor Enable                
#define VDM0CN_VDMEN__DISABLED             0x00 ///< Disable the VDD/DC+ Supply Monitor.          
#define VDM0CN_VDMEN__ENABLED              0x80 ///< Enable the VDD/DC+ Supply Monitor.           
...
#define REF0CN_REFSL__VDD_PIN         0x08 ///< The ADC0 voltage reference is the VDD/DC+ pin.   
...
#endif // SI_SI1080_REGISTER_ENUMS_H
//-eof--------------------------------------------------------------------------
