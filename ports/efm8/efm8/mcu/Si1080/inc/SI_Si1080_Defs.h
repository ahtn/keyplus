...
#ifndef SI_SI1080_DEFS_H
#define SI_SI1080_DEFS_H
...
SFR (ADC0TK,   0xBD); ///< ADC0 Burst Mode Track Time            
...
SFR (DC0CF,    0x96); ///< DC-DC Converter Configuration         
SFR (DC0CN,    0x97); ///< DC-DC Converter Control               
SFR (DC0MD,    0x94); ///< DC-DC Mode                            
...
SFR (SPI1CKR,  0x85); ///< SPI1 Clock Rate                       
...
SFR (TOFFH,    0x86); ///< Temperature Sensor Offset High        
SFR (TOFFL,    0x85); ///< Temperature Sensor Offset Low         
SFR (VDM0CN,   0xFF); ///< VDD/DC+ Supply Monitor Control        
...
#define SPI1_IRQn      18 ///< Radio Serial Interface (SPI1)
