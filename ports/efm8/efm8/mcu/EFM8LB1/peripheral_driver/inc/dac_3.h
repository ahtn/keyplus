...
/**************************************************************************//**
 * @addtogroup dac_3 DAC3 Driver
 * @{
 *
 * @brief Peripheral driver for DAC3
 *
 * # Introduction #
 *
 * This module provides an API for using the DAC3 peripheral. This includes
 ...
 * |--------------|--------------------------|------|-------|-------|------|
 * |Base          |                          |  29  |     0 |     0 |   0.1|
 * |Init          |EFM8PDL_DAC3_USE_INIT     | +18  |     0 |     0 |   0  |
 * |Auto Page     |EFM8PDL_DAC3_AUTO_PAGE    | +45  |     0 |     0 |  +1  |
 * |Default (All) |                          |  92  |     0 |     0 |   1.1|
 *
 * ## Setting Output Voltage ##
 * The DAC3 module is used to output a user determined voltage to a pin. The
 ...
 * using the simple initialization function DAC3_init(), or when generating 
 ...
 * is driven on the output pin. This can be accomplished through the DAC3_enable()
 * and DAC3_disable() functions.
 *
 ...
 ******************************************************************************/
/**************************************************************************//**
 * @def EFM8PDL_DAC3_AUTO_PAGE
 * @brief Controls if the library handles SI_SFR paging.
 *
 * When '1' the DAC3 driver automatically handles setting and restoring
 ...
 *****************************************************************************/
 /**************************************************************************//**
 * @def EFM8PDL_DAC3_USE_INIT
 * @brief Controls inclusion of DAC3 Initialization function.
 *
 * When '1' the DAC3_init() function is available for use. This provides a
...
#ifndef EFM8PDL_DAC3_AUTO_PAGE
 #define EFM8PDL_DAC3_AUTO_PAGE 1
#endif

#ifndef EFM8PDL_DAC3_USE_INIT
 #define EFM8PDL_DAC3_USE_INIT 1
#endif

// Initialization API
/**************************************************************************//**
 * @addtogroup dac3_init DAC3 Initialization API
 * @{
 *****************************************************************************/
 
/// @brief Output Update Trigger Source Enum.
typedef enum {
    DAC3_UPDATE_TRIGGER_SYSCLK  = DAC3CF0_UPDATE__SYSCLK, //!< DAC3 output updates occur on every SYSCLK clock cycle
    DAC3_UPDATE_TRIGGER_TIMER3  = DAC3CF0_UPDATE__TIMER3, //!< DAC3 output updates occur on Timer 3 high byte overflow
    DAC3_UPDATE_TRIGGER_TIMER4  = DAC3CF0_UPDATE__TIMER4, //!< DAC3 output updates occur on Timer 4 high byte overflow
    DAC3_UPDATE_TRIGGER_TIMER5  = DAC3CF0_UPDATE__TIMER5, //!< DAC3 output updates occur on Timer 5 high byte overflow
    DAC3_UPDATE_TRIGGER_CLU0    = DAC3CF0_UPDATE__CLU0, //!< DAC3 output updates occur on Configurable Logic output 0 rising edge
    DAC3_UPDATE_TRIGGER_CLU1    = DAC3CF0_UPDATE__CLU1,   //!< DAC3 output updates occur on Configurable Logic output 1 rising edge
    DAC3_UPDATE_TRIGGER_CLU2    = DAC3CF0_UPDATE__CLU2, //!< DAC3 output updates occur on Configurable Logic output 2 rising edge
    DAC3_UPDATE_TRIGGER_CLU3    = DAC3CF0_UPDATE__CLU3, //!< DAC3 output updates occur on Configurable Logic output 3 rising edge
  }DAC3_UpdateTrigger_t ;
...
/** @} (end dac3_init DAC3 Initialization API) */

// Runtime API
/**************************************************************************//**
 * @addtogroup dac3_runtime DAC3 Runtime API
 * @{
 *****************************************************************************/
 /***************************************************************************//**
 * @brief
 ...
 * registers, or if the DAC's output voltage is being held by DAC3_holdOutput().
 *
 ******************************************************************************/
uint16_t DAC3_getOutput(void);

/** @} (end adc0_runtime ADC0 Runtime API) */
/** @} (end addtogroup dac_3 DAC3 Driver) */
