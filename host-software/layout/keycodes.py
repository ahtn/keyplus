...
def gen_modkey(kc, ctrl=False, shift=False, alt=False, gui=False, right=False, force=False):
    mod_mask = 0
...
MODKEY_LEFT_ALT               = gen_modkey(KC_NONE, alt=True)
MODKEY_LEFT_GUI               = gen_modkey(KC_NONE, gui=True)
MODKEY_RIGHT_CONTROL          = gen_modkey(KC_NONE, right=True, ctrl=True)
MODKEY_RIGHT_SHIFT            = gen_modkey(KC_NONE, right=True, shift=True)
MODKEY_RIGHT_ALT              = gen_modkey(KC_NONE, right=True, alt=True)
MODKEY_RIGHT_GUI              = gen_modkey(KC_NONE, right=True, gui=True)


if __name__ == "__main__":
    print("a", hex(gen_modkey(KC_A)))
    print("ls-a", hex(gen_modkey(KC_A, shift=True)))
    print("csag-a", hex(gen_modkey(KC_A, ctrl=True, alt=True, shift=True, gui=True)))
    print("rcsag-a", hex(gen_modkey(KC_A, ctrl=True, alt=True, shift=True, gui=True, right=True)))
    print("rs-a", hex(gen_modkey(KC_A, shift=True, right=True)))
