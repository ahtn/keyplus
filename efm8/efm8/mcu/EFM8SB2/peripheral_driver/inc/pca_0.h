 ...
 * # Theory of Operation #
 *
 * The Programmable counter array provides 3 main categories of functionality.
 *
 * - PWM
 * - Counter/capture
 * - Timer
...
/**************************************************************************//**
 * @def EFM8PDL_PCA0_AUTO_PAGE
 * @brief Controls if the library handles SI_SFR paging.
 *
 * When '1' the PCA0 driver automatically handles setting and restoring
...
#ifndef EFM8PDL_PCA0_AUTO_PAGE
#define EFM8PDL_PCA0_AUTO_PAGE 1
#endif
...
typedef enum
{
  ...
  PCA0_CHAN3 = 0x3,         //!<  PCA Channel 3
  PCA0_CHAN4 = 0x4,         //!<  PCA Channel 4
  PCA0_CHAN5 = 0x5,         //!<  PCA Channel 5
} PCA0_Channel_t;
...
#define PCA0_IOVERFLOW_IF 0x40                //!<  Intermediate overflow flag
...
#define PCA0_CHAN3_IF     PCA0CN0_CCF3__BMASK  //!<  Channel 3
#define PCA0_CHAN4_IF     PCA0CN0_CCF4__BMASK  //!<  Channel 4
#define PCA0_CHAN5_IF     PCA0CN0_CCF5__BMASK  //!<  Channel 4
/** @} (end addtogroup pca0_if Interrupt Flag Enums) */

/**************************************************************************//**
 * @brief Return the value of the specified interrupt flag
 *
 * @return
...
#if IS_DOXYGEN
  PCA0_LFOSC_DIV8  = -1,                         //!< NOT SUPPORTED ON THIS DEVICE
#endif
} PCA0_Timebase_t;
...
typedef enum
{
  ...
  //xx11 000* (CPM) 0x30
  //0x*0 0xxx (PWM)
  PCA0_CAPTURE_TOGGLE_CEX = PCA0CPM0_PWM16__8_BIT //!< Capture Mode triggered by CEX rising or falling
                           | PCA0CPM0_ECOM__DISABLED
                           | PCA0CPM0_CAPP__ENABLED
                           | PCA0CPM0_CAPN__ENABLED
                           | PCA0CPM0_MAT__DISABLED
...
#if IS_DOXYGEN
  PCA0_PWM8_CENTER       = -1, //!< NOT SUPPORTED ON THIS DEVICE
  PCA0_PWM9_CENTER       = -1, //!< NOT SUPPORTED ON THIS DEVICE
  PCA0_PWM10_CENTER      = -1, //!< NOT SUPPORTED ON THIS DEVICE
  PCA0_PWM11_CENTER      = -1, //!< NOT SUPPORTED ON THIS DEVICE
  PCA0_PWM16_CENTER      = -1, //!< NOT SUPPORTED ON THIS DEVICE
#endif
} PCA0_ChannelMode_t;
...
#if IS_DOXYGEN
  PCA0_INVERT_POLARITY   = -1,  //!< NOT SUPPORTED ON THIS DEVICE
#endif
 ...
 *
 * @todo:
 * remove idle state selection? Should be ON most of the time.
 *
 ******************************************************************************/
 ...
 * @param pol:
 * Desired output polatiry for this channel.
 *
 ******************************************************************************/
...
/***************************************************************************//**
 * @brief
 * Callback for channel 3 events.
 *
 * This function is defined by the user and called when there is a capture
 * or compare event on channel 3
 *
 * @warning
 * This function is called from an ISR and should be as short as possible.
 *
...
/***************************************************************************//**
 * @brief
 * Callback for channel 4 events.
 *
 * This function is defined by the user and called when there is a capture
 * or compare event on channel 4
 *
 * @warning
 * This function is called from an ISR and should be as short as possible.
 *
...
/***************************************************************************//**
 * @brief 
 * Callback for channel 5 events.
 *
 * This function is defined by the user and called when there is a capture
 * or compare event on channel 5
 *
 * @warning 
 * This function is called from an ISR and should be as short as possible.
 *
 ******************************************************************************/
extern void PCA0_channel5EventCb();
