...
/**************************************************************************//**
 *
 * @addtogroup spi_1_group SPI1 Driver
 * @{
 *
 * @brief Peripheral driver for SPI 1
 *
 * # Introduction #
 *
 * @note This driver is the same as the SPI0 peripheral driver, except that
 * SPI0 is replaced by SPI1.  All of the functions work in the same way.
 *
 * This module provides an API for using the SPI1 peripheral.  There is a
...
/**************************************************************************//**
 * @addtogroup spi1_config SPI Driver Configuration
 * @{
 *
...
/**************************************************************************//**
 * @def EFM8PDL_SPI1_USE_BUFFER
 * @brief Controls inclusion of SPI1 Buffer Access API.
 *
 ...
 * When set to '1' the SPI1 Buffered Access API is included in the driver.
 *
 * @note When this feature is enabled, a SPI1 interrupt handler will be
...
/**************************************************************************//**
 * @def EFM8PDL_SPI1_USE_ERR_CALLBACK
 * @brief Controls whether buffered API uses an error callback function.
 *
 * This option is only meaningful if @ref EFM8PDL_SPI1_USE_BUFFER is enabled.
 * If this option is enabled, when an error is detected in the SPI interrupt
 * handler, the callback function SPI1_transferErrorCallback() will be called.
...
/**************************************************************************//**
 * @def EFM8PDL_SPI1_USE_PIPELINE
 * @brief Controls buffered mode data pipelining.
 *
 * When using a buffered transfer with SPI1_transfer() the data can be
 ...
 * SPI1_pollTransfer() or SPI1_transfer().  Valid values are:
 *
...
/**  @} (end addtogroup spi1_config */

// Option macro default values

#ifdef IS_DOXYGEN
#define EFM8PDL_SPI1_USE_BUFFER 1
#define EFM8PDL_SPI1_AUTO_PAGE 1
#define EFM8PDL_SPI1_USE_ERR_CALLBACK 1
#endif

#ifndef EFM8PDL_SPI1_USE_BUFFER
#define EFM8PDL_SPI1_USE_BUFFER 0
#endif
#ifndef EFM8PDL_SPI1_TX_SEGTYPE
#define EFM8PDL_SPI1_TX_SEGTYPE SI_SEG_XDATA
#endif
#ifndef EFM8PDL_SPI1_RX_SEGTYPE
#define EFM8PDL_SPI1_RX_SEGTYPE SI_SEG_XDATA
#endif
#ifndef EFM8PDL_SPI1_AUTO_PAGE
#define EFM8PDL_SPI1_AUTO_PAGE 1
#endif
#ifndef EFM8PDL_SPI1_USE_PIPELINE
#define EFM8PDL_SPI1_USE_PIPELINE 0
#endif
#ifndef EFM8PDL_SPI1_USE_ERR_CALLBACK
#define EFM8PDL_SPI1_USE_ERR_CALLBACK 0
#endif

// Runtime API

/**************************************************************************//**
 * @addtogroup spi1_runtime SPI1 Runtime API
 * @{
 *****************************************************************************/

/**************************************************************************//**
 * @addtogroup spi1_if SPI Interrupt Flag Enums
 *
 * The following macros define the interrupt bits in the SPI interrupt flag
 * register.  These value are used with the functions SPI1_getIntFlags() and
 * SPI1_clearIntFlags().
 *
 * @{
 *****************************************************************************/
...
#define SPI1_MODF_IF SPI1CN0_MODF__BMASK
...
#define SPI1_RXOVR_IF SPI1CN0_RXOVRN__BMASK

/**  @} (end addtogroup spi1_if) */
 ...
 * value can be tested against the [Interrupt flag enums](@ref spi1_if ) by
 ...
 *
 * ~~~~~~~~.c
 * uint8_t intFlags = SPI1_getIntFlags();
 *
 * if (intFlags & SPI1_INT_IF)
 * {
 *   // handle transfer complete interrupt
 * }
 * if (intFlags & SPI1_RXOVR_IF)
 * {
 *   // handle receive overflow
 * }
 *
 * // Clear interrupts
 * SPI1_clearIntFlags(intFlags);
 * ~~~~~~~~
 *
 * @note This function is implemented as a macro if EFM8PDL_SPI1_AUTO_PAGE
 * is 0.
 *****************************************************************************/
#if defined(IS_DOXYGEN) || (EFM8PDL_SPI1_AUTO_PAGE == 1)
extern uint8_t SPI1_getIntFlags(void);
#else
#define SPI1_getIntFlags(x) (SPI1CN0 & 0xF0)
#endif
 ...
 * of one or more [Interrupt flag enums](@ref spi1_if).
 *
 * @note This function is implemented as a macro if EFM8PDL_SPI1_AUTO_PAGE
 * is 0.
 *****************************************************************************/
#if defined(IS_DOXYGEN) || (EFM8PDL_SPI1_AUTO_PAGE == 1)
extern void SPI1_clearIntFlags(uint8_t flags);
#else
#define SPI1_clearIntFlags(flags)                                             \
            do {SPI1CN0 = (SPI1CN0 & (~flags | 0x0F));} while (0)
#endif
...
extern bool SPI1_enableInt(void);
#else
#define SPI1_enableInt(x) do { EIE2 |= EIE2_ESPI1__BMASK; } while (0)
#endif
 ...
 *****************************************************************************/
#if defined(IS_DOXYGEN)
extern bool SPI1_disableInt(void);
#else
#define SPI1_disableInt(x) do { EIE2 &= ~EIE2_ESPI1__BMASK; } while (0)
#endif
 ...
 *****************************************************************************/
extern bool SPI1_writeByte(uint8_t value);
 ...
 *****************************************************************************/
extern void SPI1_pollWriteByte(uint8_t value);
...
#else
#define SPI1_readByte(x) (SPI1DAT)
#endif
...
typedef enum
{
  SPI1_TRANSFER_RX = 1,     /**< RX only */
  SPI1_TRANSFER_TX = 2,     /**< TX only */
  SPI1_TRANSFER_RXTX = 3,   /**< both directions */
} SPI1_TransferDirection_t;
 ...
 * the _dir_ argument should be SPI1_TRANSFER_TX, and the _pRxBuffer_
 ...
 * _dir_ should be set to SPI1_TRANSFER_TX and _pRxBuffer_ can be set to
 * **NULL** and all bytes received from the interface will be discarded.
 * For a receive-only operation, _dir_ should be set to SPI1_TRANSFER_RX,
 ...
 * SPI1_pollTransfer(myTxBuf, myRxBuf, SPI1_TRANSFER_RXTX, 16);
 *
 * // Receive 12 bytes, and send none
 * // (This will cause 12 zero bytes to be sent)
 * SPI1_pollTransfer(NULL, myRxBuf, SPI1_TRANSFER_RX, 12);
 * ~~~~~~~~
 *
 * @note The memory type of the TX and RX buffers much match the type
 * of the configuration macros @ref EFM8PDL_SPI1_TX_SEGTYPE and
 * @ref EFM8PDL_SPI1_RX_SEGTYPE.
 *
 ...
 *****************************************************************************/
extern uint8_t
SPI1_pollTransfer(SI_VARIABLE_SEGMENT_POINTER(pTxBuffer, uint8_t, EFM8PDL_SPI1_TX_SEGTYPE),
                  SI_VARIABLE_SEGMENT_POINTER(pRxBuffer, uint8_t, EFM8PDL_SPI1_RX_SEGTYPE),
                  SPI1_TransferDirection_t dir, uint8_t xferCount);
 ...
 *****************************************************************************/
#if defined(IS_DOXYGEN) || (EFM8PDL_SPI1_AUTO_PAGE == 1)
extern bool SPI1_isTxFull(void);
#else
#define SPI1_isTxFull(x) (!((bool)(SPI1CN0_TXBMT)))
#endif
 ...
 *****************************************************************************/
#if defined(IS_DOXYGEN) || (EFM8PDL_SPI1_AUTO_PAGE == 1)
extern bool SPI1_isSlaveSelected(void);
#else
#define SPI1_isSlaveSelected(x) ((bool)(SPI1CFG & 0x8))
#endif
 ...
 *****************************************************************************/
#if defined(IS_DOXYGEN) || (EFM8PDL_SPI1_AUTO_PAGE == 1)
extern bool SPI1_isShiftEmpty(void);
#else
#define SPI1_isShiftEmpty(x) ((bool)(SPI1CFG & 0x2))
#endif

/**************************************************************************//**
 * Check if SPI slave receive buffer is empty.
 *
 * @return __True__ if this SPI slave RX buffer is empty.
 *
 * @note This function is only valid for SPI slave mode.
 * @note This function is implemented as a macro if EFM8PDL_SPI1_AUTO_PAGE
 * is 0.
 *****************************************************************************/
#if defined(IS_DOXYGEN) || (EFM8PDL_SPI1_AUTO_PAGE == 1)
extern bool SPI1_isRxEmpty(void);
#else
#define SPI1_isRxEmpty(x) ((bool)(SPI1CFG & 0x1))
#endif

/**  @} (end addtogroup spi1_runtime) */

/**************************************************************************//**
 * @addtogroup spi1_init SPI1 Initialization API
 *
...
{
  /// POL=0, PHA=0
  SPI1_CLKMODE_0 = SPI1CFG_CKPOL__IDLE_LOW | SPI1CFG_CKPHA__DATA_CENTERED_FIRST,
  /// POL=0, PHA=1
  SPI1_CLKMODE_1 = SPI1CFG_CKPOL__IDLE_LOW | SPI1CFG_CKPHA__DATA_CENTERED_SECOND,
  /// POL=1, PHA=0
  SPI1_CLKMODE_2 = SPI1CFG_CKPOL__IDLE_HIGH | SPI1CFG_CKPHA__DATA_CENTERED_FIRST,
  /// POL=1, PHA=1
  SPI1_CLKMODE_3 = SPI1CFG_CKPOL__IDLE_HIGH | SPI1CFG_CKPHA__DATA_CENTERED_SECOND
} SPI1_ClockMode_t;
 ...
 * @ref SPI1_ClockMode_t for clock configuration choices.
 *
 ...
 *****************************************************************************/
extern void SPI1_init(SPI1_ClockMode_t clockMode,
...
#else
#define SPI1_reset(x) do{SPI1CN0 &= 0x0E; EIE2_ESPI1 = 0;}while(0)
#endif
 ...
 * value will be used.
 *****************************************************************************/
extern void SPI1_setClockDivider(uint16_t divider);

/** @} spi1_init */

#if EFM8PDL_SPI1_USE_BUFFER == 1
/**************************************************************************//**
 * @addtogroup spi1_buffer SPI1 Buffered API
 *
 ...
 *
 * The buffered API functions are available when @ref EFM8PDL_SPI1_USE_BUFFER
 ...
 * The transfer must have been started using SPI1_transfer().
 *
 * @note This function is called in interrupt context.
 *****************************************************************************/
extern void SPI1_transferCompleteCb(void);

#if EFM8PDL_SPI1_USE_ERR_CALLBACK == 1
/**************************************************************************//**
 ...
 * SPI transfer.  The transfer must have been started using SPI1_transfer().
 ...
 *
 * - @ref SPI1_MODF_IF - master mode conflict with external SPI master
 * - @ref SPI1_RXOVR_IF - receive overrun
 *
 ...
 * @ref EFM8PDL_SPI1_USE_ERR_CALLBACK is set to 1 in 'efm8_config.h'.
 *
 * @note This function is called in interrupt context.
 *****************************************************************************/
extern void SPI1_transferErrorCb(uint8_t errFlags);
#endif // EFM8PDL_SPI1_USE_ERR_CALLBACK
 ...
 * user callback function SPI1_transferCompleteCb() will be called when
 ...
 *
 * // Transfer 16 bytes in and out
 * SPI1_transfer(myTxBuf, myRxBuf, SPI1_TRANSFER_RXTX, 16);
 *
 * // Receive 12 bytes, and send none
 * // (This will cause 12 zero bytes to be sent)
 * SPI1_transfer(NULL, myRxBuf, SPI1_TRANSFER_RX, 12);
 * ~~~~~~~~
 *
 * @note The memory type of the TX and RX buffers much match the type
 * of the configuration macros @ref EFM8PDL_SPI1_TX_SEGTYPE and
 ...
 *****************************************************************************/
extern void
SPI1_transfer(SI_VARIABLE_SEGMENT_POINTER(pTxBuffer, uint8_t, EFM8PDL_SPI1_TX_SEGTYPE),
              SI_VARIABLE_SEGMENT_POINTER(pRxBuffer, uint8_t, EFM8PDL_SPI1_RX_SEGTYPE),
              SPI1_TransferDirection_t dir, uint8_t xferCount);
 ...
 *****************************************************************************/
extern void SPI1_abortTransfer(void);
 ...
 *
 * When a transfer is started with SPI1_transfer(), this function can be
 * used to determine how many bytes are remaining to transfer.  This value
 * will be zero if the transfer is complete.
 *****************************************************************************/
extern uint8_t SPI1_bytesRemaining(void);

/** @} spi1_buffer */
#endif // EFM8PDL_SPI1_USE_BUFFER
