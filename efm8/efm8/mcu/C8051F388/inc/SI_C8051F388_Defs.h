...
#ifndef SI_C8051F388_DEFS_H
#define SI_C8051F388_DEFS_H
...
SFR (CKCON1,   0xE4); ///< Clock Control 1                          
...
SFR (SFRPAGE,  0xBF); ///< SFR Page                                 
SFR (SMB0ADM,  0xCE); ///< SMBus 0 Slave Address Mask               
SFR (SMB0ADR,  0xCF); ///< SMBus 0 Slave Address                    
SFR (SMB0CF,   0xC1); ///< SMBus 0 Configuration                    
SFR (SMB0CN,   0xC0); ///< SMBus 0 Control                          
SFR (SMB0DAT,  0xC2); ///< SMBus 0 Data                             
SFR (SMB1ADM,  0xCE); ///< SMBus 1 Slave Address Mask               
SFR (SMB1ADR,  0xCF); ///< SMBus 1 Slave Address                    
SFR (SMB1CF,   0xC1); ///< SMBus 1 Configuration                    
SFR (SMB1CN,   0xC0); ///< SMBus 1 Control                          
SFR (SMB1DAT,  0xC2); ///< SMBus 1 Data                             
SFR (SMBTC,    0xB9); ///< SMBus Timing and Pin Control             
...
#define INT2LVL_IRQn 15 ///< INT2 Level            
