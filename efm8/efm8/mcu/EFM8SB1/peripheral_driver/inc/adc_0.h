...
typedef enum {
    ...
    ADC0_POSITIVE_INPUT_P10 = 10, //!< ADC0P10 is ADC Positive Input
    ADC0_POSITIVE_INPUT_P11 = 11, //!< ADC0P11 is ADC Positive Input
    ADC0_POSITIVE_INPUT_P12 = 12, //!< ADC0P12 is ADC Positive Input
    ADC0_POSITIVE_INPUT_TEMP = 27, //!< Internal Temperature Sensor is ADC Positive Input
    ADC0_POSITIVE_INPUT_VDD = 28, //!< VDD Supply Pin is ADC Positive Input
    ADC0_POSITIVE_INPUT_LDO_OUT = 29, //!< Internal 1.8 V LDO Output is ADC Positive Input
    ADC0_POSITIVE_INPUT_GND = 31, //!< GND Supply Pin is ADC Positive Input
