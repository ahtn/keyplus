...
#ifndef SI_C8051F700_SI_DEFS_H
#define SI_C8051F700_SI_DEFS_H
...
SI_SFR (CLKSEL,   0xBD); ///< Clock Select                                     
...
SI_SFR (CRC0CN,   0x91); ///< CRC0 Control                                     
SI_SFR (CRC0CNT,  0x97); ///< CRC0 Automatic Flash Sector Count                
SI_SFR (CRC0DAT,  0xD9); ///< CRC0 Data Output                                 
SI_SFR (CRC0FLIP, 0x95); ///< CRC0 Bit Flip                                    
SI_SFR (CRC0IN,   0x94); ///< CRC0 Data Input                                  
SI_SFR (CS0CF,    0x9E); ///< Capacitive Sense 0 Configuration                 
SI_SFR (CS0CN,    0x9A); ///< Capacitive Sense 0 Control                       
SI_SFR (CS0DH,    0xAA); ///< Capacitive Sense 0 Data High Byte                
SI_SFR (CS0DL,    0xA9); ///< Capacitive Sense 0 Data Low Byte                 
SI_SFR (CS0MD1,   0xAD); ///< Capacitive Sense 0 Mode 1                        
SI_SFR (CS0MD2,   0xBE); ///< Capacitive Sense 0 Mode 2                        
SI_SFR (CS0MX,    0x9C); ///< Capacitive Sense 0 Mux Channel Select            
SI_SFR (CS0PM,    0x9F); ///< Capacitive Sense 0 Pin Monitor                   
SI_SFR (CS0SE,    0x93); ///< Capacitive Sense 0 Auto Scan End Channel         
SI_SFR (CS0SS,    0x92); ///< Capacitive Sense 0 Auto Scan Start Channel       
SI_SFR (CS0THH,   0x97); ///< Capacitive Sense 0 Comparator Threshold High Byte
SI_SFR (CS0THL,   0x96); ///< Capacitive Sense 0 Comparator Threshold Low Byte 
SI_SFR (DERIVID,  0xEC); ///< Derivative Identification                        
SI_SFR (DEVICEID, 0xC4); ///< Device Identification                            
SI_SFR (DPH,      0x83); ///< Data Pointer High                                
SI_SFR (DPL,      0x82); ///< Data Pointer Low                                 
SI_SFR (EEADR,    0xB6); ///< EEPROM Byte Address                              
SI_SFR (EECN,     0xC5); ///< EEPROM Control                                   
SI_SFR (EEDAT,    0xD1); ///< EEPROM Byte Data                                 
SI_SFR (EEKEY,    0xC6); ///< EEPROM Key                                       
SI_SFR (EIE1,     0xE6); ///< Extended Interrupt Enable 1                      
SI_SFR (EIE2,     0xE7); ///< Extended Interrupt Enable 2                      
SI_SFR (EIP1,     0xCE); ///< Extended Interrupt Priority 1                    
SI_SFR (EIP2,     0xCF); ///< Extended Interrupt Priority 2                    
SI_SFR (EMI0CF,   0xC7); ///< External Memory Configuration                    
SI_SFR (EMI0CN,   0xAA); ///< External Memory Interface Control                
SI_SFR (EMI0TC,   0xEE); ///< External Memory Timing Control                   
...
SI_SFR (OSCICL,   0xBF); ///< High Frequency Oscillator Calibration            
SI_SFR (OSCICN,   0xA9); ///< High Frequency Oscillator Control                
SI_SFR (OSCXCN,   0xB5); ///< External Oscillator Control                      
SI_SFR (P0,       0x80); ///< Port 0 Pin Latch                                 
SI_SFR (P0DRV,    0xF9); ///< Port 0 Drive Strength                            
SI_SFR (P0MASK,   0xF4); ///< Port 0 Mask                                      
SI_SFR (P0MAT,    0xF3); ///< Port 0 Match                                     
...
SI_SFR (P1DRV,    0xFA); ///< Port 1 Drive Strength                            
SI_SFR (P1MASK,   0xE2); ///< Port 1 Mask                                      
SI_SFR (P1MAT,    0xE1); ///< Port 1 Match                                     
...
SI_SFR (P2DRV,    0xFB); ///< Port 2 Drive Strength                            
...
SI_SFR (P3DRV,    0xFC); ///< Port 3 Drive Strength                            
SI_SFR (P3MDIN,   0xF4); ///< Port 3 Input Mode                                
SI_SFR (P3MDOUT,  0xAF); ///< Port 3 Output Mode                               
SI_SFR (P4,       0xAC); ///< Port 4 Pin Latch                                 
SI_SFR (P4DRV,    0xFD); ///< Port 4 Drive Strength                            
SI_SFR (P4MDIN,   0xF5); ///< Port 4 Input Mode                                
SI_SFR (P4MDOUT,  0x9A); ///< Port 4 Output Mode                               
SI_SFR (P5,       0xB3); ///< Port 5 Pin Latch                                 
SI_SFR (P5DRV,    0xFE); ///< Port 5 Drive Strength                            
SI_SFR (P5MDIN,   0xF6); ///< Port 5 Input Mode                                
SI_SFR (P5MDOUT,  0x9B); ///< Port 5 Output Mode                               
SI_SFR (P6,       0xB2); ///< Port 6 Pin Latch                                 
SI_SFR (P6DRV,    0xC1); ///< Port 6 Drive Strength                            
SI_SFR (P6MDIN,   0xF7); ///< Port 6 Input Mode                                
SI_SFR (P6MDOUT,  0x9C); ///< Port 6 Output Mode                               
...
SI_SFR (PCA0MD,   0xED); ///< PCA Mode                                         
SI_SFR (PCA0PWM,  0xA1); ///< PCA PWM Configuration                            
SI_SFR (PCON,     0x87); ///< Power Control                                    
SI_SFR (PSCTL,    0x8F); ///< Program Store Control                            
SI_SFR (PSW,      0xD0); ///< Program Status Word                              
SI_SFR (REF0CN,   0xD2); ///< Voltage Reference Control                        
SI_SFR (REG0CN,   0xB9); ///< Voltage Regulator Control                        
SI_SFR (REVID,    0xAD); ///< Revision Identifcation                           
...
SI_SFR (SMB0ADM,  0xBB); ///< SMBus 0 Slave Address Mask                       
SI_SFR (SMB0ADR,  0xBA); ///< SMBus 0 Slave Address                            
...
SI_SFR (WDTCN,    0xE3); ///< Watchdog Timer Control                           
...
SI_SFR16 (CS0D,    0xA9); ///< Capacitive Sense 0 Data                 
SI_SFR16 (CS0TH,   0x96); ///< Capacitive Sense 0 Comparator Threshold 
...
#define CS0EOC_IRQn  15 ///< CS0 End of Conversion 
#define CS0DCMP_IRQn 16 ///< CS0 Digital Comparator
