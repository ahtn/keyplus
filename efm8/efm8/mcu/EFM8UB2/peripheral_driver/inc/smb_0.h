...
/**************************************************************************//**
 * @def EFM8PDL_SMB0_AUTO_PAGE
 * @brief Controls if the library handles SI_SFR paging.
 *
 * When '1' the SMB0 driver automatically handles setting and restoring
...
// Runtime API
/***************************************************************************//**
 *  @addtogroup i2c0_runtime SMB0 Runtime API
 *  @{
 ******************************************************************************/
 ...
 *
 * Valid enums flag can be found in the Status Flag Enums group.
 ******************************************************************************/
...
/** @} (end addtogroup i2c0_runtime SMB0 Runtime API) */

// Initialization API
/***************************************************************************//**
 * @addtogroup i2c0_init SMB0 Initialization API
 * @{
 ******************************************************************************/
...
/** @} (end addtogroup i2c0_init SMB0 Initialization API) */
...
// Buffered API
/***************************************************************************//**
 * @addtogroup i2c0_buffered SMB0 Buffered API
 * @{
 ******************************************************************************/
...
/** @} (end addtogroup i2c0_buffered SMB0 Buffered API) */
...
/** @} (end addtogroup i2c_0 SMB0 Driver) */
#endif //__SMB_0_H__
