 ...
 * @brief
 * Controls the inclusion of putchar and setchar for use with printf/scanf.
 *
 ...
 * @brief
 * Controls inclusion of UART0 Buffer Access API.
 *
 ...
 *
 ******************************************************************************/
void UART0_clearIntFlags(uint8_t flag);
 ...
 *
 * @retur
 * 0 if transfer is not in progress.
 *
 ******************************************************************************/
