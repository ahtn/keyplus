...
#if IS_DOXYGEN
#define PCA0_IOVERFLOW_IF -1  //!< NOT SUPPORTED ON THIS DEVICE
#define PCA0_CHAN5_IF     -1  //!< NOT SUPPORTED ON THIS DEVICE
#endif
/**  @} (end addtogroup pca0_if Interrupt Flag Enums) */

/**************************************************************************//**
 * @brief Return the value of the interrupt flags
 *
 * @return
...
typedef enum
{
  ...
  //0100101*
  PCA0_PWM8              = PCA0CPM0_PWM16__8_BIT //!< 8-bit PWM
                           | PCA0CPM0_ECOM__ENABLED
                           | PCA0CPM0_CAPP__DISABLED
                           | PCA0CPM0_CAPN__DISABLED
                           | PCA0CPM0_MAT__ENABLED
  ...
  //1100101*
  PCA0_PWM16             = PCA0CPM0_PWM16__16_BIT //!< 16-bit PWM
                           | PCA0CPM0_ECOM__ENABLED
                           | PCA0CPM0_CAPP__DISABLED
                           | PCA0CPM0_CAPN__DISABLED
                           | PCA0CPM0_MAT__ENABLED
  ...
  PCA0_PWM9              = -1, //!< NOT SUPPORTED ON THIS DEVICE
  PCA0_PWM9_CENTER       = -1, //!< NOT SUPPORTED ON THIS DEVICE
  PCA0_PWM10             = -1, //!< NOT SUPPORTED ON THIS DEVICE
  PCA0_PWM10_CENTER      = -1, //!< NOT SUPPORTED ON THIS DEVICE
  PCA0_PWM11             = -1, //!< NOT SUPPORTED ON THIS DEVICE
...
/***************************************************************************//**
 * @def void PCA0_intermediateOverflowCb()
 *
 * @warning
