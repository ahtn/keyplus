...
SI_INTERRUPT(SMB0_ISR, SMBUS0_IRQn)
{
  ...
  case SMB0_MASTER_START:
    ...
    //tailchain: clear_start; Other cases will jump here to execute this sequence
    // due to compiler case statment optomization (tailchaining)
    SMB0CN0_STA = 0;
    smbBusy = true;
    break;
