...
#ifndef SI_C8051F390_SI_DEFS_H
#define SI_C8051F390_SI_DEFS_H
...
SI_SFR (CRC0AUTO, 0xDD); ///< CRC0 Automatic Control                   
SI_SFR (CRC0CN,   0xDF); ///< CRC0 Control                             
SI_SFR (CRC0CNT,  0xDE); ///< CRC0 Automatic Flash Sector Count        
SI_SFR (CRC0DAT,  0x9E); ///< CRC0 Data Output                         
SI_SFR (CRC0FLIP, 0x9A); ///< CRC0 Bit Flip                            
SI_SFR (CRC0IN,   0x9C); ///< CRC0 Data Input                          
SI_SFR (DERIVID,  0xAB); ///< Device Derivative ID                     
...
SI_SFR (EIP1H,    0x85); ///< Extended Interrupt Priority 1 High       
SI_SFR (EIP2,     0xBF); ///< Extended Interrupt Priority 2            
SI_SFR (EIP2H,    0x86); ///< Extended Interrupt Priority 2 High       
...
SI_SFR (IDA1H,    0x97); ///< IDAC1 Data High Byte                     
SI_SFR (IDA1L,    0x96); ///< IDAC1 Data Low Byte                      
...
SI_SFR (REVISION, 0xAC); ///< Revision Identifcation                   
...
SI_SFR (SMB0ADM,  0xE7); ///< SMBus 0 Slave Address Mask               
...
SI_SFR (SMB1ADM,  0xE7); ///< SMBus 1 Slave Address Mask               
SI_SFR (SMB1ADR,  0xD7); ///< SMBus 1 Slave Address                    
SI_SFR (SMB1CF,   0xC1); ///< SMBus 1 Configuration                    
SI_SFR (SMB1CN,   0xC0); ///< SMBus 1 Control                          
SI_SFR (SMB1DAT,  0xC2); ///< SMBus 1 Data                             
SI_SFR (SMBTC,    0xC7); ///< SMBus Timing and Pin Control             
SI_SFR (SN0,      0xAB); ///< Serial Number Byte 0                     
SI_SFR (SN1,      0xAC); ///< Serial Number Byte 1                     
SI_SFR (SN2,      0xAD); ///< Serial Number Byte 2                     
SI_SFR (SN3,      0xAE); ///< Serial Number Byte 3                     
...
SI_SFR (TS0DATH,  0xD3); ///< Temperature Sensor Output High Byte      
SI_SFR (TS0DATL,  0xD2); ///< Temperature Sensor Output Low Byte       
...
SI_SFR16 (TS0DAT,  0xD2); ///< Temperature Sensor Output    
