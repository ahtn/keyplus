...
#ifndef SI_C8051F390_DEFS_H
#define SI_C8051F390_DEFS_H
...
SFR (IDA1H,    0x97); ///< IDAC1 Data High Byte                     
SFR (IDA1L,    0x96); ///< IDAC1 Data Low Byte                      
...
SFR (REVISION, 0xAC); ///< Revision Identifcation                   
...
SFR (SMB0ADM,  0xE7); ///< SMBus 0 Slave Address Mask               
...
SFR (SMB1ADM,  0xE7); ///< SMBus 1 Slave Address Mask               
SFR (SMB1ADR,  0xD7); ///< SMBus 1 Slave Address                    
SFR (SMB1CF,   0xC1); ///< SMBus 1 Configuration                    
SFR (SMB1CN,   0xC0); ///< SMBus 1 Control                          
SFR (SMB1DAT,  0xC2); ///< SMBus 1 Data                             
SFR (SMBTC,    0xC7); ///< SMBus Timing and Pin Control             
SFR (SN0,      0xAB); ///< Serial Number Byte 0                     
SFR (SN1,      0xAC); ///< Serial Number Byte 1                     
SFR (SN2,      0xAD); ///< Serial Number Byte 2                     
SFR (SN3,      0xAE); ///< Serial Number Byte 3                     
...
SFR (TMR4CN,   0x91); ///< Timer 4 Control                          
SFR (TMR4H,    0x95); ///< Timer 4 High Byte                        
SFR (TMR4L,    0x94); ///< Timer 4 Low Byte                         
SFR (TMR4RLH,  0x93); ///< Timer 4 Reload High Byte                 
SFR (TMR4RLL,  0x92); ///< Timer 4 Reload Low Byte                  
SFR (TMR5CN,   0xC8); ///< Timer 5 Control                          
SFR (TMR5H,    0xCD); ///< Timer 5 High Byte                        
SFR (TMR5L,    0xCC); ///< Timer 5 Low Byte                         
SFR (TMR5RLH,  0xCB); ///< Timer 5 Reload High Byte                 
SFR (TMR5RLL,  0xCA); ///< Timer 5 Reload Low Byte                  
SFR (TS0CN,    0xD2); ///< Temperature Sensor Control               
SFR (TS0DATH,  0xD3); ///< Temperature Sensor Output High Byte      
SFR (TS0DATL,  0xD2); ///< Temperature Sensor Output Low Byte       
...
SFR16 (TMR4,    0x94); ///< Timer 4                      
SFR16 (TMR4RL,  0x92); ///< Timer 4 Reload               
SFR16 (TMR5,    0xCC); ///< Timer 5                      
SFR16 (TMR5RL,  0xCA); ///< Timer 5 Reload               
SFR16 (TS0DAT,  0xD2); ///< Temperature Sensor Output    
...
SBIT (SMB1CN_SI,      SFR_SMB1CN, 0); ///< SMBus Interrupt Flag            
SBIT (SMB1CN_ACK,     SFR_SMB1CN, 1); ///< SMBus Acknowledge               
SBIT (SMB1CN_ARBLOST, SFR_SMB1CN, 2); ///< SMBus Arbitration Lost Indicator
SBIT (SMB1CN_ACKRQ,   SFR_SMB1CN, 3); ///< SMBus Acknowledge Request       
SBIT (SMB1CN_STO,     SFR_SMB1CN, 4); ///< SMBus Stop Flag                 
SBIT (SMB1CN_STA,     SFR_SMB1CN, 5); ///< SMBus Start Flag                
SBIT (SMB1CN_TXMODE,  SFR_SMB1CN, 6); ///< SMBus Transmit Mode Indicator   
SBIT (SMB1CN_MASTER,  SFR_SMB1CN, 7); ///< SMBus Master/Slave Indicator    
...
SBIT (TMR5CN_T5XCLK,  SFR_TMR5CN, 0); ///< Timer 5 External Clock Select    
SBIT (TMR5CN_TR5,     SFR_TMR5CN, 2); ///< Timer 5 Run Control              
SBIT (TMR5CN_T5SPLIT, SFR_TMR5CN, 3); ///< Timer 5 Split Mode Enable        
SBIT (TMR5CN_TF5LEN,  SFR_TMR5CN, 5); ///< Timer 5 Low Byte Interrupt Enable
SBIT (TMR5CN_TF5L,    SFR_TMR5CN, 6); ///< Timer 5 Low Byte Overflow Flag   
SBIT (TMR5CN_TF5H,    SFR_TMR5CN, 7); ///< Timer 5 High Byte Overflow Flag  
...
#define SMBUS1_IRQn  15 ///< SMBus 1                     
#define TIMER4_IRQn  16 ///< Timer 4 Overflow            
#define TIMER5_IRQn  17 ///< Timer 5 Overflow            
#define PTEMP0_IRQn  18 ///< Precision Temperature Sensor

//------------------------------------------------------------------------------
// SFR Page Definitions
//------------------------------------------------------------------------------
#define IDAC0_PAGE     0x00 ///< IDAC0 Page                         
#define LEGACY_PAGE    0x00 ///< Legacy SFR Page                    
#define PTEMPDAT_PAGE  0x00 ///< Precision Temperature Sensor Data  
#define SMBUS0_PAGE    0x00 ///< SMBus 0 Page                       
#define TIMER2_PAGE    0x00 ///< Timer 2 Page                       
#define TIMER3_PAGE    0x00 ///< Timer 3 Page                       
#define CONFIG_PAGE    0x0F ///< System and Port Configuration Page 
#define IDAC1_PAGE     0x0F ///< IDAC1 Page                         
#define PTEMPCFG_PAGE  0x0F ///< Precision Temperature Sensor Config
#define SERIALNUM_PAGE 0x0F ///< Serial Number Page                 
#define SMBUS1_PAGE    0x0F ///< SMBus 1 Page                       
#define TIMER4_PAGE    0x0F ///< Timer 4 Page                       
#define TIMER5_PAGE    0x0F ///< Timer 5 Page                       
