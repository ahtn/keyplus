...
#ifndef SI_C8051F350_SI_DEFS_H
#define SI_C8051F350_SI_DEFS_H
...
SI_SFR (ADC0BUF,  0xBD); ///< ADC0 Input Buffer Control             
SI_SFR (ADC0CF,   0xFB); ///< ADC0 Configuration                    
SI_SFR (ADC0CGH,  0xAD); ///< ADC0 Gain Calibration High Byte       
SI_SFR (ADC0CGL,  0xAB); ///< ADC0 Gain Calibration Low Byte        
SI_SFR (ADC0CGM,  0xAC); ///< ADC0 Gain Calibration Middle Byte     
SI_SFR (ADC0CLK,  0xF7); ///< ADC0 Modulator Clock Divisor          
SI_SFR (ADC0CN,   0xF4); ///< ADC0 Control                          
SI_SFR (ADC0COH,  0xBC); ///< ADC0 Offset Calibration High Byte     
SI_SFR (ADC0COL,  0xBA); ///< ADC0 Offset Calibration Low Byte      
SI_SFR (ADC0COM,  0xBB); ///< ADC0 Offset Calibration Middle Byte   
SI_SFR (ADC0DAC,  0xBF); ///< ADC0 Offset DAC                       
SI_SFR (ADC0DECH, 0x9B); ///< ADC0 Decimation Ratio High Byte       
SI_SFR (ADC0DECL, 0x9A); ///< ADC0 Decimation Ratio Low Byte        
SI_SFR (ADC0FH,   0xFE); ///< ADC0 Fast Filter Data High Byte       
SI_SFR (ADC0FL,   0xFC); ///< ADC0 Data Low Byte                    
SI_SFR (ADC0FM,   0xFD); ///< ADC0 Fast Filter Data Middle Byte     
SI_SFR (ADC0H,    0xC5); ///< ADC0 Data High Byte                   
SI_SFR (ADC0L,    0xC3); ///< ADC0 Data Low Byte                    
SI_SFR (ADC0M,    0xC4); ///< ADC0 Data Middle Byte                 
SI_SFR (ADC0MD,   0xF3); ///< ADC0 Mode                             
SI_SFR (ADC0MUX,  0xC6); ///< ADC0 Analog Multiplexer Control       
SI_SFR (ADC0STA,  0xE8); ///< ADC0 Status                           
SI_SFR (B,        0xF0); ///< B Register                            
SI_SFR (CKCON,    0x8E); ///< Clock Control                         
SI_SFR (CLKMUL,   0xBE); ///< Clock Multiplier Control              
SI_SFR (CLKSEL,   0xA9); ///< Clock Select                          
SI_SFR (CPT0CN,   0x9C); ///< Comparator 0 Control                  
...
SI_SFR (IDA0,     0x96); ///< IDAC0 Data                            
SI_SFR (IDA0CN,   0xB9); ///< IDAC0 Control                         
SI_SFR (IDA1,     0xDD); ///< IDAC1 Data                            
SI_SFR (IDA1CN,   0xD7); ///< IDAC1 Control                         
...
SI_SFR (PCA0CPH0, 0xEA); ///< PCA Channel 0 Capture Module High Byte
SI_SFR (PCA0CPH1, 0xEC); ///< PCA Channel 1 Capture Module High Byte
SI_SFR (PCA0CPH2, 0xEE); ///< PCA Channel 2 Capture Module High Byte
SI_SFR (PCA0CPL0, 0xE9); ///< PCA Channel 0 Capture Module Low Byte 
SI_SFR (PCA0CPL1, 0xEB); ///< PCA Channel 1 Capture Module Low Byte 
SI_SFR (PCA0CPL2, 0xED); ///< PCA Channel 2 Capture Module Low Byte 
...
SI_SFR (PFE0CN,   0xE3); ///< Prefetch Engine Control               
SI_SFR (PSCTL,    0x8F); ///< Program Store Control                 
SI_SFR (PSW,      0xD0); ///< Program Status Word                   
SI_SFR (REF0CN,   0xD1); ///< Reference Control                     
...
SI_SFR16 (PCA0CP0, 0xE9); ///< PCA Channel 0 Capture Module 
SI_SFR16 (PCA0CP1, 0xEB); ///< PCA Channel 1 Capture Module 
SI_SFR16 (PCA0CP2, 0xED); ///< PCA Channel 2 Capture Module 
...
SI_SBIT (ADC0STA_ADOVR,   SFR_ADC0STA, 0); ///< Overrun Flag                      
SI_SBIT (ADC0STA_ADERR,   SFR_ADC0STA, 1); ///< Error Flag                        
SI_SBIT (ADC0STA_ADCALC,  SFR_ADC0STA, 2); ///< Calibration Complete Flag         
SI_SBIT (ADC0STA_ADFFC,   SFR_ADC0STA, 3); ///< Fast Filter Clip Flag             
SI_SBIT (ADC0STA_ADS3C,   SFR_ADC0STA, 4); ///< SINC3 Filter Clip Flag            
SI_SBIT (ADC0STA_ADINT,   SFR_ADC0STA, 5); ///< Conversion Complete Interrupt Flag
SI_SBIT (ADC0STA_ADCBUSY, SFR_ADC0STA, 6); ///< Calibration In-Progress Flag      
SI_SBIT (ADC0STA_ADBUSY,  SFR_ADC0STA, 7); ///< Conversion In-Progress Flag       
