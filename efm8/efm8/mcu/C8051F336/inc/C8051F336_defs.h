...
// Program Description:
//
// Register/bit definitions for the C8051F336 family.
...
//     (pdata)
// Release 1.0 - 07 AUG 2007 (PKC)
//    -Removed #include <compiler_defs.h>. The C source file should include it.
// Release 0.2 - 21 MAY 2007 (PKC)
//    -Added Port Match interrupt; Removed FID.
// Release 0.1 - 06 MAY 2007 (PKC)
...
#ifndef C8051F336_DEFS_H
#define C8051F336_DEFS_H
...
SFR (P2SKIP, 0xD6);                    // Port 2 Skip *NEW*
SFR (SMB0ADR, 0xD7);                   // SMBus0 Address *NEW*
...
SFR (SMB0ADM, 0xE7);                   // SMBus0 Address Match *NEW*
...
SFR (P1MAT, 0xED);                     // Port 1 Match Register *NEW*
SFR (P1MASK, 0xEE);                    // Port 1 Mask Register *NEW*
...
SFR (P2MDIN, 0xF3);                    // Port 2 Input Mode Configuration *NEW*
SFR (EIP1, 0xF6);                      // Extended Interrupt Priority 1
SFR (PCA0PWM, 0xF7);                   // PCA0 PWM Configuration Register *NEW*
...
SFR (P0MAT, 0xFD);                     // Port 0 Match Register *NEW*
SFR (P0MASK, 0xFE);                    // Port 1 Mask Register *NEW*
