...
#ifndef SI_C8051F800_SI_DEFS_H
#define SI_C8051F800_SI_DEFS_H
...
SI_SFR (CRC0CN,   0xCE); ///< CRC0 Control                                     
...
SI_SFR (CS0DH,    0xAC); ///< Capacitive Sense 0 Data High Byte                
SI_SFR (CS0DL,    0xAB); ///< Capacitive Sense 0 Data Low Byte                 
SI_SFR (CS0MX,    0x9C); ///< Capacitive Sense 0 Mux Channel Select            
SI_SFR (CS0SE,    0xBA); ///< Capacitive Sense 0 Auto Scan End Channel         
SI_SFR (CS0SS,    0xB9); ///< Capacitive Sense 0 Auto Scan Start Channel       
...
SI_SFR16 (CS0D,    0xAB); ///< Capacitive Sense 0 Data                 
