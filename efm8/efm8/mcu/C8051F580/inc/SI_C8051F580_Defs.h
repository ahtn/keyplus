...
#ifndef SI_C8051F580_DEFS_H
#define SI_C8051F580_DEFS_H
...
SFR (CPT2MX,      0x9C); ///< Comparator 2 Multiplexer Selection          
...
SFR (PCA1CN,      0xD8); ///< PCA Control                                 
SFR (PCA1CPH10,   0xFE); ///< PCA Channel 10 Capture Module High Byte     
SFR (PCA1CPH11,   0xCF); ///< PCA Channel 11 Capture Module High Byte     
SFR (PCA1CPH6,    0xFC); ///< PCA Channel 6 Capture Module High Byte      
SFR (PCA1CPH7,    0xEA); ///< PCA Channel 7 Capture Module High Byte      
SFR (PCA1CPH8,    0xEC); ///< PCA Channel 8 Capture Module High Byte      
SFR (PCA1CPH9,    0xEE); ///< PCA Channel 9 Capture Module High Byte      
SFR (PCA1CPL10,   0xFD); ///< PCA Channel 10 Capture Module Low Byte      
SFR (PCA1CPL11,   0xCE); ///< PCA Channel 11 Capture Module Low Byte      
SFR (PCA1CPL6,    0xFB); ///< PCA Channel 6 Capture Module Low Byte       
SFR (PCA1CPL7,    0xE9); ///< PCA Channel 7 Capture Module Low Byte       
SFR (PCA1CPL8,    0xEB); ///< PCA Channel 8 Capture Module Low Byte       
SFR (PCA1CPL9,    0xED); ///< PCA Channel 9 Capture Module Low Byte       
SFR (PCA1CPM10,   0xDE); ///< PCA Channel 10 Capture/Compare Mode         
SFR (PCA1CPM11,   0xDF); ///< PCA Channel 11 Capture/Compare Mode         
SFR (PCA1CPM6,    0xDA); ///< PCA Channel 6 Capture/Compare Mode          
SFR (PCA1CPM7,    0xDB); ///< PCA Channel 7 Capture/Compare Mode          
SFR (PCA1CPM8,    0xDC); ///< PCA Channel 8 Capture/Compare Mode          
SFR (PCA1CPM9,    0xDD); ///< PCA Channel 9 Capture/Compare Mode          
SFR (PCA1H,       0xFA); ///< PCA Counter/Timer High Byte                 
SFR (PCA1L,       0xF9); ///< PCA Counter/Timer Low Byte                  
SFR (PCA1MD,      0xD9); ///< PCA Mode                                    
SFR (PCA1PWM,     0xDA); ///< PCA PWM Configuration                       
...
SFR (TMR4CAPH,    0xCB); ///< Timer 4 Reload High Byte                    
SFR (TMR4CAPL,    0xCA); ///< Timer 4 Reload Low Byte                     
SFR (TMR4CF,      0xC9); ///< Timer 4 Config                              
SFR (TMR4CN,      0xC8); ///< Timer 4 Control                             
SFR (TMR4H,       0xCD); ///< Timer 4 High Byte                           
SFR (TMR4L,       0xCC); ///< Timer 4 Low Byte                            
SFR (TMR5CAPH,    0x93); ///< Timer 5 Reload High Byte                    
SFR (TMR5CAPL,    0x92); ///< Timer 5 Reload Low Byte                     
SFR (TMR5CF,      0x96); ///< Timer 5 Config                              
SFR (TMR5CN,      0x91); ///< Timer 5 Control                             
SFR (TMR5H,       0x95); ///< Timer 5 High Byte                           
SFR (TMR5L,       0x94); ///< Timer 5 Low Byte                            
...
SFR (XBR3,        0xC6); ///< Port I/O Crossbar 3                         
...
SFR16 (PCA1CP10,   0xFD); ///< PCA Channel 10 Capture Module   
SFR16 (PCA1CP11,   0xCE); ///< PCA Channel 11 Capture Module   
SFR16 (PCA1CP6,    0xFB); ///< PCA Channel 6 Capture Module    
SFR16 (PCA1CP7,    0xE9); ///< PCA Channel 7 Capture Module    
SFR16 (PCA1CP8,    0xEB); ///< PCA Channel 8 Capture Module    
SFR16 (PCA1CP9,    0xED); ///< PCA Channel 9 Capture Module    
SFR16 (PCA1,       0xF9); ///< PCA Counter/Timer               
...
SFR16 (TMR4CAP,    0xCA); ///< Timer 4 Reload                  
SFR16 (TMR4,       0xCC); ///< Timer 4                         
SFR16 (TMR5CAP,    0x92); ///< Timer 5 Reload                  
...
SBIT (PCA1CN_CCF6,  SFR_PCA1CN, 0); ///< PCA Module 6 Capture/Compare Flag 
SBIT (PCA1CN_CCF7,  SFR_PCA1CN, 1); ///< PCA Module 7 Capture/Compare Flag 
SBIT (PCA1CN_CCF8,  SFR_PCA1CN, 2); ///< PCA Module 8 Capture/Compare Flag 
SBIT (PCA1CN_CCF9,  SFR_PCA1CN, 3); ///< PCA Module 9 Capture/Compare Flag 
SBIT (PCA1CN_CCF10, SFR_PCA1CN, 4); ///< PCA Module 10 Capture/Compare Flag
SBIT (PCA1CN_CCF11, SFR_PCA1CN, 5); ///< PCA Module 11 Capture/Compare Flag
SBIT (PCA1CN_CR,    SFR_PCA1CN, 6); ///< PCA Counter/Timer Run Control     
SBIT (PCA1CN_CF,    SFR_PCA1CN, 7); ///< PCA Counter/Timer Overflow Flag   
...
SBIT (TMR4CN_EXE4,  SFR_TMR4CN, 3); ///< Timer 4 External Enable           
SBIT (TMR4CN_EXF4,  SFR_TMR4CN, 6); ///< Timer 4 External Flag             
SBIT (TMR4CN_TF4,   SFR_TMR4CN, 7); ///< Timer 4 Overflow or Underflow Flag
