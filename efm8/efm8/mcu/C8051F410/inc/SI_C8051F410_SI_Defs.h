...
#ifndef SI_C8051F410_SI_DEFS_H
#define SI_C8051F410_SI_DEFS_H
...
SI_SFR (CLKMUL,   0xAB); ///< Clock Multiplier Control              
...
SI_SFR (CRC0FLIP, 0xDF); ///< CRC0 Bit Flip                         
...
SI_SFR (IDA1CN,   0xB5); ///< IDAC1 Control                         
SI_SFR (IDA1H,    0xF5); ///< IDAC1 Data High Byte                  
SI_SFR (IDA1L,    0xF4); ///< IDAC1 Data Low Byte                   
SI_SFR (IE,       0xA8); ///< Interrupt Enable                      
SI_SFR (IP,       0xB8); ///< Interrupt Priority                    
SI_SFR (IT01CF,   0xE4); ///< INT0/INT1 Configuration               
SI_SFR (ONESHOT,  0xAF); ///< Flash Oneshot Period                  
...
SI_SFR (P0ODEN,   0xB0); ///< Port 0 Overdrive Mode                 
...
SI_SBIT (P0ODEN_B0, SFR_P0ODEN, 0); ///< Port 0 Bit 0 Overdrive Mode
SI_SBIT (P0ODEN_B1, SFR_P0ODEN, 1); ///< Port 0 Bit 1 Overdrive Mode
SI_SBIT (P0ODEN_B2, SFR_P0ODEN, 2); ///< Port 0 Bit 2 Overdrive Mode
SI_SBIT (P0ODEN_B3, SFR_P0ODEN, 3); ///< Port 0 Bit 3 Overdrive Mode
SI_SBIT (P0ODEN_B4, SFR_P0ODEN, 4); ///< Port 0 Bit 4 Overdrive Mode
SI_SBIT (P0ODEN_B5, SFR_P0ODEN, 5); ///< Port 0 Bit 5 Overdrive Mode
SI_SBIT (P0ODEN_B6, SFR_P0ODEN, 6); ///< Port 0 Bit 6 Overdrive Mode
SI_SBIT (P0ODEN_B7, SFR_P0ODEN, 7); ///< Port 0 Bit 7 Overdrive Mode
...
SI_SBIT (TMR2CN_T2RCLK,  SFR_TMR2CN, 1); ///< Timer 2 Capture Mode             
