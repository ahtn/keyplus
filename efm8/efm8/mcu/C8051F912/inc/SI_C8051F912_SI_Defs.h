...
#ifndef SI_C8051F912_SI_DEFS_H
#define SI_C8051F912_SI_DEFS_H
...
SI_SFR (DC0CF,    0x96); ///< DC-DC Converter Configuration         
SI_SFR (DC0CN,    0x97); ///< DC-DC Converter Control               
SI_SFR (DC0MD,    0x94); ///< DC-DC Mode                            
...
SI_SFR (VDM0CN,   0xFF); ///< VDD/DC+ Supply Monitor Control        
