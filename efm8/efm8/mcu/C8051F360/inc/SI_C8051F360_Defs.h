...
#ifndef SI_C8051F360_DEFS_H
#define SI_C8051F360_DEFS_H
...
SFR (EMI0TC,   0xF7); ///< External Memory Timing Control           
...
SFR (MAC0AH,   0xA5); ///< Operand A High Byte                      
SFR (MAC0AL,   0xA4); ///< Operand A Low Byte                       
SFR (MAC0BH,   0xF2); ///< Operand B High Byte                      
SFR (MAC0BL,   0xF1); ///< Operand B Low Byte                       
SFR (MAC0CF,   0xD7); ///< MAC0 Configuration                       
SFR (MAC0OVR,  0xD6); ///< Accumulator Overflow Byte                
SFR (MAC0RNDH, 0xAF); ///< Rounded Result High Byte                 
SFR (MAC0RNDL, 0xAE); ///< Rounded Result Low Byte                  
SFR (MAC0STA,  0xCF); ///< MAC0 Status                              
SFR (OSCICL,   0xBF); ///< High Frequency Oscillator Calibration    
SFR (OSCICN,   0xB7); ///< High Frequency Oscillator Control        
...
SFR (PCA0CPH5, 0xF6); ///< PCA Channel 5 Capture Module High Byte   
...
SFR (PCA0CPL5, 0xF5); ///< PCA Channel 5 Capture Module Low Byte    
...
SFR16 (MAC0A,   0xA4); ///< Operand A                    
SFR16 (MAC0B,   0xF1); ///< Operand B                    
SFR16 (MAC0RND, 0xAE); ///< Rounded Result               
...
SFR16 (PCA0CP5, 0xF5); ///< PCA Channel 5 Capture Module 
